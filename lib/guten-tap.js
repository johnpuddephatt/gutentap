import { openBlock as F, createElementBlock as Z, normalizeClass as jt, renderSlot as Pl, createCommentVNode as it, defineComponent as qr, ref as Us, onMounted as Pc, onBeforeUnmount as Js, h as hn, reactive as Bc, markRaw as zc, getCurrentInstance as uf, watchEffect as ff, nextTick as hf, unref as pf, Teleport as mf, customRef as gf, Fragment as Ct, renderList as St, withModifiers as Te, createElementVNode as Ke, createTextVNode as yf, toDisplayString as vf, resolveComponent as hr, createBlock as Qe, withCtx as Me, createVNode as je, createSlots as bf, withKeys as wf } from "vue";
const Kr = (n, e) => {
...
}, xf = ["aria-label", "data-tooltip", "title", "innerHTML"];
...
const Sf = /* @__PURE__ */ Kr(kf, [["render", Cf]]), Mf = {
  computed: {
    hasDropdown() {
...
}, Tf = { class: "group text-sm relative" };
...
const Of = /* @__PURE__ */ Kr(Mf, [["render", Af]]), Ef = {
  props: {
    content: {
      type: String,
      required: !1
...
const Rf = /* @__PURE__ */ Kr(Ef, [["render", Df]]);
function ye(n) {
  this.content = n;
}
ye.prototype = {
...
function Hc(n, e, t) {
  for (let r = 0; ; r++) {
    ...
    if (i.content.size || o.content.size) {
      let s = Hc(i.content, o.content, t + 1);
      if (s != null)
        return s;
    }
    t += i.nodeSize;
...
function Vc(n, e, t, r) {
  for (let i = n.childCount, o = e.childCount; ; ) {
    ...
    if (s.content.size || l.content.size) {
      let c = Vc(s.content, l.content, t - 1, r - 1);
      if (c)
        return c;
    }
    t -= a, r -= a;
...
class M {
  ...
  */
  removeBetween(e, t) {
    return new M(Fc(this.content, e + this.openStart, t + this.openStart), this.openStart, this.openEnd);
  }
  /**
...
function Fc(n, e, t) {
  ...
  if (r != s)
    throw new RangeError("Removing non-flat range");
  return n.replaceChild(r, o.copy(Fc(o.content, e - i - 1, t - i - 1)));
}
function $c(n, e, t, r) {
  let { index: i, offset: o } = n.findIndex(e), s = n.maybeChild(i);
  if (o == e || s.isText)
    return r && !r.canReplace(i, i, t) ? null : n.cut(0, e).append(t).append(n.cut(e));
  let l = $c(s.content, e - o - 1, t);
...
function jc(n, e, t, r) {
  ...
  if (i == e.index(r) && r < n.depth - t.openStart) {
    ...
    if (!t.openStart && !t.openEnd && n.depth == r && e.depth == r) {
      ...
      let { start: s, end: l } = If(t, n);
      return mn(o, _c(n, s, l, e, r));
    }
  else
...
function _c(n, e, t, r, i) {
  ...
  return br(null, n, i, l), o && s && e.index(i) == t.index(i) ? (Wc(o, s), pn(mn(o, _c(n, e, t, r, i + 1)), l)) : (o && pn(mn(o, Li(n, e, i + 1)), l), br(e, t, i, l), s && pn(mn(s, Li(t, r, i + 1)), l)), br(r, null, i, l), new x(l);
}
function Li(n, e, t) {
  let r = [];
...
let gn = class ds {
  ...
  */
  hasMarkup(e, t, r) {
    return this.type == e && Di(this.attrs, t || e.defaultAttrs || Bf) && G.sameSet(this.marks, r || G.none);
  }
  /**
  ...
  */
  replace(e, t, r) {
    return Lf(this.resolve(e), this.resolve(t), r);
  }
  /**
...
function jf(n) {
  if (n.eat("(")) {
    ...
    let e = $f(n, n.next).map((t) => (n.inline == null ? n.inline = t.isInline : n.inline != t.isInline && n.err("Mixing inline and block content"), { type: "name", value: t }));
...
let Hl = class Xc {
  ...
  */
  constructor(e, t, r) {
    this.name = e, this.schema = t, this.spec = r, this.markSet = null, this.groups = r.group ? r.group.split(" ") : [], this.attrs = Yc(r.attrs), this.defaultAttrs = Jc(this.attrs), this.contentMatch = null, this.inlineContent = null, this.isBlock = !(r.inline || e == "text"), this.isText = e == "text";
  }
  /**
  ...
  */
  computeAttrs(e) {
    return !e && this.defaultAttrs ? this.defaultAttrs : Gc(this.attrs, e);
  }
  /**
  ...
  */
  static compile(e, t) {
    ...
    e.forEach((o, s) => r[o] = new Xc(o, t, s));
...
class co {
  ...
  */
  constructor(e, t, r, i) {
    this.name = e, this.rank = t, this.schema = r, this.spec = i, this.attrs = Yc(i.attrs), this.excluded = null;
    let o = Jc(this.attrs);
  ...
  */
  create(e = null) {
    return !e && this.instance ? this.instance : new G(this, Gc(this.attrs, e));
  }
  /**
  @internal
  */
...
class Uf {
  ...
  */
  constructor(e) {
    ...
    for (let i in e)
      t[i] = e[i];
    t.nodes = ye.from(e.nodes), t.marks = ye.from(e.marks || {}), this.nodes = Hl.compile(this.spec.nodes, this), this.marks = co.compile(this.spec.marks, this);
    let r = /* @__PURE__ */ Object.create(null);
    for (let i in this.nodes) {
      ...
      o.markSet = l == "_" ? null : l ? Vl(this, l.split(" ")) : l == "" || !o.inlineContent ? [] : null;
    }
    for (let i in this.marks) {
      let o = this.marks[i], s = o.spec.excludes;
      o.excluded = s == null ? [o] : s == "" ? [] : Vl(this, s.split(" "));
    }
  ...
  */
  constructor(e, t) {
    this.schema = e, this.rules = t, this.tags = [], this.styles = [], t.forEach((r) => {
      Jf(r) ? this.tags.push(r) : Gf(r) && this.styles.push(r);
  ...
  */
  matchTag(e, t, r) {
    for (let i = r ? this.tags.indexOf(r) + 1 : 0; i < this.tags.length; i++) {
      let o = this.tags[i];
      if (Qf(e, o.tag) && (o.namespace === void 0 || e.namespaceURI == o.namespace) && (!o.context || t.matchesContext(o.context))) {
        if (o.getAttrs) {
          let s = o.getAttrs(e);
          if (s === !1)
            continue;
  ...
  */
  static schemaRules(e) {
    ...
    for (let i in e.marks) {
      ...
      o && o.forEach((s) => {
        r(s = jl(s)), s.mark || s.ignore || s.clearMark || (s.mark = i);
      });
    }
    for (let i in e.nodes) {
      let o = e.nodes[i].spec.parseDOM;
      o && o.forEach((s) => {
        r(s = jl(s)), s.node || s.ignore || s.mark || (s.node = i);
      });
    }
    return t;
  }
...
class di {
  ...
  applyPending(e) {
    for (let t = 0, r = this.pendingMarks; t < r.length; t++) {
      let i = r[t];
      (this.type ? this.type.allowsMarkType(i.type) : eh(i.type, e)) && !i.isInSet(this.activeMarks) && (this.activeMarks = i.addToSet(this.activeMarks), this.pendingMarks = i.removeFromSet(this.pendingMarks));
    }
  }
  inlineContext(e) {
    return this.type ? this.type.inlineContent : this.content.length ? this.content[0].isInline : e.parentNode && !Qc.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
  }
}
class $l {
  constructor(e, t, r) {
    this.parser = e, this.options = t, this.isOpen = r, this.open = 0;
    let i = t.topNode, o, s = Fl(null, t.preserveWhitespace, 0) | (r ? wr : 0);
...
`));
  ...
  addPendingMark(e) {
    let t = th(e, this.top.pendingMarks);
...
class ze {
  ...
  _map(e, t, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= u) {
        ...
        if (r)
          return h;
        let p = e == (t < 0 ? a : u) ? null : nh(l / 3, e - a), g = e == a ? rd : e == u ? nd : Ci;
        return (t < 0 ? e != a : e != u) && (g |= id), new us(h, g, p);
      }
      i += d - c;
    }
  ...
  */
  touches(e, t) {
    let r = 0, i = _l(t), o = this.inverted ? 2 : 1, s = this.inverted ? 1 : 2;
    for (let l = 0; l < this.ranges.length; l += 3) {
...
class Wt extends Ce {
  ...
  */
  ...
  apply(e) {
    let t = e.slice(this.from, this.to), r = e.resolve(this.from), i = r.node(r.sharedDepth(this.to)), o = new M(Gs(t.content, (s, l) => !s.isAtom || !l.type.allowsMarkType(this.mark.type) ? s : s.mark(this.mark.addToSet(s.marks)), i), t.openStart, t.openEnd);
...
class ft extends Ce {
  ...
  */
  ...
  apply(e) {
    let t = e.slice(this.from, this.to), r = new M(Gs(t.content, (i) => i.mark(this.mark.removeFromSet(i.marks)), e), t.openStart, t.openEnd);
...
class _t extends Ce {
  ...
  */
  ...
  apply(e) {
    ...
    return ce.fromReplace(e, this.pos, this.pos + 1, new M(x.from(r), 0, t.isLeaf ? 0 : 1));
  }
  invert(e) {
    let t = e.nodeAt(this.pos);
    if (t) {
...
class ae extends Ce {
  ...
  */
  ...
  apply(e) {
    return this.structure && fs(e, this.from, this.to) ? ce.fail("Structure replace would overwrite content") : ce.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
  ...
  */
  static fromJSON(e, t) {
    ...
    return new ae(t.from, t.to, M.fromJSON(e, t.slice), !!t.structure);
  }
}
Ce.jsonID("replace", ae);
class he extends Ce {
  /**
  ...
  */
  static fromJSON(e, t) {
    ...
    return new he(t.from, t.to, t.gapFrom, t.gapTo, M.fromJSON(e, t.slice), t.insert, !!t.structure);
  }
}
Ce.jsonID("replaceAround", he);
function fs(n, e, t) {
  ...
  for (let a = 0; a < o.childCount; a++) {
    ...
    if (!u)
      ...
      if (i && c.isText && t.whitespace != "pre") {
        let f, h = /\r?\n|\r/g, p;
        for (; f = h.exec(c.text); )
          p || (p = new M(x.from(t.schema.text(" ", t.allowedMarks(c.marks))), 0, 0)), s.push(new ae(l + f.index, l + f.index + f[0].length, p));
      }
    }
    l = d;
  }
...
function sr(n) {
  ...
  for (let r = n.depth; ; --r) {
    ...
    if (r < n.depth && i.canReplace(o, s, t))
      return r;
    if (r == 0 || i.type.spec.isolating || !sh(i, o, s))
      break;
  }
  return null;
}
function lh(n, e, t) {
  ...
  n.step(new he(a, c, s, l, new M(d.append(f), u, h), d.size - u, !0));
}
function Ys(n, e, t = null, r = n) {
  let i = ah(n, e), o = i && ch(r, e);
...
function dh(n, e, t) {
  ...
  n.step(new he(i, o, i, o, new M(r, 0, 0), t.length, !0));
}
function uh(n, e, t, r, i) {
  ...
  n.doc.nodesBetween(e, t, (s, l) => {
    if (s.isTextblock && !s.hasMarkup(r, i) && ph(n.doc, n.mapping.slice(o).map(l), r)) {
      let a = null;
      if (r.schema.linebreakReplacement) {
        let f = r.whitespace == "pre", h = !!r.contentMatch.matchType(r.schema.linebreakReplacement);
        f && !h ? a = !1 : !f && h && (a = !0);
      }
      a === !1 && hh(n, s, l, o), od(n, n.mapping.slice(o).map(l, 1), r, void 0, a === null);
      let c = n.mapping.slice(o), d = c.map(l, 1), u = c.map(l + s.nodeSize, 1);
      return n.step(new he(d, u, d + 1, u - 1, new M(x.from(r.create(i, null, s.marks)), 0, 0), 1, !0)), a === !0 && fh(n, s, l, o), !1;
    }
  });
}
function fh(n, e, t, r) {
...
function mh(n, e, t, r, i) {
  ...
  n.step(new he(e, e + o.nodeSize, e + 1, e + o.nodeSize - 1, new M(x.from(s), 0, 0), 1, !0));
}
...
function gh(n, e, t = 1, r) {
  ...
  n.step(new ae(e, e, new M(o.append(s), t, t), !0));
}
function Xt(n, e) {
...
function uo(n, e, t = -1) {
  ...
  for (let i = r.depth; ; i--) {
    let o, s, l = r.index(i);
    if (i == r.depth ? (o = r.nodeBefore, s = r.nodeAfter) : t > 0 ? (o = r.node(i + 1), l++, s = r.node(i).maybeChild(l)) : (o = r.node(i).maybeChild(l - 1), s = r.node(i + 1)), o && !o.isTextblock && sd(o, s) && r.node(i).canReplace(l, l + 1))
      return e;
    if (i == 0)
      break;
...
function yh(n, e, t) {
  let r = new ae(e - t, e + t, M.empty, !0);
  n.step(r);
}
function vh(n, e, t) {
  let r = n.resolve(e);
...
function fo(n, e, t = e, r = M.empty) {
  ...
  return ad(i, o, r) ? new ae(e, t, r) : new bh(i, o, r).fit();
}
function ad(n, e, t) {
...
class bh {
  ...
  fit() {
    ...
    let a = new M(o, s, l);
    return e > -1 ? new he(r.pos, e, this.$to.pos, this.$to.end(), a, t) : a.size || r.pos != this.$to.pos ? new ae(r.pos, i.pos, a) : null;
  }
  ...
  placeNodes({ sliceDepth: e, frontierDepth: t, parent: r, inject: i, wrap: o }) {
    ...
    for (; c < l.childCount; ) {
      ...
      if (!m)
        break;
      c++, (c > 1 || a == 0 || g.content.size) && (u = m, d.push(cd(g.mark(f.allowedMarks(g.marks)), c == 1 ? a : 0, c == l.childCount ? h : -1)));
    }
...
function cd(n, e, t) {
  if (e <= 0)
    return n;
  let r = n.content;
  return e > 1 && (r = r.replaceChild(0, cd(r.firstChild, e - 1, r.childCount == 1 ? t - 1 : 0))), e > 0 && (r = n.type.contentMatch.fillBefore(r).append(r), t <= 0 && (r = r.append(n.type.contentMatch.matchFragment(r).fillBefore(x.empty, !0)))), n.copy(r);
}
function Po(n, e, t, r, i) {
  ...
  return l && !wh(t, o.content, s) ? l : null;
}
function wh(n, e, t) {
    ...
    if (p)
      for (let g = 0; g < s.length; g++) {
        ...
        if (w.canReplaceWith(C, C, p.type, p.marks))
          return n.replace(i.before(m), y ? o.after(m) : t, new M(dd(r.content, 0, r.openStart, h), h, r.openEnd));
      }
  }
...
function dd(n, e, t, r, i) {
  if (e < t) {
    let o = n.firstChild;
    n = n.replaceChild(0, o.copy(dd(o.content, e + 1, t, r, o)));
  }
  if (e > r) {
...
function Ch(n, e, t, r) {
  if (!r.isInline && e == t && n.doc.resolve(e).parent.content.size) {
    let i = vh(n.doc, e, r.type);
    i != null && (e = t = i);
  }
  n.replaceRange(e, t, new M(x.from(r), 0, 0));
}
function Sh(n, e, t) {
  let r = n.doc.resolve(e), i = n.doc.resolve(t), o = ud(r, i);
  for (let s = 0; s < o.length; s++) {
...
class Jn extends Ce {
  ...
  */
  ...
  apply(e) {
    ...
    return ce.fromReplace(e, this.pos, this.pos + 1, new M(x.from(i), 0, t.isLeaf ? 0 : 1));
  }
  getMap() {
    return ze.empty;
  }
  ...
  */
  replace(e, t = M.empty) {
    ...
    for (let l = 0; l < s.length; l++) {
      ...
      e.replaceRange(d.map(a.pos), d.map(c.pos), l ? M.empty : t), l == 0 && Jl(e, o, (r ? r.isInline : i && i.isTextblock) ? -1 : 1);
    }
  }
  /**
  ...
  */
  replaceWith(e, t) {
    ...
    for (let o = 0; o < i.length; o++) {
      ...
      o ? e.deleteRange(c, d) : (e.replaceRangeWith(c, d, t), Jl(e, r, t.isInline ? -1 : 1));
    }
  }
  /**
...
function Jl(n, e, t) {
  ...
  if (r < e)
    return;
  let i = n.steps[r];
  if (!(i instanceof ae || i instanceof he))
    return;
...
class Th extends Xs {
  ...
  */
  setSelection(e) {
    ...
    return this.curSelection = e, this.curSelectionFor = this.steps.length, this.updated = (this.updated | Gl) & ~ui, this.storedMarks = null, this;
  }
  /**
...
class zo {
  constructor(e, t) {
    this.schema = e, this.plugins = [], this.pluginsByKey = /* @__PURE__ */ Object.create(null), this.fields = Ah.slice(), t && t.forEach((r) => {
...
const At = function(n, e, t) {
  ...
  return t && (Ql(n, e, t, r, -1) || Ql(n, e, t, r, 1));
...
function Ql(n, e, t, r, i) {
  for (; ; ) {
    ...
    if (e == (i < 0 ? 0 : dt(n))) {
      let o = n.parentNode;
      if (!o || o.nodeType != 1 || Ur(n) || Eh.test(n.nodeName) || n.contentEditable == "false")
        return !1;
      e = ve(n) + (i < 0 ? 0 : 1), n = o;
...
const pt = typeof navigator < "u" ? navigator : null, Zl = typeof document < "u" ? document : null, Qt = pt && pt.userAgent || "", ps = /Edge\/(\d+)/.exec(Qt), md = /MSIE \d/.exec(Qt), ms = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Qt), Le = !!(md || ms || ps), Kt = md ? document.documentMode : ms ? +ms[1] : ps ? +ps[1] : 0, nt = !Le && /gecko\/(\d+)/i.test(Qt);
nt && +(/Firefox\/(\d+)/.exec(Qt) || [0, 0])[1];
const gs = !Le && /Chrome\/(\d+)/.exec(Qt), Ae = !!gs, Ph = gs ? +gs[1] : 0, Oe = !Le && !!pt && /Apple Computer/.test(pt.vendor), Zn = Oe && (/Mobile\/\w+/.test(Qt) || !!pt && pt.maxTouchPoints > 2), _e = Zn || (pt ? /Mac/.test(pt.platform) : !1), Bh = pt ? /Win/.test(pt.platform) : !1, Ze = /Android \d/.test(Qt), Jr = !!Zl && "webkitFontSmoothing" in Zl.documentElement.style, zh = Jr ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function Hh(n) {
...
function ea(n, e, t) {
  ...
  for (let s = t || n.dom; s; s = Rr(s)) {
    if (s.nodeType != 1)
      continue;
    let l = s, a = l == o.body, c = a ? Hh(o) : Vh(l), d = 0, u = 0;
...
function Fh(n) {
  ...
  return { refDOM: r, refTop: i, stack: gd(n.dom) };
}
function gd(n) {
...
function vd(n, e) {
  ...
  return !t && a && (t = a, i = c, r = 0), t && t.nodeType == 3 ? Wh(t, i) : !t || r && t.nodeType == 1 ? { node: n, offset: o } : vd(t, i);
}
function Wh(n, e) {
...
function qh(n, e, t) {
  let { node: r, offset: i } = vd(e, t), o = -1;
...
function Uh(n, e) {
  let t = n.dom.ownerDocument, r, i = 0, o = Ih(t, e.left, e.top);
  o && ({ node: r, offset: i } = o);
  ...
  if (s = _h(s, e), r) {
    ...
    let c;
    Jr && i && r.nodeType == 1 && (c = r.childNodes[i - 1]).nodeType == 1 && c.contentEditable == "false" && c.getBoundingClientRect().top >= e.top && i--, r == n.dom && i == r.childNodes.length - 1 && r.lastChild.nodeType == 1 && e.top > r.lastChild.getBoundingClientRect().bottom ? l = n.state.doc.content.size : (i == 0 || r.nodeType != 1 || r.childNodes[i - 1].nodeName != "BR") && (l = Kh(n, r, i, e));
  }
  l == null && (l = qh(n, s, e));
...
function wd(n, e, t) {
  ...
  if (r.nodeType == 3)
    if (s && (Jh.test(r.nodeValue) || (t < 0 ? !i : i == r.nodeValue.length))) {
      let a = Pt(At(r, i, i), t);
...
function Xh(n, e, t) {
  ...
  return !Yh.test(r.parent.textContent) || !l.modify ? t == "left" || t == "backward" ? o : s : kd(n, e, () => {
...
function Qh(n, e, t) {
  return na == e && ra == t ? ia : (na = e, ra = t, ia = t == "up" || t == "down" ? Gh(n, e, t) : Xh(n, e, t));
}
const Ue = 0, oa = 1, dn = 2, mt = 3;
class Gr {
  constructor(e, t, r, i) {
  ...
  domFromPos(e, t) {
    ...
    for (let o; r && !(o = this.children[r - 1]).size && o instanceof xd && o.side >= 0; r--)
      ;
    if (t <= 0) {
      let o, s = !0;
  ...
  markDirty(e, t) {
    for (let r = 0, i = 0; i < this.children.length; i++) {
      ...
      if (r == s ? e <= s && t >= r : e < s && t > r) {
        ...
        if (e >= l && t <= a) {
          this.dirty = e == r || t == s ? dn : oa, e == l && t == a && (o.contentLost || o.dom.parentNode != this.contentDOM) ? o.dirty = mt : o.markDirty(e - l, t - l);
          return;
        } else
...
class Ut extends Gr {
  ...
  static create(e, t, r, i, o, s) {
    ...
    let f = d;
    return d = Td(d, r, t), c ? a = new ep(e, t, r, i, d, u || null, f, c, o, s + 1) : t.isText ? new mo(e, t, r, i, d, f, o) : new Ut(e, t, r, i, d, u || null, f, o, s + 1);
  }
  parseRule() {
  ...
  // `this.children`.
  updateChildren(e, t) {
    let r = this.node.inlineContent, i = t, o = e.composing ? this.localCompositionInfo(e, t) : null, s = o && o.pos > -1 ? o : null, l = o && o.pos < 0, a = new np(this, s && s.node, e);
    op(this.node, this.innerDeco, (c, d, u) => {
    ...
    }), a.syncToMarks([], r, e), this.node.isTextblock && a.addTextblockHacks(), a.destroyRest(), (a.changed || this.dirty == dn) && (s && this.protectLocalComposition(e, s), Sd(this.contentDOM, this.children, e), Zn && sp(this.dom));
  }
  localCompositionInfo(e, t) {
    ...
    if (this.node.inlineContent) {
      let s = o.nodeValue, l = lp(this.node.content, s, r - t, i - t);
  ...
  updateOuterDeco(e) {
    ...
    this.dom = Md(this.dom, this.nodeDOM, ys(this.outerDeco, this.node, t), ys(e, this.node, t)), this.dom != r && (r.pmViewDesc = void 0, this.dom.pmViewDesc = this), this.outerDeco = e;
  }
...
function Sd(n, e, t) {
  ...
  for (let o = 0; o < e.length; o++) {
    ...
    if (s instanceof Cn) {
      ...
      Sd(s.contentDOM, s.children, t), r = a ? a.nextSibling : n.firstChild;
    }
  }
  for (; r; )
    r = la(r), i = !0;
...
function Td(n, e, t) {
  return Md(n, n, un, ys(e, t, n.nodeType != 1));
}
function vs(n, e) {
  if (n.length != e.length)
    return !1;
...
class np {
  constructor(e, t, r) {
    this.lock = t, this.view = r, this.index = 0, this.stack = [], this.changed = !1, this.top = e, this.preMatch = rp(e.node.content, e);
  }
...
function el(n, e = null) {
  ...
  if (po(t)) {
    for (a = l; i && !i.node; )
      i = i.parent;
    let d = i.node;
    if (i && d.isAtom && R.isSelectable(d) && i.parent && !(d.isInline && Rh(t.focusNode, t.focusOffset, i.dom))) {
      let u = i.posBefore;
...
function Ad(n) {
  return n.editable ? n.hasFocus() : Ed(n) && document.activeElement && document.activeElement.contains(n.dom);
}
function Nt(n, e = !1) {
  ...
  if (Od(n, t), !!Ad(n)) {
    ...
    if (n.domObserver.disconnectSelection(), n.cursorWrapper)
      ...
      aa && !(t instanceof L) && (t.$from.parent.inlineContent || (o = ca(n, t.from)), !t.empty && !t.$from.parent.inlineContent && (s = ca(n, t.to))), n.docView.setSelection(r, i, n.root, e), aa && (o && da(o), s && da(s)), t.visible ? n.dom.classList.remove("ProseMirror-hideselection") : (n.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && ap(n));
    }
    n.domObserver.setCurSelection(), n.domObserver.connectSelection();
  }
}
const aa = Oe || Ae && Ph < 63;
function ca(n, e) {
...
function ap(n) {
  ...
  e.addEventListener("selectionchange", n.input.hideSelectionGuard = () => {
    (t.anchorNode != r || t.anchorOffset != i) && (e.removeEventListener("selectionchange", n.input.hideSelectionGuard), setTimeout(() => {
      (!Ad(n) || n.state.selection.visible) && n.dom.classList.remove("ProseMirror-hideselection");
    }, 20));
  });
}
function cp(n) {
...
function Od(n, e) {
  if (e instanceof R) {
    ...
    t != n.lastSelectedViewDesc && (ua(n), t && t.selectNode(), n.lastSelectedViewDesc = t);
  } else
    ua(n);
}
function ua(n) {
...
function fa(n) {
  return n.editable && !n.hasFocus() ? !1 : Ed(n);
}
function Ed(n) {
...
function ks(n, e, t) {
  if (e.nodeType != 3) {
    let o, s;
    (s = hp(e, t)) ? (e = s, t = 0) : (o = pp(e, t)) && (e = o, t = o.nodeValue.length);
  }
...
function pa(n, e) {
  ...
  if (!(Ae || Bh) && t.parent.inlineContent) {
...
function yp(n, e) {
  let t = e.keyCode, r = gp(e);
  if (t == 8 || _e && t == 72 && r == "c")
    return ga(n, -1) || In(n, -1);
...
function Dd(n, e) {
  ...
  let s = n.someProp("clipboardSerializer") || ut.fromSchema(n.state.schema), l = zd(), a = l.createElement("div");
  a.appendChild(s.serializeFragment(r, { document: l }));
  let c = a.firstChild, d, u = 0;
  for (; c && c.nodeType == 1 && (d = Bd[c.nodeName.toLowerCase()]); ) {
...
`))), 0, 0) : M.empty;
  ...
  if (l || (l = (n.someProp("clipboardParser") || n.someProp("domParser") || Yn.fromSchema(n.state.schema)).parseSlice(s, {
    ...
    l = xp(va(l, +d[1], +d[2]), d[4]);
  else if (l = M.maxOpen(bp(l.content, i), !0), l.openStart || l.openEnd) {
    let u = 0, f = 0;
...
function bp(n, e) {
  ...
  for (let t = e.depth; t >= 0; t--) {
    ...
    if (n.forEach((l) => {
      ...
      if (!a)
        return s = null;
      if (c = s.length && o.length && Id(a, o, l, s[s.length - 1], 0))
        s[s.length - 1] = c;
      else {
        s.length && (s[s.length - 1] = Pd(s[s.length - 1], o.length));
        let d = Ld(l, a);
...
function Id(n, e, t, r, i) {
  if (i < n.length && i < e.length && n[i] == e[i]) {
    let o = Id(n, e, t, r.lastChild, i + 1);
    if (o)
      return r.copy(r.content.replaceChild(r.childCount - 1, o));
    if (r.contentMatchAt(r.childCount).matchType(i == n.length - 1 ? t.type : n[i + 1]))
      return r.copy(r.content.append(x.from(Ld(t, n, i + 1))));
  }
}
function Pd(n, e) {
  if (e == 0)
    return n;
  let t = n.content.replaceChild(n.childCount - 1, Pd(n.lastChild, e - 1)), r = n.contentMatchAt(n.childCount).fillBefore(x.empty, !0);
...
function wp(n) {
  ...
  let t = zd().createElement("div"), r = /<([a-z][^>\s]+)/i.exec(n), i;
  if ((i = r && Bd[r[1].toLowerCase()]) && (n = i.map((o) => "<" + o + ">").join("") + n + i.map((o) => "</" + o + ">").reverse().join("")), t.innerHTML = n, i)
    for (let o = 0; o < i.length; o++)
...
const Ee = {}, Ne = {}, Cp = { touchstart: !0, touchmove: !0 };
class Sp {
  constructor() {
...
function Mp(n) {
  for (let e in Ee) {
    ...
    n.dom.addEventListener(e, n.input.eventHandlers[e] = (r) => {
      Ap(n, r) && !nl(n, r) && (n.editable || !(r.type in Ne)) && t(n, r);
    }, Cp[e] ? { passive: !0 } : void 0);
  }
...
function Op(n, e) {
  !nl(n, e) && Ee[e.type] && (n.editable || !(e.type in Ne)) && Ee[e.type](n, e);
}
Ne.keydown = (n, e) => {
  let t = e;
  if (n.input.shiftKey = t.keyCode == 16 || t.shiftKey, !Vd(n, t) && (n.input.lastKeyCode = t.keyCode, n.input.lastKeyCodeTime = Date.now(), !(Ze && Ae && t.keyCode == 13)))
    if (t.keyCode != 229 && n.domObserver.forceFlush(), Zn && t.keyCode == 13 && !t.ctrlKey && !t.altKey && !t.metaKey) {
      ...
      n.someProp("handleKeyDown", (r) => r(n, t)) || yp(n, t) ? t.preventDefault() : qt(n, "key");
};
Ne.keyup = (n, e) => {
...
Ne.keypress = (n, e) => {
  let t = e;
  if (Vd(n, t) || !t.charCode || t.ctrlKey && !t.altKey || _e && t.metaKey)
    return;
...
function Rp(n, e, t, r, i) {
  return rl(n, "handleClickOn", e, t, r) || n.someProp("handleClick", (o) => o(n, e, r)) || (i ? Dp(n, t) : Np(n, t));
}
function Lp(n, e, t, r) {
  return rl(n, "handleDoubleClickOn", e, t, r) || n.someProp("handleDoubleClick", (i) => i(n, e, r));
}
function Ip(n, e, t, r) {
  return rl(n, "handleTripleClickOn", e, t, r) || n.someProp("handleTripleClick", (i) => i(n, e, r)) || Pp(n, t, r);
}
function Pp(n, e, t) {
  if (t.button != 0)
    return !1;
...
const Hd = _e ? "metaKey" : "ctrlKey";
Ee.mousedown = (n, e) => {
  let t = e;
  n.input.shiftKey = t.shiftKey;
  let r = il(n), i = Date.now(), o = "singleClick";
  i - n.input.lastClick.time < 500 && Ep(t, n.input.lastClick) && !t[Hd] && (n.input.lastClick.type == "singleClick" ? o = "doubleClick" : n.input.lastClick.type == "doubleClick" && (o = "tripleClick")), n.input.lastClick = { time: i, x: t.clientX, y: t.clientY, type: o };
  let s = n.posAtCoords(go(t));
  s && (o == "singleClick" ? (n.input.mouseDown && n.input.mouseDown.done(), n.input.mouseDown = new Bp(n, s, t, !!r)) : (o == "doubleClick" ? Lp : Ip)(n, s.pos, s.inside, t) ? t.preventDefault() : qt(n, "pointer"));
};
class Bp {
  constructor(e, t, r, i) {
  ...
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let t = this.pos;
    this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(go(e))), this.updateAllowDefault(e), this.allowDefault || !t ? qt(this.view, "pointer") : Rp(this.view, t.pos, t.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
...
function Hp(n) {
  ...
  if (!e.focusNode)
    return null;
  let t = Nh(e.focusNode, e.focusOffset), r = Dh(e.focusNode, e.focusOffset);
  if (t && r && t != r) {
    let i = r.pmViewDesc;
...
const Lr = Le && Kt < 15 || Zn && zh < 604;
Ee.copy = Ne.cut = (n, e) => {
  let t = e, r = n.state.selection, i = t.type == "cut";
  if (r.empty)
    return;
  let o = Lr ? null : t.clipboardData, s = r.content(), { dom: l, text: a } = Dd(n, s);
...
function Ir(n, e, t, r, i) {
  let o = Rd(n, e, t, r, n.state.selection.$from);
  if (n.someProp("handlePaste", (a) => a(n, i, o || M.empty)))
    return !0;
  if (!o)
    return !1;
  let s = $p(o), l = s ? n.state.tr.replaceSelectionWith(s, r) : n.state.tr.replaceSelection(o);
...
Ne.paste = (n, e) => {
  ...
  r && Ir(n, jd(r), r.getData("text/html"), i, t) ? t.preventDefault() : jp(n, t);
};
class Wd {
  constructor(e, t, r) {
...
Ee.dragstart = (n, e) => {
  ...
  let l = (s || n.state.selection).content(), { dom: a, text: c, slice: d } = Dd(n, l);
  t.dataTransfer.clearData(), t.dataTransfer.setData(Lr ? "Text" : "text/html", a.innerHTML), t.dataTransfer.effectAllowed = "copyMove", Lr || t.dataTransfer.setData("text/plain", c), n.dragging = new Wd(d, !t[_d], s);
};
Ee.dragend = (n) => {
  let e = n.dragging;
  window.setTimeout(() => {
...
Ne.drop = (n, e) => {
  ...
  s ? n.someProp("transformPasted", (p) => {
    s = p(s, n);
  }) : s = Rd(n, jd(t.dataTransfer), Lr ? null : t.dataTransfer.getData("text/html"), !1, o);
  let l = !!(r && !t[_d]);
  ...
  if (!s)
    return;
  t.preventDefault();
  let a = s ? ld(n.state.doc, o.pos, s) : o.pos;
  a == null && (a = o.pos);
  let c = n.state.tr;
  if (l) {
    let { node: p } = r;
  ...
  if (u && R.isSelectable(s.content.firstChild) && h.nodeAfter && h.nodeAfter.sameMarkup(s.content.firstChild))
    ...
    c.mapping.maps[c.mapping.maps.length - 1].forEach((g, m, y, w) => p = w), c.setSelection(tl(n, h, c.doc.resolve(p)));
  }
...
class ol {
  ...
  eq(e) {
    return this == e || e instanceof ol && Pr(this.attrs, e.attrs) && Pr(this.spec, e.spec);
  }
  destroy() {
  }
}
...
class Q {
  ...
  */
  mapInner(e, t, r, i, o) {
    ...
    return this.children.length ? Wp(this.children, s || [], e, t, r, i, o) : s ? new Q(s.sort(vn), Hn) : we;
  }
  /**
...
function Wp(n, e, t, r, i, o, s) {
  ...
  if (a) {
    let c = _p(l, n, e, t, i, o, s), d = $i(c, r, 0, s);
    e = d.local;
  ...
  for (let t = 0; t < e.length - 1; t++) {
    ...
    if (r.from != r.to)
      for (let i = t + 1; i < e.length; i++) {
        let o = e[i];
        if (o.from == r.from) {
          o.to != r.to && (e == n && (e = n.slice()), e[i] = o.copy(o.from, r.to), wa(e, i + 1, o.copy(r.to, o.to)));
          continue;
        } else {
          o.from < r.to && (e == n && (e = n.slice()), e[t] = r.copy(r.from, o.from), wa(e, i, r.copy(o.from, r.to)));
          break;
        }
      }
  }
...
class Jp {
  constructor(e, t) {
    this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new Up(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let i = 0; i < r.length; i++)
        this.queue.push(r[i]);
  ...
  flush() {
    ...
    let c = null;
    o < 0 && i && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && po(r) && (c = el(e)) && c.eq(I.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, Nt(e), this.currentSelection.set(r), e.scrollToSelection()) : (o > -1 || i) && (o > -1 && (e.docView.markDirty(o, s), Gp(e)), this.handleDOMChange(o, s, l, a), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(r) || Nt(e), this.currentSelection.set(r));
  }
...
let ka = /* @__PURE__ */ new WeakMap(), xa = !1;
function Gp(n) {
  if (!ka.has(n) && (ka.set(n, null), ["normal", "nowrap", "pre-line"].indexOf(getComputedStyle(n.dom).whiteSpace) !== -1)) {
    if (n.requiresGeckoHackNode = nt, xa)
      return;
...
function em(n, e, t, r, i) {
  ...
  if (n.input.compositionPendingChanges = 0, e < 0) {
    let A = n.input.lastSelectionTime > Date.now() - 50 ? n.input.lastSelectionOrigin : null, B = el(n, A);
  ...
  let a = n.state.selection, c = Xp(n, e, t), d = n.state.doc, u = d.slice(c.from, c.to), f, h;
  n.input.lastKeyCode === 8 && Date.now() - 100 < n.input.lastKeyCodeTime ? (f = n.state.selection.to, h = "end") : (f = n.state.selection.from, h = "start"), n.input.lastKeyCode = null;
  let p = rm(u.content, c.doc.content, c.from, f, h);
  if ((Zn && n.input.lastIOSEnter > Date.now() - 225 || Ze) && i.some((A) => A.nodeType == 1 && !Zp.test(A.nodeName)) && (!p || p.endA >= p.endB) && n.someProp("handleKeyDown", (A) => A(n, sn(13, "Enter")))) {
  ...
  if (n.state.selection.anchor > p.start && nm(d, p.start, p.endA, g, m) && n.someProp("handleKeyDown", (A) => A(n, sn(8, "Backspace")))) {
  ...
  if (w) {
    if (g.pos == m.pos)
      ...
      p.endA == p.endB && (z = tm(g.parent.content.cut(g.parentOffset, m.parentOffset), y.parent.content.cut(y.parentOffset, p.endA - y.start())))
    )
...
function rm(n, e, t, r, i) {
  ...
  if (s < o && n.size < e.size) {
    let a = r <= o && r >= s ? o - r : 0;
    o -= a, o && o < e.size && Ma(e.textBetween(o - 1, o + 1)) && (o += a ? 1 : -1), l = o + (l - s), s = o;
  } else if (l < o) {
    let a = r <= o && r >= l ? o - r : 0;
    o -= a, o && o < n.size && Ma(n.textBetween(o - 1, o + 1)) && (o += a ? 1 : -1), s = o + (s - l), l = o;
  }
...
class im {
  ...
  */
  constructor(e, t) {
    this._root = null, this.focused = !1, this.trackWrites = null, this.mounted = !1, this.markCursor = null, this.cursorWrapper = null, this.lastSelectedViewDesc = void 0, this.input = new Sp(), this.prevDirectPlugins = [], this.pluginViews = [], this.requiresGeckoHackNode = !1, this.dragging = null, this._props = t, this.state = t.state, this.directPlugins = t.plugins || [], this.directPlugins.forEach(Na), this.dispatch = this.dispatch.bind(this), this.dom = e && e.mount || document.createElement("div"), e && (e.appendChild ? e.appendChild(this.dom) : typeof e == "function" ? e(this.dom) : e.mount && (this.mounted = !0)), this.editable = Oa(this), Aa(this), this.nodeViews = Ea(this), this.docView = sa(this.state.doc, Ta(this), $o(this), this.dom, this), this.domObserver = new Jp(this, (r, i, o, s) => em(this, r, i, o, s)), this.domObserver.start(), Mp(this), this.updatePluginViews();
  }
  /**
  Holds `true` when a
  ...
  */
  ...
  updateStateInner(e, t) {
    ...
    e.storedMarks && this.composing && ($d(this), s = !0), this.state = e;
    let l = i.plugins != e.plugins || this._props.plugins != t.plugins;
    if (l || this._props.plugins != t.plugins || this._props.nodeViews != t.nodeViews) {
      let h = Ea(this);
      sm(h, this.nodeViews) && (this.nodeViews = h, o = !0);
    }
    (l || t.handleDOMEvents != this._props.handleDOMEvents) && Cs(this), this.editable = Oa(this), Aa(this);
    let a = $o(this), c = Ta(this), d = i.plugins != e.plugins && !i.doc.eq(e.doc) ? "reset" : e.scrollToSelection > i.scrollToSelection ? "to selection" : "preserve", u = o || !this.docView.matchesNode(e.doc, c, a);
    (u || !e.selection.eq(i.selection)) && (s = !0);
    let f = d == "preserve" && s && this.dom.style.overflowAnchor == null && Fh(this);
    if (s) {
      this.domObserver.stop();
      let h = u && (Le || Ae) && !this.composing && !i.selection.empty && !e.selection.empty && om(i.selection, e.selection);
      if (u) {
        let p = Ae ? this.trackWrites = this.domSelectionRange().focusNode : null;
        this.composing && (this.input.compositionNode = Hp(this)), (o || !this.docView.update(e.doc, c, a, this)) && (this.docView.updateOuterDeco(c), this.docView.destroy(), this.docView = sa(e.doc, c, a, this.dom, this)), p && !this.trackWrites && (h = !0);
      }
      h || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && dp(this)) ? Nt(this, h) : (Od(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
    }
    this.updatePluginViews(i), !((r = this.dragging) === null || r === void 0) && r.node && !i.doc.eq(e.doc) && this.updateDraggedNode(this.dragging, i), d == "reset" ? this.dom.scrollTop = 0 : d == "to selection" ? this.scrollToSelection() : f && $h(f);
  }
  /**
  @internal
  */
  ...
  updateDraggedNode(e, t) {
    ...
    this.dragging = new Wd(e.slice, e.move, i < 0 ? void 0 : R.create(this.state.doc, i));
  }
  someProp(e, t) {
  ...
  */
  focus() {
    this.domObserver.stop(), this.editable && jh(this.dom), Nt(this), this.domObserver.start();
  }
  /**
  ...
  */
  destroy() {
    this.docView && (Tp(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], $o(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, Oh());
  }
  /**
  ...
  */
  domSelectionRange() {
    ...
    return Oe && this.root.nodeType === 11 && Lh(this.dom.ownerDocument) == this.dom && Yp(this, e) || e;
  }
  /**
  @internal
  */
...
var Gt = {
  ...
  221: "}",
  222: '"'
}, lm = typeof navigator < "u" && /Mac/.test(navigator.platform), am = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
...
function cm(n) {
  var e = lm && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey || am && n.shiftKey && n.key && n.key.length == 1 || n.key == "Unidentified", t = !e && n.key || (n.shiftKey ? ji : Gt)[n.keyCode] || n.key || "Unidentified";
...
function hm(n) {
  return new te({ props: { handleKeyDown: ll(n) } });
}
function ll(n) {
  let e = fm(n);
  return function(t, r) {
    let i = cm(r), o, s = e[_o(i, r)];
...
const pm = (n, e) => n.selection.empty ? !1 : (e && e(n.tr.deleteSelection().scrollIntoView()), !0);
function Jd(n, e) {
...
const mm = (n, e, t) => {
  ...
  let o = i.nodeBefore;
  if (!o.type.spec.isolating && Qd(n, i, e))
    return !0;
...
function Qd(n, e, t) {
  ...
  if (l && (o = (s = r.contentMatchAt(r.childCount)).findWrapping(i.type)) && s.matchType(o[0] || i.type).validEnd) {
    if (t) {
      ...
      f = x.from(r.copy(f));
      let h = n.tr.step(new he(e.pos - 1, u, e.pos, u, new M(f, 1, 0), o.length, !0)), p = u + 2 * o.length;
    ...
    if (u.canReplace(u.childCount, u.childCount, h.content)) {
      if (t) {
        ...
        for (let y = f.length - 1; y >= 0; y--)
          g = x.from(f[y].copy(g));
        let m = n.tr.step(new he(e.pos - f.length, e.pos + i.nodeSize, e.pos + p, e.pos + i.nodeSize - p, new M(g, f.length, 0), 0, !0));
        t(m.scrollIntoView());
      }
      return !0;
    }
...
const Nm = Zd(-1), Dm = Zd(1);
function Rm(n, e = null) {
  return function(t, r) {
    let { $from: i, $to: o } = t.selection, s = i.blockRange(o), l = s && Ys(s, n, e);
...
function Lm(n, e = null) {
  return function(t, r) {
    ...
    let c = Ys(a, n, e, s);
    return c ? (r && r(Im(t.tr, s, c, l, n).scrollIntoView()), !0) : !1;
  };
}
function Im(n, e, t, r, i) {
  ...
  n.step(new he(e.start - (r ? 2 : 0), e.end, e.start, e.end, new M(o, 0, 0), t.length, !0));
  let s = 0;
  for (let d = 0; d < t.length; d++)
    t[d].type == i && (s = d + 1);
...
function Pm(n) {
  return function(e, t) {
    ...
    return o ? t ? r.node(o.depth - 1).type == n ? Bm(e, t, n, o) : zm(e, t, o) : !0 : !1;
  };
}
function Bm(n, e, t, r) {
  let i = n.tr, o = r.end, s = r.$to.end(r.depth);
  o < s && (i.step(new he(o - 1, s, o, s, new M(x.from(t.create(null, r.parent.copy())), 1, 0), 1, !0)), r = new Ii(i.doc.resolve(r.$from.pos), i.doc.resolve(s), r.depth));
  const l = sr(r);
  if (l == null)
    return !1;
  i.lift(r, l);
...
function zm(n, e, t) {
  ...
  return r.step(new he(u - (l ? 1 : 0), f + (a ? 1 : 0), u + 1, f - 1, new M((l ? x.empty : x.from(i.copy(x.empty))).append(a ? x.empty : x.from(i.copy(x.empty))), l ? 0 : 1, a ? 0 : 1), l ? 0 : 1)), e(r.scrollIntoView()), !0;
}
function Hm(n) {
  return function(e, t) {
  ...
  return n.style ? n : {
    ...
    getAttrs: (t) => {
      ...
      const i = e.reduce((o, s) => {
        const l = s.attribute.parseHTML ? s.attribute.parseHTML(t) : $m(t.getAttribute(s.name));
        return l == null ? o : {
          ...o,
          [s.name]: l
        };
...
function jm(n, e) {
  var t;
  const r = eu(n), { nodeExtensions: i, markExtensions: o } = bo(n), s = (t = i.find((c) => E(c, "topNode"))) === null || t === void 0 ? void 0 : t.name, l = Object.fromEntries(i.map((c) => {
  ...
  return t.map((d) => new te({
    ...
    appendTransaction: (u, f, h) => {
      ...
      if (!g && !m && !w)
        return;
      if (w) {
        const { from: T, text: b } = y, O = T + b.length, z = Gm(b);
        return a({
          rule: d,
          state: h,
          from: T,
...
class jn {
  constructor(e, t) {
    this.splittableMarks = [], this.editor = t, this.extensions = jn.resolve(e), this.schema = jm(this.extensions, t), this.setupExtensions();
  }
  /**
   ...
   */
  static resolve(e) {
    const t = jn.sort(jn.flatten(e)), r = Xm(t.map((i) => i.name));
...
function Ko(n) {
  return Qm(n) !== "Object" ? !1 : n.constructor === Object && Object.getPrototypeOf(n) === Object.prototype;
}
function ko(n, e) {
  const t = { ...n };
      ...
      new te({
        ...
        props: {
          clipboardTextSerializer: () => {
            const { editor: n } = this, { state: e, schema: t } = n, { doc: r, selection: i } = e, { ranges: o } = i, s = Math.min(...o.map((d) => d.$from.pos)), l = Math.max(...o.map((d) => d.$to.pos)), a = iu(t);
            return ru(r, { from: s, to: l }, {
...
}), eg = () => ({ editor: n, view: e }) => (requestAnimationFrame(() => {
  var t;
  n.isDestroyed || (e.dom.blur(), (t = window == null ? void 0 : window.getSelection()) === null || t === void 0 || t.removeAllRanges());
}), !0), tg = (n = !1) => ({ commands: e }) => e.setContent("", n), ng = () => ({ state: n, tr: e, dispatch: t }) => {
...
}, rg = (n) => (e) => n(e), ig = () => ({ state: n, dispatch: e }) => Tm(n, e), og = (n, e) => ({ editor: t, tr: r }) => {
...
}, cg = () => ({ state: n, dispatch: e }) => pm(n, e), dg = () => ({ commands: n }) => n.keyboardShortcut("Enter"), ug = () => ({ state: n, dispatch: e }) => Mm(n, e);
...
function ul(n, e, t = {}) {
  ...
  for (; l < n.parent.childCount && fg([...n.parent.child(l).marks], e, t); )
...
const hg = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
...
const mg = (n = null, e = {}) => ({ editor: t, view: r, tr: i, dispatch: o }) => {
  e = {
    scrollIntoView: !0,
    ...e
  };
  const s = () => {
    hl() && r.dom.focus(), requestAnimationFrame(() => {
      t.isDestroyed || (r.focus(), e != null && e.scrollIntoView && t.commands.scrollIntoView());
    });
  };
  if (r.hasFocus() && n === null || n === !1)
    return !0;
  if (o && n === null && !fl(t.state.selection))
    return s(), !0;
...
}, gg = (n, e) => (t) => n.every((r, i) => e(r, { ...t, index: i })), yg = (n, e) => ({ tr: t, commands: r }) => r.insertContentAt({ from: t.selection.from, to: t.selection.to }, n, e), su = (n) => {
...
function _i(n, e, t) {
  ...
  if (i) {
    ...
    return t.slice ? o.parseSlice(Pa(n), t.parseOptions).content : o.parse(Pa(n), t.parseOptions);
  }
  return _i("", e, t);
}
function vg(n, e, t) {
...
const bg = (n) => n.toString().startsWith("<"), wg = (n, e, t) => ({ tr: r, dispatch: i, editor: o }) => {
  if (i) {
    t = {
      parseOptions: {},
      updateSelection: !0,
    ...
    let f;
    c ? (Array.isArray(e) ? f = e.map((h) => h.text || "").join("") : typeof e == "object" && e && e.text ? f = e.text : f = e, r.insertText(f, l, a)) : (f = s, r.replaceWith(l, a, f)), t.updateSelection && vg(r, r.steps.length - 1, -1), t.applyInputRules && r.setMeta("applyInputRules", { from: l, text: f }), t.applyPasteRules && r.setMeta("applyPasteRules", { from: l, text: f });
  }
  return !0;
}, kg = () => ({ state: n, dispatch: e }) => km(n, e), xg = () => ({ state: n, dispatch: e }) => xm(n, e), Cg = () => ({ state: n, dispatch: e }) => mm(n, e), Sg = () => ({ state: n, dispatch: e }) => bm(n, e), Mg = () => ({ tr: n, state: e, dispatch: t }) => {
  try {
...
}, Ag = () => ({ state: n, dispatch: e }) => gm(n, e), Og = () => ({ state: n, dispatch: e }) => ym(n, e);
function lu() {
...
const Ng = (n) => ({ editor: e, view: t, tr: r, dispatch: i }) => {
  const o = Eg(n).split(/-(?!$)/), s = o.find((c) => !["Alt", "Ctrl", "Meta", "Shift"].includes(c)), l = new KeyboardEvent("keydown", {
    key: s === "Space" ? " " : s,
...
const Dg = (n, e = {}) => ({ state: t, dispatch: r }) => {
  const i = me(n, t.schema);
  return Br(t, i, e) ? Cm(t, r) : !1;
}, Rg = () => ({ state: n, dispatch: e }) => Am(n, e), Lg = (n) => ({ state: e, dispatch: t }) => {
  const r = me(n, e.schema);
  return Pm(r)(e, t);
}, Ig = () => ({ state: n, dispatch: e }) => Sm(n, e);
function xo(n, e) {
...
const Pg = (n, e) => ({ tr: t, state: r, dispatch: i }) => {
  let o = null, s = null;
  const l = xo(typeof n == "string" ? n : n.name, r.schema);
  return l ? (l === "node" && (o = me(n, r.schema)), l === "mark" && (s = Zt(n, r.schema)), i && t.selection.ranges.forEach((a) => {
    r.doc.nodesBetween(a.$from.pos, a.$to.pos, (c, d) => {
      o && o === c.type && t.setNodeMarkup(d, void 0, Ba(c.attrs, e)), s && c.marks.length && c.marks.forEach((u) => {
        s === u.type && t.addMark(d, d + c.nodeSize, s.create(Ba(u.attrs, e)));
      });
    });
  }), !0) : !1;
}, Bg = () => ({ tr: n, dispatch: e }) => (e && n.scrollIntoView(), !0), zg = () => ({ tr: n, commands: e }) => e.setTextSelection({
  from: 0,
  to: n.doc.content.size
}), Hg = () => ({ state: n, dispatch: e }) => vm(n, e), Vg = () => ({ state: n, dispatch: e }) => wm(n, e), Fg = () => ({ state: n, dispatch: e }) => Om(n, e), $g = () => ({ state: n, dispatch: e }) => Dm(n, e), jg = () => ({ state: n, dispatch: e }) => Nm(n, e);
function au(n, e, t = {}) {
  return _i(n, e, { slice: !1, parseOptions: t });
}
const Wg = (n, e = !1, t = {}) => ({ tr: r, editor: i, dispatch: o }) => {
  const { doc: s } = r, l = au(n, i.schema, t);
...
function du(n, e) {
  ...
  return t === "node" ? Gg(n, e) : t === "mark" ? Co(n, e) : {};
}
...
function ml(n, e, t) {
  ...
  return n === e ? t.resolve(n).marks().forEach((i) => {
    const o = t.resolve(n - 1), s = ul(o, i.type);
    s && r.push({
      mark: i,
      ...s
    });
...
const r1 = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  ...
  return n1(r, t, a);
}, i1 = (n, e) => ({ tr: t }) => (t.setMeta(n, e), !0), o1 = (n, e = {}) => ({ state: t, dispatch: r, chain: i }) => {
...
const c1 = ({ keepMarks: n = !0 } = {}) => ({ tr: e, state: t, dispatch: r, editor: i }) => {
  ...
  if (o instanceof R && o.node.isBlock)
    return !l.parentOffset || !Un(s, l.pos) ? !1 : (r && (n && Ha(t, i.extensionManager.splittableMarks), e.split(l.pos).scrollIntoView()), !0);
  if (!l.parent.isBlock)
    return !1;
  if (r) {
    const u = a.parentOffset === a.parent.content.size;
    o instanceof L && e.deleteSelection();
    const f = l.depth === 0 ? void 0 : qg(l.node(-1).contentMatchAt(l.indexAfter(-1)));
    let h = u && f ? [
      {
        type: f,
        attrs: d
    ...
    n && Ha(t, i.extensionManager.splittableMarks), e.scrollIntoView();
  }
  return !0;
}, d1 = (n) => ({ tr: e, state: t, dispatch: r, editor: i }) => {
  var o;
  ...
  const t = pl((s) => s.type === e)(n.selection);
  if (!t)
    return !0;
...
}, u1 = (n, e, t, r = {}) => ({ editor: i, tr: o, state: s, dispatch: l, chain: a, commands: c, can: d }) => {
  const { extensions: u, splittableMarks: f } = i.extensionManager, h = me(n, s.schema), p = me(e, s.schema), { selection: g, storedMarks: m } = s, { $from: y, $to: w } = g, C = y.blockRange(w), v = m || g.$to.parentOffset && g.$from.marks();
  if (!C)
    return !1;
  const T = pl((b) => za(b.type.name, u))(g);
  if (C.depth >= 1 && T && C.depth - T.depth <= 1) {
    if (T.node.type === h)
      return c.liftListItem(p);
    if (za(T.node.type.name, u) && h.validContent(T.node.content) && l)
  ...
  if (d && s) {
    let { from: f, to: h } = l;
    const p = (o = c.marks().find((m) => m.type === a)) === null || o === void 0 ? void 0 : o.attrs, g = ul(c, a, p);
...
var k1 = /* @__PURE__ */ Object.freeze({
  ...
  joinItemBackward: Mg,
  joinItemForward: Tg,
  joinTextblockBackward: Ag,
  joinTextblockForward: Og,
  keyboardShortcut: Ng,
  lift: Dg,
  liftEmptyBlock: Rg,
  liftListItem: Lg,
  ...
  selectNodeForward: Vg,
  selectParentNode: Fg,
  selectTextblockEnd: $g,
  selectTextblockStart: jg,
  setContent: Wg,
  setMark: r1,
  setMeta: i1,
  setNode: o1,
...
let E1 = class extends Vm {
   ...
   */
  injectCSS() {
    this.options.injectCSS && document && (this.css = O1(A1, this.options.injectNonce));
  }
  /**
   ...
   */
  createView() {
    const e = au(this.options.content, this.schema, this.options.parseOptions), t = ou(e, this.options.autofocus);
    this.view = new im(this.options.element, {
   ...
   */
  getHTML() {
    return Ug(this.state.doc.content, this.schema);
  }
  /**
  ...
  return new wo({
    ...
    handler: ({ state: e, range: t, match: r }) => {
      ...
      if (s) {
        ...
        if (ml(t.from, t.to, e.doc).filter((h) => h.mark.type.excluded.find((g) => g === n.type && g !== h.mark.type)).filter((h) => h.to > c).length)
          return null;
...
function zr(n) {
  return new wo({
    ...
    handler: ({ state: e, range: t, match: r, chain: i }) => {
      const o = H(n.getAttributes, void 0, r) || {}, s = e.tr.delete(t.from, t.to), a = s.doc.resolve(t.from).blockRange(), c = a && Ys(a, n.type, o);
      if (!c)
        return null;
  ...
  return new nu({
    ...
    handler: ({ state: e, range: t, match: r, pasteEvent: i }) => {
      ...
      if (l) {
        ...
        if (ml(t.from, t.to, e.doc).filter((p) => p.mark.type.excluded.find((m) => m === n.type && m !== p.mark.type)).filter((p) => p.to > u).length)
          return null;
...
var Ie = "top", Ge = "bottom", Ye = "right", Pe = "left", gl = "auto", Yr = [Ie, Ge, Ye, Pe], tr = "start", Hr = "end", L1 = "clippingParents", fu = "viewport", mr = "popper", I1 = "reference", Va = /* @__PURE__ */ Yr.reduce(function(n, e) {
  return n.concat([e + "-" + tr, e + "-" + Hr]);
}, []), hu = /* @__PURE__ */ [].concat(Yr, [gl]).reduce(function(n, e) {
  return n.concat([e, e + "-" + tr, e + "-" + Hr]);
}, []), P1 = "beforeRead", B1 = "read", z1 = "afterRead", H1 = "beforeMain", V1 = "main", F1 = "afterMain", $1 = "beforeWrite", j1 = "write", W1 = "afterWrite", _1 = [P1, B1, z1, H1, V1, F1, $1, j1, W1];
function gt(n) {
...
function rr(n, e, t) {
  ...
  var s = Mn(n) ? Ve(n) : window, l = s.visualViewport, a = !mu() && t, c = (r.left + (a && l ? l.offsetLeft : 0)) / i, d = (r.top + (a && l ? l.offsetTop : 0)) / o, u = r.width / i, f = r.height / o;
  return {
    width: u,
    height: f,
    top: d,
...
function So(n) {
  return gt(n) === "html" ? n : (
    ...
    (yl(n) ? n.host : null) || // ShadowRoot detected
...
function J1(n) {
  ...
  var i = So(n);
  for (yl(i) && (i = i.host); Je(i) && ["html", "body"].indexOf(gt(i)) < 0; ) {
    var o = Dt(i);
...
function Xr(n) {
  for (var e = Ve(n), t = Fa(n); t && U1(t) && Dt(t).position === "static"; )
    t = Fa(t);
  return t && (gt(t) === "html" || gt(t) === "body" && Dt(t).position === "static") ? e : t || J1(n) || e;
}
function bl(n) {
...
var Y1 = function(e, t) {
  ...
  })) : e, vu(typeof e != "number" ? e : bu(e, Yr));
};
function X1(n) {
  var e, t = n.state, r = n.name, i = n.options, o = t.elements.arrow, s = t.modifiersData.popperOffsets, l = ht(t.placement), a = bl(l), c = [Pe, Ye].indexOf(l) >= 0, d = c ? "height" : "width";
  if (!(!o || !s)) {
    var u = Y1(i.padding, t), f = vl(o), h = a === "y" ? Ie : Pe, p = a === "y" ? Ge : Ye, g = t.rects.reference[d] + t.rects.reference[a] - s[a] - t.rects.popper[d], m = s[a] - t.rects.reference[a], y = Xr(o), w = y ? a === "y" ? y.clientHeight || 0 : y.clientWidth || 0 : 0, C = g / 2 - m / 2, v = u[h], T = w - f[d] - u[p], b = w / 2 - f[d] / 2 + C, O = Cr(v, b, T), z = a;
    t.modifiersData[r] = (e = {}, e[z] = O, e.centerOffset = O - b, e);
  }
}
function Q1(n) {
  var e = n.state, t = n.options, r = t.element, i = r === void 0 ? "[data-popper-arrow]" : r;
  i != null && (typeof i == "string" && (i = e.elements.popper.querySelector(i), !i) || gu(e.elements.popper, i) && (e.elements.arrow = i));
}
const Z1 = {
  name: "arrow",
  enabled: !0,
...
function kl(n) {
  return rr(en(n)).left + wl(n).scrollLeft;
}
function a0(n, e) {
...
function c0(n) {
  var e, t = en(n), r = wl(n), i = (e = n.ownerDocument) == null ? void 0 : e.body, o = bn(t.scrollWidth, t.clientWidth, i ? i.scrollWidth : 0, i ? i.clientWidth : 0), s = bn(t.scrollHeight, t.clientHeight, i ? i.scrollHeight : 0, i ? i.clientHeight : 0), l = -r.scrollLeft + kl(n), a = -r.scrollTop;
...
function wu(n) {
  return ["html", "body", "#document"].indexOf(gt(n)) >= 0 ? n.ownerDocument.body : Je(n) && xl(n) ? n : wu(So(n));
}
function Sr(n, e) {
  var t;
  e === void 0 && (e = []);
  var r = wu(n), i = r === ((t = n.ownerDocument) == null ? void 0 : t.body), o = Ve(r), s = i ? [o].concat(o.visualViewport || [], xl(r) ? r : []) : r, l = e.concat(s);
  return i ? l : (
...
function Wa(n, e, t) {
  return e === fu ? Ns(a0(n, t)) : Mn(e) ? d0(e, t) : Ns(c0(en(n)));
}
function u0(n) {
  var e = Sr(So(n)), t = ["absolute", "fixed"].indexOf(Dt(n).position) >= 0, r = t && Je(n) ? Xr(n) : n;
  return Mn(r) ? e.filter(function(i) {
    return Mn(i) && gu(i, r) && gt(i) !== "body";
  }) : [];
}
function f0(n, e, t, r) {
  var i = e === "clippingParents" ? u0(n) : [].concat(e), o = [].concat(i, [t]), s = o[0], l = o.reduce(function(a, c) {
    var d = Wa(n, c, r);
...
function Vr(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = r === void 0 ? n.placement : r, o = t.strategy, s = o === void 0 ? n.strategy : o, l = t.boundary, a = l === void 0 ? L1 : l, c = t.rootBoundary, d = c === void 0 ? fu : c, u = t.elementContext, f = u === void 0 ? mr : u, h = t.altBoundary, p = h === void 0 ? !1 : h, g = t.padding, m = g === void 0 ? 0 : g, y = vu(typeof m != "number" ? m : bu(m, Yr)), w = f === mr ? I1 : mr, C = n.rects.popper, v = n.elements[p ? w : f], T = f0(Mn(v) ? v : v.contextElement || en(n.elements.popper), a, d, s), b = rr(n.elements.reference), O = ku({
    reference: b,
    element: C,
    strategy: "absolute",
    placement: i
  }), z = Ns(Object.assign({}, C, O)), A = f === mr ? z : b, B = {
  ...
  if (f === mr && V) {
    ...
    Object.keys(B).forEach(function(_) {
      var le = [Ye, Ge].indexOf(_) >= 0 ? 1 : -1, X = [Ie, Ge].indexOf(_) >= 0 ? "y" : "x";
      B[_] += $[X] * le;
    });
  }
  return B;
...
function h0(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = t.boundary, o = t.rootBoundary, s = t.padding, l = t.flipVariations, a = t.allowedAutoPlacements, c = a === void 0 ? hu : a, d = ir(r), u = d ? l ? Va : Va.filter(function(p) {
    return ir(p) === d;
...
function m0(n) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !0 : s, a = t.fallbackPlacements, c = t.padding, d = t.boundary, u = t.rootBoundary, f = t.altBoundary, h = t.flipVariations, p = h === void 0 ? !0 : h, g = t.allowedAutoPlacements, m = e.options.placement, y = ht(m), w = y === m, C = a || (w || !p ? [Mi(m)] : p0(m)), v = [m].concat(C).reduce(function(vt, Xe) {
      return vt.concat(ht(Xe) === gl ? h0(e, {
        placement: Xe,
        boundary: d,
        rootBoundary: u,
        padding: c,
      ...
      var V = v[B], $ = ht(V), _ = ir(V) === tr, le = [Ie, Ge].indexOf($) >= 0, X = le ? "width" : "height", U = Vr(e, {
        placement: V,
        boundary: d,
        rootBoundary: u,
        altBoundary: f,
        padding: c
      }), J = le ? _ ? Ye : Pe : _ ? Ge : Ie;
      T[X] > b[X] && (J = Mi(J));
      var W = Mi(J), se = [];
...
function y0(n) {
  var e = n.state, t = n.name, r = e.rects.reference, i = e.rects.popper, o = e.modifiersData.preventOverflow, s = Vr(e, {
    ...
    altBoundary: !0
  }), a = _a(s, r), c = _a(l, i, o), d = qa(a), u = qa(c);
  e.modifiersData[t] = {
...
function w0(n) {
  var e = n.state, t = n.options, r = n.name, i = t.offset, o = i === void 0 ? [0, 0] : i, s = hu.reduce(function(d, u) {
    return d[u] = b0(u, e.rects, o), d;
...
function M0(n) {
  var e = n.state, t = n.options, r = n.name, i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !1 : s, a = t.boundary, c = t.rootBoundary, d = t.altBoundary, u = t.padding, f = t.tether, h = f === void 0 ? !0 : f, p = t.tetherOffset, g = p === void 0 ? 0 : p, m = Vr(e, {
    ...
    padding: u,
    altBoundary: d
  }), y = ht(e.placement), w = ir(e.placement), C = !w, v = bl(y), T = S0(v), b = e.modifiersData.popperOffsets, O = e.rects.reference, z = e.rects.popper, A = typeof g == "function" ? g(Object.assign({}, e.rects, {
    placement: e.placement
  })) : g, B = typeof A == "number" ? {
    mainAxis: A,
    altAxis: A
  ...
  if (b) {
    if (o) {
      var _, le = v === "y" ? Ie : Pe, X = v === "y" ? Ge : Ye, U = v === "y" ? "height" : "width", J = b[v], W = J + m[le], se = J - m[X], ne = h ? -z[U] / 2 : 0, De = w === tr ? O[U] : z[U], ue = w === tr ? -z[U] : -O[U], Fe = e.elements.arrow, vt = h && Fe ? vl(Fe) : {
        width: 0,
        height: 0
      }, Xe = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : yu(), bt = Xe[le], On = Xe[X], wt = Cr(0, O[U], vt[U]), En = C ? O[U] / 2 - ne - wt - bt - B.mainAxis : De - wt - bt - B.mainAxis, Rt = C ? -O[U] / 2 + ne + wt + On + B.mainAxis : ue + wt + On + B.mainAxis, Nn = e.elements.arrow && Xr(e.elements.arrow), Qr = Nn ? v === "y" ? Nn.clientTop || 0 : Nn.clientLeft || 0 : 0, ar = (_ = V == null ? void 0 : V[v]) != null ? _ : 0, Zr = J + En - ar - Qr, ei = J + Rt - ar, cr = Cr(h ? qi(W, Zr) : W, J, h ? bn(se, ei) : se);
      b[v] = cr, $[v] = cr - J;
    }
    if (l) {
      var dr, ti = v === "x" ? Ie : Pe, ni = v === "x" ? Ge : Ye, kt = b[T], Lt = T === "y" ? "height" : "width", ur = kt + m[ti], tn = kt - m[ni], fr = [Ie, Pe].indexOf(y) !== -1, ri = (dr = V == null ? void 0 : V[T]) != null ? dr : 0, ii = fr ? ur : kt - O[Lt] - z[Lt] - ri + B.altAxis, oi = fr ? kt + O[Lt] + z[Lt] - ri - B.altAxis : tn, si = h && fr ? G1(ii, kt, oi) : Cr(h ? ii : ur, kt, h ? oi : tn);
      b[T] = si, $[T] = si - kt;
    }
    e.modifiersData[r] = $;
  }
...
function N0(n, e, t) {
  t === void 0 && (t = !1);
  var r = Je(e), i = Je(e) && E0(e), o = en(e), s = rr(n, i, t), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, a = {
    x: 0,
  ...
  xl(o)) && (l = O0(e)), Je(e) ? (a = rr(e, !0), a.x += e.clientLeft, a.y += e.clientTop) : o && (a.x = kl(o))), {
  ...
  return function(l, a, c) {
    ...
    var d = {
      ...
      setOptions: function(y) {
        ...
        var C = R0(I0([].concat(r, d.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!f) {
          ...
          if (Ua(w, C)) {
            d.rects = {
              reference: N0(w, Xr(C), d.options.strategy === "fixed"),
              popper: vl(C)
...
var B0 = [o0, C0, r0, pu, k0, g0, T0, Z1, v0], z0 = /* @__PURE__ */ P0({
  defaultModifiers: B0
}), H0 = "tippy-box", xu = "tippy-content", V0 = "tippy-backdrop", Cu = "tippy-arrow", Su = "tippy-svg-arrow", on = {
  passive: !0,
  capture: !0
}, Mu = function() {
...
function J0(n) {
  return Fr(n) ? [n] : q0(n) ? Ki(n) : Array.isArray(n) ? n : Ki(document.querySelectorAll(n));
}
function Yo(n, e) {
...
function Y0(n, e) {
  ...
  return n.every(function(i) {
    var o = i.popperRect, s = i.popperState, l = i.props, a = l.interactiveBorder, c = _0(s.placement), d = s.modifiersData.offset;
    if (!d)
      return !0;
...
function X0() {
  ct.isTouch || (ct.isTouch = !0, window.performance && document.addEventListener("mousemove", Au));
}
function Au() {
  var n = performance.now();
  n - Za < 20 && (ct.isTouch = !1, document.removeEventListener("mousemove", Au)), Za = n;
}
function Q0() {
...
function Z0() {
  document.addEventListener("touchstart", X0, on), window.addEventListener("blur", Q0);
}
var ey = typeof window < "u" && typeof document < "u", ty = ey ? (
  // @ts-ignore
  !!window.msCrypto
) : !1;
function Pn(n) {
...
var $r;
process.env.NODE_ENV !== "production" && ry();
function ry() {
  $r = /* @__PURE__ */ new Set();
}
function Ot(n, e) {
  if (n && !$r.has(e)) {
    var t;
    $r.add(e), (t = console).warn.apply(t, Ou(e));
  }
}
function Ds(n, e) {
  if (n && !$r.has(e)) {
    var t;
    $r.add(e), (t = console).error.apply(t, Ou(e));
  }
}
function iy(n) {
...
var Eu = {
  ...
  triggerTarget: null
}, Eu, oy), sy = Object.keys(He), ly = function(e) {
  process.env.NODE_ENV !== "production" && Du(e, []);
  var t = Object.keys(e);
...
function ay(n, e) {
  var t = e ? Object.keys(Nu(Object.assign({}, He, {
    plugins: e
...
function tc(n, e) {
  var t = Object.assign({}, e, {
    content: Tu(e.content, [n])
  }, e.ignoreAttributes ? {} : ay(n, e.plugins));
...
function Du(n, e) {
  ...
  var t = Object.keys(n);
  t.forEach(function(r) {
    var i = $0(He, Object.keys(Eu)), o = !F0(i, r);
...
function nc(n) {
  var e = Mr();
  return n === !0 ? e.className = Cu : (e.className = Su, Fr(n) ? e.appendChild(n) : Rs(e, n)), e;
}
function rc(n, e) {
  Fr(e.content) ? (Rs(n, ""), n.appendChild(e.content)) : typeof e.content != "function" && (e.allowHTML ? Rs(n, e.content) : n.textContent = e.content);
}
function Ls(n) {
  ...
  return {
    ...
    content: t.find(function(r) {
      return r.classList.contains(xu);
    }),
    arrow: t.find(function(r) {
      return r.classList.contains(Cu) || r.classList.contains(Su);
    }),
    backdrop: t.find(function(r) {
      return r.classList.contains(V0);
    })
  };
}
function Ru(n) {
  var e = Mr(), t = Mr();
  t.className = H0, t.setAttribute("data-state", "hidden"), t.setAttribute("tabindex", "-1");
  var r = Mr();
  r.className = xu, r.setAttribute("data-state", "hidden"), rc(r, n.props), e.appendChild(t), t.appendChild(r), i(n.props, n.props);
  function i(o, s) {
    var l = Ls(e), a = l.box, c = l.content, d = l.arrow;
    s.theme ? a.setAttribute("data-theme", s.theme) : a.removeAttribute("data-theme"), typeof s.animation == "string" ? a.setAttribute("data-animation", s.animation) : a.removeAttribute("data-animation"), s.inertia ? a.setAttribute("data-inertia", "") : a.removeAttribute("data-inertia"), a.style.maxWidth = typeof s.maxWidth == "number" ? s.maxWidth + "px" : s.maxWidth, s.role ? a.setAttribute("role", s.role) : a.removeAttribute("role"), (o.content !== s.content || o.allowHTML !== s.allowHTML) && rc(c, n.props), s.arrow ? d ? o.arrow !== s.arrow && (a.removeChild(d), a.appendChild(nc(s.arrow))) : a.appendChild(nc(s.arrow)) : d && a.removeChild(d);
  }
  return {
    popper: e,
    onUpdate: i
...
var dy = 1, pi = [], Qo = [];
function uy(n, e) {
  var t = tc(n, Object.assign({}, He, Nu(Ya(e)))), r, i, o, s = !1, l = !1, a = !1, c = !1, d, u, f, h = [], p = Ja(Zr, t.interactiveDebounce), g, m = dy++, y = null, w = W0(t.plugins), C = {
  ...
  return Nn(), ne(), J(), W("onCreate", [v]), t.showOnCreate && ur(), b.addEventListener("mouseenter", function() {
    ...
    v.props.interactive && v.props.trigger.indexOf("mouseenter") >= 0 && le().addEventListener("mousemove", p);
  }), v;
  function B() {
    var k = v.props.touch;
  ...
  function De() {
    le().removeEventListener("mousemove", p), pi = pi.filter(function(k) {
      return k !== p;
    });
  }
  function ue(k) {
  ...
  function Xe() {
    var k = le();
    k.addEventListener("mousedown", ue, !0), k.addEventListener("touchend", ue, on), k.addEventListener("touchstart", vt, on), k.addEventListener("touchmove", Fe, on);
  }
  function bt() {
    var k = le();
    k.removeEventListener("mousedown", ue, !0), k.removeEventListener("touchend", ue, on), k.removeEventListener("touchstart", vt, on), k.removeEventListener("touchmove", Fe, on);
  }
  function On(k, N) {
    En(k, function() {
  ...
  function Nn() {
    V() && (Rt("touchstart", ar, {
      ...
      passive: !0
    })), j0(v.props.trigger).forEach(function(k) {
      if (k !== "manual")
        switch (Rt(k, ar), k) {
          case "mouseenter":
            Rt("mouseleave", ei);
  ...
  function ar(k) {
    ...
    if (!(!v.state.isEnabled || dr(k) || l)) {
      ...
      d = k, g = k.currentTarget, ne(), !v.state.isVisible && K0(k) && pi.forEach(function(j) {
        return j(k);
  ...
  function ti() {
    ni();
    var k = v.props, N = k.popperOptions, P = k.placement, q = k.offset, j = k.getReferenceClientRect, Se = k.moveTransition, $e = $() ? Ls(b).arrow : null, Dn = j ? {
    ...
    }), nn.push.apply(nn, (N == null ? void 0 : N.modifiers) || []), v.popperInstance = z0(Dn, b, Object.assign({}, N, {
      placement: P,
      onFirstUpdate: f,
      modifiers: nn
    }));
...
`, "See: https://atomiks.github.io/tippyjs/v6/accessibility/#interactivity"].join(" "));
  ...
  function oi(k) {
    if (process.env.NODE_ENV !== "production" && Ot(v.state.isDestroyed, Pn("setProps")), !v.state.isDestroyed) {
      ...
      var N = v.props, P = tc(n, Object.assign({}, N, Ya(k), {
        ignoreAttributes: !0
      }));
      v.props = P, Nn(), N.interactiveDebounce !== P.interactiveDebounce && (De(), p = Ja(Zr, P.interactiveDebounce)), N.triggerTarget && !P.triggerTarget ? Vn(N.triggerTarget).forEach(function(q) {
      ...
      f = function() {
        ...
        if (!(!v.state.isVisible || c)) {
          if (c = !0, b.offsetHeight, b.style.transition = v.props.moveTransition, $() && v.props.animation) {
            ...
            Yo([li, Rn], j), Xa([li, Rn], "visible");
          }
          se(), ne(), Ga(Qo, v), (nn = v.popperInstance) == null || nn.forceUpdate(), W("onMount", [v]), v.props.animation && $() && wt(j, function() {
  ...
  function sf() {
    ...
    if (!(k || N || P) && (W("onHide", [v], !1), v.props.onHide(v) !== !1)) {
      if (v.state.isVisible = !1, v.state.isShown = !1, c = !1, s = !1, $() && (b.style.visibility = "hidden"), De(), bt(), J(!0), $()) {
        ...
        v.props.animation && (Yo([Se, $e], q), Xa([Se, $e], "hidden"));
      }
      se(), ne(), v.props.animation ? $() && On(q, v.unmount) : v.unmount();
    }
  }
  function lf(k) {
    process.env.NODE_ENV !== "production" && Ot(v.state.isDestroyed, Pn("hideWithInteractivity")), le().addEventListener("mousemove", p), Ga(pi, p), p(k);
  }
  function af() {
...
function An(n, e) {
  ...
  process.env.NODE_ENV !== "production" && (iy(n), Du(e, t)), Z0();
...
class fy {
  constructor({ editor: e, element: t, view: r, tippyOptions: i = {}, updateDelay: o = 250, shouldShow: s }) {
    this.preventHide = !1, this.shouldShow = ({ view: l, state: a, from: c, to: d }) => {
      const { doc: u, selection: f } = a, { empty: h } = f, p = !u.textBetween(c, d).length && fl(a.selection), g = this.element.contains(document.activeElement);
...
class hy {
  ...
  update(e, t) {
    ...
    (i = this.tippy) === null || i === void 0 || i.setProps({
      getReferenceClientRect: ((o = this.tippyOptions) === null || o === void 0 ? void 0 : o.getReferenceClientRect) || (() => uu(e, c, d))
    }), this.show();
  }
  show() {
    var e;
...
class my extends E1 {
  constructor(e = {}) {
    return super(e), this.vueRenderers = Bc(/* @__PURE__ */ new Map()), this.contentComponent = null, this.reactiveState = ic(this.view.state), this.reactiveExtensionStorage = ic(this.extensionStorage), this.on("transaction", () => {
...
class yy {
  constructor(e, { props: t = {}, editor: r }) {
    if (this.id = Math.floor(Math.random() * 4294967295).toString(), this.editor = r, this.component = zc(e), this.teleportElement = document.createElement("div"), this.element = this.teleportElement, this.props = Bc(t), this.editor.vueRenderers.set(this.id, this), this.editor.contentComponent) {
...
const vy = /^\s*>\s$/, Pu = ge.create({
...
}), by = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/, wy = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g, ky = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/, xy = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g, Cy = Be.create({
  name: "bold",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addCommands() {
    return {
      toggleBulletList: () => ({ commands: n, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(Sy.name, this.editor.getAttributes(oc.name)).run() : n.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
  ...
  addInputRules() {
    ...
    return (this.options.keepMarks || this.options.keepAttributes) && (n = zr({
      ...
      getAttributes: () => this.editor.getAttributes(oc.name),
      editor: this.editor
    })), [
      n
    ];
  }
}), Ty = /(?:^|\s)(`(?!\s+`)((?:[^`]+))`(?!\s+`))$/, Ay = /(?:^|\s)(`(?!\s+`)((?:[^`]+))`(?!\s+`))/g, Oy = Be.create({
  name: "code",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  dragover(e) {
    ...
    if (t && !o) {
      ...
      if (this.editorView.dragging && this.editorView.dragging.slice) {
        let l = ld(this.editorView.state.doc, s, this.editorView.dragging.slice);
        l != null && (s = l);
      }
...
var Ui = 200, pe = function() {
};
pe.prototype.append = function(e) {
  return e.length ? (e = pe.from(e), !this.length && e || e.length < Ui && this.leafAppend(e) || this.length < Ui && e.leafPrepend(this) || this.appendInner(e)) : this;
};
...
pe.from = function(e) {
  return e instanceof pe ? e : e && e.length ? new Bu(e) : pe.empty;
};
var Bu = /* @__PURE__ */ function(n) {
  function e(r) {
...
class et {
  ...
  addTransform(e, t, r, i) {
    ...
    let c = s - r.depth;
    return c > Gy && (l = Jy(l, c), s -= c), new et(l.append(o), s);
  }
  remapping(e, t) {
    let r = new Kn();
  ...
  rebased(e, t) {
    ...
    return u.emptyItemCount() > Uy && (u = u.compress(this.items.length - r.length)), u;
  }
  emptyItemCount() {
    let e = 0;
...
function Yy(n, e, t, r) {
  ...
  t.getMeta(Zy) && (n = new zt(n.done, n.undone, null, 0, -1));
  let s = t.getMeta("appendedTransaction");
  if (t.steps.length == 0)
    return n;
  if (s && s.getMeta(wn))
    return s.getMeta(wn).redo ? new zt(n.done.addTransform(t, void 0, r, Ti(e)), n.undone, lc(t.mapping.maps[t.steps.length - 1]), n.prevTime, n.prevComposition) : new zt(n.done, n.undone.addTransform(t, void 0, r, Ti(e)), null, n.prevTime, n.prevComposition);
  if (t.getMeta("addToHistory") !== !1 && !(s && s.getMeta("addToHistory") === !1)) {
    let l = t.getMeta("composition"), a = n.prevTime == 0 || !s && n.prevComposition != l && (n.prevTime < (t.time || 0) - r.newGroupDelay || !Xy(t, n.prevRanges)), c = s ? Zo(n.prevRanges, t.mapping) : lc(t.mapping.maps[t.steps.length - 1]);
...
const wn = new de("history"), Zy = new de("closeHistory");
function ev(n = {}) {
  return n = {
    depth: n.depth || 100,
...
const Hu = zu(!1, !0), Vu = zu(!0, !0), tv = oe.create({
  name: "history",
  addOptions() {
    return {
      depth: 100,
...
}), rv = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/, iv = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g, ov = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/, sv = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g, lv = Be.create({
  name: "italic",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addCommands() {
    return {
      toggleOrderedList: () => ({ commands: n, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(cv.name, this.editor.getAttributes(cc.name)).run() : n.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
...
}), fv = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/, hv = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))/g, pv = Be.create({
  name: "strike",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addExtensions() {
    ...
    const w = [];
    return this.options.blockquote !== !1 && w.push(Pu.configure((n = this.options) === null || n === void 0 ? void 0 : n.blockquote)), this.options.bold !== !1 && w.push(Cy.configure((e = this.options) === null || e === void 0 ? void 0 : e.bold)), this.options.bulletList !== !1 && w.push(My.configure((t = this.options) === null || t === void 0 ? void 0 : t.bulletList)), this.options.code !== !1 && w.push(Oy.configure((r = this.options) === null || r === void 0 ? void 0 : r.code)), this.options.codeBlock !== !1 && w.push(Dy.configure((i = this.options) === null || i === void 0 ? void 0 : i.codeBlock)), this.options.document !== !1 && w.push(Ry.configure((o = this.options) === null || o === void 0 ? void 0 : o.document)), this.options.dropcursor !== !1 && w.push(Py.configure((s = this.options) === null || s === void 0 ? void 0 : s.dropcursor)), this.options.gapcursor !== !1 && w.push(Wy.configure((l = this.options) === null || l === void 0 ? void 0 : l.gapcursor)), this.options.hardBreak !== !1 && w.push(_y.configure((a = this.options) === null || a === void 0 ? void 0 : a.hardBreak)), this.options.heading !== !1 && w.push(qy.configure((c = this.options) === null || c === void 0 ? void 0 : c.heading)), this.options.history !== !1 && w.push(tv.configure((d = this.options) === null || d === void 0 ? void 0 : d.history)), this.options.horizontalRule !== !1 && w.push(nv.configure((u = this.options) === null || u === void 0 ? void 0 : u.horizontalRule)), this.options.italic !== !1 && w.push(lv.configure((f = this.options) === null || f === void 0 ? void 0 : f.italic)), this.options.listItem !== !1 && w.push(av.configure((h = this.options) === null || h === void 0 ? void 0 : h.listItem)), this.options.orderedList !== !1 && w.push(dv.configure((p = this.options) === null || p === void 0 ? void 0 : p.orderedList)), this.options.paragraph !== !1 && w.push(uv.configure((g = this.options) === null || g === void 0 ? void 0 : g.paragraph)), this.options.strike !== !1 && w.push(pv.configure((m = this.options) === null || m === void 0 ? void 0 : m.strike)), this.options.text !== !1 && w.push(mv.configure((y = this.options) === null || y === void 0 ? void 0 : y.text)), w;
  }
}), yv = "ö", vv = "ελ1υ2бг1ел3дети4ею2католик6ом3мкд2он1сква6онлайн5рг3рус2ф2сайт3рб3укр3қаз3հայ3ישראל5קום3ابوظبي5تصالات6رامكو5لاردن4بحرين5جزائر5سعودية6عليان5مغرب5مارات5یران5بارت2زار4يتك3ھارت5تونس4سودان3رية5شبكة4عراق2ب2مان4فلسطين6قطر3كاثوليك6وم3مصر2ليسيا5وريتانيا7قع4همراه5پاکستان7ڀارت4कॉम3नेट3भारत0म्3ोत5संगठन5বাংলা5ভারত2ৰত4ਭਾਰਤ4ભારત4ଭାରତ4இந்தியா6லங்கை6சிங்கப்பூர்11భారత్5ಭಾರತ4ഭാരതം5ලංකා4คอม3ไทย3ລາວ3გე2みんな3アマゾン4クラウド4グーグル4コム2ストア3セール3ファッション6ポイント4世界2中信1国1國1文网3亚马逊3企业2佛山2信息2健康2八卦2公司1益2台湾1灣2商城1店1标2嘉里0大酒店5在线2大拿2天主教3娱乐2家電2广东2微博2慈善2我爱你3手机2招聘2政务1府2新加坡2闻2时尚2書籍2机构2淡马锡3游戏2澳門2点看2移动2组织机构4网址1店1站1络2联通2谷歌2购物2通販2集团2電訊盈科4飞利浦3食品2餐厅2香格里拉3港2닷넷1컴2삼성2한국2", or = (n, e) => {
  for (const t in e)
    n[t] = e[t];
  return n;
}, Is = "numeric", Ps = "ascii", Bs = "alpha", Ai = "asciinumeric", gi = "alphanumeric", zs = "domain", Fu = "emoji", bv = "scheme", wv = "slashscheme", uc = "whitespace";
function kv(n, e) {
  return n in e || (e[n] = []), e[n];
}
function fn(n, e, t) {
  e[Is] && (e[Ai] = !0, e[gi] = !0), e[Ps] && (e[Ai] = !0, e[Bs] = !0), e[Ai] && (e[gi] = !0), e[Bs] && (e[gi] = !0), e[gi] && (e[zs] = !0), e[Fu] && (e[zs] = !0);
  for (const r in e) {
    const i = kv(r, t);
...
const D = (n, e, t, r, i) => n.ta(e, t, r, i), We = (n, e, t, r, i) => n.tr(e, t, r, i), fc = (n, e, t, r, i) => n.ts(e, t, r, i), S = (n, e, t, r, i) => n.tt(e, t, r, i), Mt = "WORD", Hs = "UWORD", jr = "LOCALHOST", Vs = "TLD", Fs = "UTLD", Oi = "SCHEME", Fn = "SLASH_SCHEME", Ml = "NUM", $u = "WS", Tl = "NL", Wn = "OPENBRACE", Tr = "OPENBRACKET", Ar = "OPENANGLEBRACKET", Or = "OPENPAREN", an = "CLOSEBRACE", _n = "CLOSEBRACKET", qn = "CLOSEANGLEBRACKET", cn = "CLOSEPAREN", Ji = "AMPERSAND", Gi = "APOSTROPHE", Yi = "ASTERISK", Ht = "AT", Xi = "BACKSLASH", Qi = "BACKTICK", Zi = "CARET", Ft = "COLON", Al = "COMMA", eo = "DOLLAR", st = "DOT", to = "EQUALS", Ol = "EXCLAMATION", lt = "HYPHEN", no = "PERCENT", ro = "PIPE", io = "PLUS", oo = "POUND", so = "QUERY", El = "QUOTE", Nl = "SEMI", at = "SLASH", Er = "TILDE", lo = "UNDERSCORE", ju = "EMOJI", ao = "SYM";
...
const Bn = /[a-z]/, ts = /\p{L}/u, ns = /\p{Emoji}/u, rs = /\d/, hc = /\s/, pc = `
`, Cv = "️", Sv = "‍";
let yi = null, vi = null;
function Mv(n) {
  n === void 0 && (n = []);
  ...
  Re.groups = e;
  const t = new Re();
  yi == null && (yi = mc(yv)), vi == null && (vi = mc(vv)), S(t, "'", Gi), S(t, "{", Wn), S(t, "[", Tr), S(t, "<", Ar), S(t, "(", Or), S(t, "}", an), S(t, "]", _n), S(t, ">", qn), S(t, ")", cn), S(t, "&", Ji), S(t, "*", Yi), S(t, "@", Ht), S(t, "`", Qi), S(t, "^", Zi), S(t, ":", Ft), S(t, ",", Al), S(t, "$", eo), S(t, ".", st), S(t, "=", to), S(t, "!", Ol), S(t, "-", lt), S(t, "%", no), S(t, "|", ro), S(t, "+", io), S(t, "#", oo), S(t, "?", so), S(t, '"', El), S(t, "/", at), S(t, ";", Nl), S(t, "~", Er), S(t, "_", lo), S(t, "\\", Xi);
  const r = We(t, rs, Ml, {
    [Is]: !0
  });
  We(r, rs, r);
  ...
  for (let u = 0; u < n.length; u++) {
    ...
    f.indexOf("-") >= 0 ? p[zs] = !0 : Bn.test(f) ? rs.test(f) ? p[Ai] = !0 : p[Ps] = !0 : p[Is] = !0, fc(t, f, f, p);
  }
  return fc(t, "localhost", jr, {
    ascii: !0
  }), t.jd = new Re(ao), {
    start: t,
    tokens: or({
...
function Tv(n, e) {
  const t = Av(e.replace(/[A-Z]/g, (l) => l.toLowerCase())), r = t.length, i = [];
  let o = 0, s = 0;
  for (; s < r; ) {
...
function Dl(n, e) {
  e === void 0 && (e = null);
  let t = or({}, Wr);
  n && (t = or(t, n instanceof Dl ? n.o : n));
...
function Ev(n) {
  ...
  const t = e.domain.concat([Ji, Yi, Ht, Xi, Qi, Zi, eo, to, lt, Ml, no, ro, io, oo, at, ao, Er, lo]), r = [Gi, qn, an, _n, cn, Ft, Al, st, Ol, Ar, Wn, Tr, Or, so, El, Nl], i = [Ji, Gi, Yi, Xi, Qi, Zi, an, eo, to, lt, Wn, no, ro, io, oo, so, at, ao, Er, lo], o = fe(), s = S(o, Er);
  D(s, i, s), D(s, e.domain, s);
  const l = fe(), a = fe(), c = fe();
  ...
  const $ = S(b, Wn), _ = S(b, Tr), le = S(b, Ar), X = S(b, Or);
  S(O, Wn, $), S(O, Tr, _), S(O, Ar, le), S(O, Or, X), S($, an, b), S(_, _n, b), S(le, qn, b), S(X, cn, b), S($, an, b);
  const U = fe(rn), J = fe(rn), W = fe(rn), se = fe(rn);
  D($, t, U), D(_, t, J), D(le, t, W), D(X, t, se);
  const ne = fe(), De = fe(), ue = fe(), Fe = fe();
  return D($, r), D(_, r), D(le, r), D(X, r), D(U, t, U), D(J, t, J), D(W, t, W), D(se, t, se), D(U, r, U), D(J, r, J), D(W, r, W), D(se, r, se), D(ne, t, ne), D(De, t, J), D(ue, t, W), D(Fe, t, se), D(ne, r, ne), D(De, r, De), D(ue, r, ue), D(Fe, r, Fe), S(J, _n, b), S(W, qn, b), S(se, cn, b), S(U, an, b), S(De, _n, b), S(ue, qn, b), S(Fe, cn, b), S(ne, cn, b), S(o, jr, C), S(o, Tl, Ov), {
    start: o,
    tokens: Wu
  };
}
function Nv(n, e, t) {
  ...
  for (; i < r; ) {
    ...
    if (f < 0)
      ...
      s.length > 0 && (o.push(is(vc, e, s)), s = []), i -= f, d -= f;
      const h = u.t, p = t.slice(i - d, i);
      o.push(is(h, e, p));
    }
  }
  return s.length > 0 && o.push(is(vc, e, s)), o;
}
function is(n, e, t) {
  const r = t[0].s, i = t[t.length - 1].e, o = e.slice(r, i);
  return new n(o, t);
}
const Dv = typeof console < "u" && console && console.warn || (() => {
}), Rv = "until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.", ee = {
  scanner: null,
  parser: null,
  tokenQueue: [],
  pluginQueue: [],
...
function bc(n, e) {
  if (e === void 0 && (e = !1), ee.initialized && Dv(`linkifyjs: already initialized - will not register custom scheme "${n}" ${Rv}`), !/^[0-9a-z]+(-[0-9a-z]+)*$/.test(n))
...
function Iv() {
  ee.scanner = Mv(ee.customSchemes);
  for (let n = 0; n < ee.tokenQueue.length; n++)
    ee.tokenQueue[n][1]({
      scanner: ee.scanner
    });
  ee.parser = Ev(ee.scanner.tokens);
...
function qu(n) {
  return ee.initialized || Iv(), Nv(ee.parser.start, n, Tv(ee.scanner.start, n));
}
function Ku(n, e, t) {
...
function Bv(n) {
  return new te({
    ...
    appendTransaction: (e, t, r) => {
      ...
      if (!i || o)
        return;
      const { tr: s } = r, l = _g(t.doc, [...e]);
      if (Qg(l).forEach(({ newRange: c }) => {
        const d = Kg(r.doc, c, (h) => h.isTextblock);
        let u, f;
        if (d.length > 1 ? (u = d[0], f = r.doc.textBetween(u.pos, u.pos + u.node.nodeSize, void 0, " ")) : d.length && r.doc.textBetween(c.from, c.to, " ", " ").endsWith(" ") && (u = d[0], f = r.doc.textBetween(u.pos, c.to, void 0, " ")), u && f) {
          ...
          m.filter((y) => y.isLink).map((y) => ({
            ...
            ml(y.from, y.to, r.doc).some((w) => w.mark.type === n.type) || s.addMark(y.from, y.to, n.type.create({
              href: y.href
            }));
          });
        }
    ...
    props: {
      handleClick: (e, t, r) => {
        ...
        if (!l.find((f) => f.nodeName === "A"))
          return !1;
        const a = du(e.state, n.type.name), c = r.target, d = (i = c == null ? void 0 : c.href) !== null && i !== void 0 ? i : a.href, u = (o = c == null ? void 0 : c.target) !== null && o !== void 0 ? o : a.target;
  ...
  return new te({
    ...
    props: {
      handlePaste: (e, t, r) => {
        ...
        const a = Ku(l).find((c) => c.isLink && c.value === l);
...
const Vv = Be.create({
    ...
    return [
      Yt({
        find: (n) => {
          const e = [];
          if (n) {
            const t = Ku(n).filter((r) => r.isLink);
  ...
  addProseMirrorPlugins() {
    const n = [];
    return this.options.autolink && n.push(Bv({
      type: this.type,
      validate: this.options.validate
    })), this.options.openOnClick && n.push(zv({
      type: this.type,
      whenNotEditable: this.options.openOnClick === "whenNotEditable"
    })), this.options.linkOnPaste && n.push(Hv({
      editor: this.editor,
      type: this.type
    })), n;
  }
...
function Wv(n, e, t) {
  ...
  for (let i = 0; i < n.map.length; i++) {
    ...
    for (let c = 0; c < a.colspan; c++) {
      ...
      u != null && (!a.colwidth || a.colwidth[c] != u) && ((l || (l = _v(a)))[c] = u);
    }
...
var Y = class Tt extends I {
  ...
  getBookmark() {
    return new Gv(this.$anchorCell.pos, this.$headCell.pos);
  }
};
...
var Gv = class Gu {
  ...
  map(e) {
    return new Gu(e.map(this.anchor), e.map(this.head));
  }
  resolve(e) {
    const t = e.resolve(this.anchor), r = e.resolve(this.head);
    return t.parent.type.spec.tableRole == "row" && r.parent.type.spec.tableRole == "row" && t.index() < t.parent.childCount && r.index() < r.parent.childCount && Rl(t, r) ? new Y(t, r) : I.near(r, 1);
  }
};
function Yv(n) {
...
function Zv(n, e, t) {
  ...
  if (r instanceof R && (s = r.node.type.spec.tableRole)) {
    ...
    r instanceof L && Xv(r) ? o = L.create(i, r.from) : r instanceof L && Qv(r) && (o = L.create(i, r.$from.start(), r.$from.end()));
  return o && (e || (e = n.tr)).setSelection(o), e;
}
var eb = new de("fix-tables");
function Yu(n, e, t, r) {
  ...
  e:
    for (let s = 0, l = 0; s < o; s++) {
      ...
      r(a, t), l < i && n.child(l).sameMarkup(a) ? Yu(n.child(l), a, t + 1, r) : a.nodesBetween(0, a.content.size, r, t + 1), t += a.nodeSize;
    }
}
function Xu(n, e) {
  let t;
  const r = (i, o) => {
    i.type.spec.tableRole == "table" && (t = tb(n, i, o, t));
  };
  return e ? e.doc != n.doc && Yu(e.doc, n.doc, 0, r) : n.doc.descendants(r), t;
}
function tb(n, e, t, r) {
  const i = ie.get(e);
  if (!i.problems)
  ...
  return r.setMeta(eb, { fixTables: !0 });
}
function nb(n) {
  if (!n.size)
    return null;
...
function _s(n, e) {
  ...
  return new Xs(t).replace(0, t.content.size, e).doc;
}
function ib({ width: n, height: e, rows: t }, r, i) {
  if (n != r) {
    const o = [], s = [];
...
function xc(n, e, t, r, i) {
  ...
  ob(u, s, o, t, c, d, f) && h(), wc(u, s, o, t, a, c, l, f) && h(), wc(u, s, o, t, a, c, d, f) && h(), kc(u, s, o, t, l, d, a, f) && h(), kc(u, s, o, t, l, d, c, f) && h();
  for (let p = l; p < d; p++) {
...
function bi(n, e) {
  return (t, r, i) => {
    ...
    {
      const l = t.doc.resolve(s), a = Uu(l, n, e);
      let c;
...
function ab(n, e, t) {
  ...
  if (i instanceof Y) {
    ...
    return r = ib(r, l.right - l.left, l.bottom - l.top), xc(n.state, n.dispatch, s, l, r), !0;
  } else if (r) {
...
function cb(n, e) {
  ...
  function l(a) {
    ...
    else if (Cc(n, c.target) != r && (u = ss(n, e), !u))
      return s();
    u && o(u, c);
  }
...
var db = class {
  ...
  update(e) {
    return e.type != this.node.type ? !1 : (this.node = e, qs(e, this.colgroup, this.table, this.cellMinWidth), !0);
  }
  ignoreMutation(e) {
...
function ub({
  ...
  const i = new te({
    ...
    state: {
      init(o, s) {
        return i.spec.props.nodeViews[xe(s.schema).table.name] = (l, a) => new t(l, e, a), new fb(-1, !1);
      },
      apply(o, s) {
        return s.apply(o);
      }
...
var fb = class Ni {
  ...
  apply(e) {
    ...
    if (t.activeHandle > -1 && e.docChanged) {
      ...
      return Ws(e.doc.resolve(i)) || (i = -1), new Ni(i, t.dragging);
    }
    return t;
  }
};
function hb(n, e, t, r, i) {
  ...
  if (o && !o.dragging) {
    ...
    if (s) {
      ...
      e.clientX - a <= t ? l = Sc(n, e, "left", t) : c - e.clientX <= t && (l = Sc(n, e, "right", t));
    }
    if (l != o.activeHandle) {
      if (!i && l !== -1) {
...
function mb(n, e, t) {
  ...
  if (!o || o.activeHandle == -1 || o.dragging)
    return !1;
  const s = n.state.doc.nodeAt(o.activeHandle), l = gb(n, o.activeHandle, s.attrs);
  n.dispatch(
...
function vb(n, e, t) {
  ...
  for (let c = 0; c < o.height; c++) {
    ...
    if (f.colwidth && f.colwidth[h] == t)
      continue;
    const p = f.colwidth ? f.colwidth.slice() : wb(f.colspan);
...
function ef(n, { map: e, tableStart: t, table: r }, i) {
  let o = i > 0 ? -1 : 0;
  Jv(e, r, i + o) && (o = i == 0 || i == e.width ? null : 0);
...
function tf(n, { map: e, tableStart: t, table: r }, i) {
  var o;
  let s = t;
  for (let c = 0; c < i; c++)
  ...
  const l = [];
  let a = i > 0 ? -1 : 0;
  Tb(e, r, i + a) && (a = i == 0 || i == e.height ? null : 0);
...
function Ob(n, e) {
  ...
  if (e) {
    const t = yt(n);
    e(tf(n.tr, t, t.bottom));
  }
  return !0;
}
function Eb(n, { map: e, table: t, tableStart: r }, i) {
  let o = 0;
  for (let c = 0; c < i; c++)
...
function Nb(n, e) {
  ...
  if (e) {
    ...
    if (t.top == 0 && t.bottom == t.map.height)
      return !1;
    for (let i = t.bottom - 1; Eb(r, t, i), i != t.top; i--) {
      const o = t.tableStart ? r.doc.nodeAt(t.tableStart - 1) : r.doc;
      if (!o)
        throw RangeError("No table found");
...
function Ac(n, e) {
  ...
  if (e) {
    ...
    if (o.setNodeMarkup(a + r.tableStart, null, {
      ...
      const d = a + 1 + c.content.size, u = Tc(c) ? a + 1 : d;
...
function Oc(n, e) {
  const t = xe(n.schema);
  return Rb(({ node: r }) => t[r.type.spec.tableRole])(n, e);
}
function Rb(n) {
  return (e, t) => {
    var r;
...
function _r(n, e) {
  return e = e || { useDeprecatedLogic: !1 }, e.useDeprecatedLogic ? Ib(n) : function(t, r) {
    if (!rt(t))
      return !1;
    if (r) {
      const i = xe(t.schema), o = yt(t), s = t.tr, l = Ec("row", o, i), a = Ec(
        "column",
        o,
        i
...
function Nc(n) {
  return function(e, t) {
    ...
    if (t) {
      ...
      t(
        e.tr.setSelection(L.between(i, Uv(i))).scrollIntoView()
      );
    }
    return !0;
  };
...
class Vb {
  ...
  update(e) {
    return e.type !== this.node.type ? !1 : (this.node = e, Dc(e, this.colgroup, this.table, this.cellMinWidth), !0);
  }
  ignoreMutation(e) {
    return e.type === "attributes" && (e.target === this.table || this.colgroup.contains(e.target));
  }
...
const xi = ({ editor: n }) => {
  ...
  if (!Wb(e))
    return !1;
  let t = 0;
  const r = cu(e.ranges[0].$from, (o) => o.type.name === "table");
  ...
  addCommands() {
    return {
      ...
      addColumnBefore: () => ({ state: n, dispatch: e }) => xb(n, e),
      addColumnAfter: () => ({ state: n, dispatch: e }) => Cb(n, e),
      deleteColumn: () => ({ state: n, dispatch: e }) => Mb(n, e),
      addRowBefore: () => ({ state: n, dispatch: e }) => Ab(n, e),
      addRowAfter: () => ({ state: n, dispatch: e }) => Ob(n, e),
      deleteRow: () => ({ state: n, dispatch: e }) => Nb(n, e),
      deleteTable: () => ({ state: n, dispatch: e }) => zb(n, e),
      mergeCells: () => ({ state: n, dispatch: e }) => Ac(n, e),
      splitCell: () => ({ state: n, dispatch: e }) => Oc(n, e),
      toggleHeaderColumn: () => ({ state: n, dispatch: e }) => _r("column")(n, e),
      toggleHeaderRow: () => ({ state: n, dispatch: e }) => _r("row")(n, e),
      toggleHeaderCell: () => ({ state: n, dispatch: e }) => Pb(n, e),
      mergeOrSplit: () => ({ state: n, dispatch: e }) => Ac(n, e) ? !0 : Oc(n, e),
      setCellAttribute: (n, e) => ({ state: t, dispatch: r }) => Lb(n, e)(t, r),
      goToNextCell: () => ({ state: n, dispatch: e }) => Nc(1)(n, e),
      goToPreviousCell: () => ({ state: n, dispatch: e }) => Nc(-1)(n, e),
      fixTables: () => ({ state: n, dispatch: e }) => (e && Xu(n), !0),
...
}), Xb = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/, Qb = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))/g, Zb = Be.create({
  name: "highlight",
  addOptions() {
    return {
      multicolor: !1,
...
}, iw = function({ view: n, dir: e, currentResolved: t }) {
  if (!t)
    return !1;
  let r = n.state.tr;
  const i = e === "DOWN", o = t.node(1) || t.nodeAfter, s = 0, l = t.node(s), a = t.start(s), c = nf(l, (m) => m);
  let d = c.indexOf(o);
  if (d == -1)
    return !1;
  let u = i ? d + 1 : d - 1;
...
function rf(n, e) {
  if (ls(n) && ls(e))
    for (const t in e)
      ls(e[t]) ? (n[t] || Object.assign(n, { [t]: {} }), rf(n[t], e[t])) : ow(e[t]) ? (n[t] || (n[t] = []), Ks(n[t], e[t])) : Object.assign(n, { [t]: e[t] });
  return n;
}
const Ks = function(n, e) {
  ...
  addCommands() {
    return {
      setBlockWidth: (n) => ({ commands: e, view: t }) => this.options.alignments.includes(n) ? (e.updateAttributes(Ll(t).type.name, {
        blockWidth: n
      }), !0) : !1,
...
}), lw = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/, aw = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/g, cw = (n) => n.match(lw), Lc = (n) => n ? "https://www.youtube-nocookie.com/embed/" : "https://www.youtube.com/embed/", dw = (n) => {
  const {
    url: e,
    allowFullscreen: t,
    autoplay: r,
  ...
  addCommands() {
    return {
      setYoutubeVideo: (n) => ({ commands: e }) => cw(n.src) ? e.insertContent({
        type: this.name,
        attrs: n
      }) : !1
    };
...
const fw = oe.create({
  ...
  addProseMirrorPlugins() {
    const n = new de(this.name), e = Object.entries(this.editor.schema.nodes).map(([, t]) => t).filter((t) => this.options.notAfter.includes(t.name));
    return [
      new te({
        key: n,
  ...
  addCommands() {
    return {
      setVariant: (n) => ({ commands: e, view: t }) => (e.updateAttributes(Ll(t).type.name, {
        variant: n
      }), !0),
...
function mw(n) {
  var e;
  const { char: t, allowSpaces: r, allowedPrefixes: i, startOfLine: o, $position: s } = n, l = D1(t), a = new RegExp(`\\s${l}$`), c = o ? "^" : "", d = r ? new RegExp(`${c}${l}.*?(?=\\s${l}|$)`, "gm") : new RegExp(`${c}(?:^)?${l}[^\\s${l}]*`, "gm"), u = ((e = s.nodeBefore) === null || e === void 0 ? void 0 : e.isText) && s.nodeBefore.text;
  if (!u)
    return null;
...
const gw = new de("suggestion");
function yw({ pluginKey: n = gw, editor: e, char: t = "@", allowSpaces: r = !1, allowedPrefixes: i = [" "], startOfLine: o = !1, decorationTag: s = "span", decorationClass: l = "suggestion", command: a = () => null, items: c = () => [], render: d = () => ({}), allow: u = () => !0, findSuggestionMatch: f = mw }) {
  let h;
  const p = d == null ? void 0 : d(), g = new te({
    ...
    view() {
      return {
        update: async (m, y) => {
          var w, C, v, T, b, O, z;
          const A = (w = this.key) === null || w === void 0 ? void 0 : w.getState(y), B = (C = this.key) === null || C === void 0 ? void 0 : C.getState(m.state), V = A.active && B.active && A.range.from !== B.range.from, $ = !A.active && B.active, _ = A.active && !B.active, le = !$ && !_ && A.query !== B.query, X = $ || V, U = le && !V, J = _ || V;
          if (!X && !U && !J)
            return;
          ...
          h = {
            ...
            clientRect: se ? () => {
              var ne;
              const { decorationId: De } = (ne = this.key) === null || ne === void 0 ? void 0 : ne.getState(e.state), ue = m.dom.querySelector(`[data-decoration-id="${De}"]`);
              return (ue == null ? void 0 : ue.getBoundingClientRect()) || null;
            } : null
...
}, ww = { class: "bg-white border border-slate-400 rounded overflow-hidden shadow" }, kw = ["onClick"], xw = ["innerHTML"], Cw = {
  key: 1,
  class: "p-2 text-slate-600 text-sm w-full"
};
function Sw(n, e, t, r, i, o) {
  return F(), Z("div", ww, [
    t.items.length ? (F(!0), Z(Ct, { key: 0 }, St(o.itemsWithInsertCommand, (s, l) => (F(), Z("button", {
      ...
      yf(" " + vf(s.title), 1)
    ], 10, kw))), 128)) : (F(), Z("div", Cw, "No result"))
  ]);
}
const Mw = /* @__PURE__ */ Kr(bw, [["render", Sw]]);
function Tw(n) {
  return {
...
const Rw = {
  ...
  data() {
    return {
      ...
      editor: null,
      allBlockTools: Ks(Aw(), this.blockTools),
      allInlineTools: Ks(Ow(), this.inlineTools),
      allAlignmentTools: this.alignmentTools.length ? this.alignmentTools : Ew(),
      tableRowTools: Nw(),
      tableColumnTools: Dw(),
  ...
  mounted() {
    this.editor = new my({
      extensions: [
        ...
        Zb,
        vw.configure({
          suggestion: Tw(this.allBlockTools)
        }),
        Vv.configure({
          openOnClick: !1
        }),
  ...
  methods: {
    ...
    startDragging(n) {
      ...
      this.draggedNodePosition = ((t = this.editor.view.posAtCoords(e)) == null ? void 0 : t.pos) ?? null, this.dragging = !0, this._dragOverHandler = (r) => {
        const i = this.editor.view.posAtCoords({
          left: r.clientX,
          top: r.clientY
        });
        i && (this.hoverNodePosition = i.pos);
      }, this.editor.view.dom.addEventListener("dragover", this._dragOverHandler);
    },
    onDragStart(n) {
      if (this.draggedNodePosition === null)
        return;
      const e = this.editor.state.doc.resolve(this.draggedNodePosition), t = e.depth >= 1 ? e.before(1) : 0;
      let r = this.editor.view.nodeDOM(t);
      if (!r || r.nodeType !== Node.ELEMENT_NODE && (r = r.parentElement, !r))
        return;
      const i = document.createElement("div");
      i.className = "gutentap", i.style.cssText = `
        position: fixed;
        top: -9999px;
        left: -9999px;
        opacity: 0.6;
      ...
      o.className = this.editorClass ?? "prose", o.style.cssText = `width: ${r.offsetWidth}px; margin: 0;`, o.appendChild(r.cloneNode(!0)), i.appendChild(o), document.body.appendChild(i), n.dataTransfer.setDragImage(i, 20, 20), requestAnimationFrame(() => i.remove());
    },
    endDragging() {
      this.hoverNodePosition !== null && this.draggedNodePosition !== null && rw({
      ...
      ), this.dragging = !1, this.draggedNodePosition = null, this.hoverNodePosition = null;
    },
    tableIsActive() {
    ...
    getTopLevelNodeType() {
      var n;
      return (n = Ll(this.editor.view)) == null ? void 0 : n.type.name;
    },
    canMoveNodeDown() {
...
}, Lw = { class: "gutentap" }, Iw = { class: "flex flex-row" }, Pw = /* @__PURE__ */ Ke("svg", {
  width: "24",
  height: "24",
...
}, Hw = /* @__PURE__ */ Ke("div", { class: "p-3 uppercase text-gray-600 text-xs pb-1 tracking-wide" }, " Transform to ", -1), Vw = {
  key: 1,
  class: "pr-2 flex flex-col"
}, Fw = ["disabled"], $w = /* @__PURE__ */ Ke("svg", {
  width: "24",
  height: "24",
  ...
  $w
], Ww = ["disabled"], _w = /* @__PURE__ */ Ke("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  width: "24",
  height: "24",
  fill: "currentColor",
...
function Yw(n, e, t, r, i, o) {
  ...
  return F(), Z("div", Lw, [
    ...
    i.editor ? (F(), Qe(c, {
      key: 2,
      pluginKey: "mainMenu",
      onDragstart: e[9] || (e[9] = (u) => o.onDragStart(u)),
      onDragend: e[10] || (e[10] = (u) => o.endDragging(u)),
        ...
        return [
          Ke("div", Iw, [
            Ke("button", {
              ...
              onMouseup: e[2] || (e[2] = (m) => o.endDragging()),
            ...
            !i.dragging && i.currentBlockTool ? (F(), Z("div", zw, [
              je(a, null, bf({
                default: Me(() => {
                  var m, y, w;
                  return [
          ...
          !i.dragging && ((h = (f = i.currentBlockTool) == null ? void 0 : f.tools) != null && h.length) ? (F(), Z("div", Uw, [
          ...
          (g = i.currentBlockTool) != null && g.hasInlineTools && !i.dragging ? (F(), Z("div", Jw, [
          ...
          i.editor && i.editor.can().deleteNode(i.topLevelNodeType) && !i.dragging ? (F(), Z("div", Gw, [
            je(a, { align: "right" }, {
              dropdown: Me(() => [
                je(l, {
                  ref: "deleteButton",
    ...
    je(d, {
      ...
      onKeydown: e[11] || (e[11] = (u) => i.isTyping = !0),
...
const Xw = /* @__PURE__ */ Kr(Rw, [["render", Yw]]), t2 = Xw;
export {
  t2 as GutenTap
};
