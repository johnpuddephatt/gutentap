import { openBlock as V, createElementBlock as te, normalizeClass as Ft, renderSlot as Al, createCommentVNode as it, defineComponent as jr, ref as Vs, onMounted as Ac, onBeforeUnmount as Fs, h as fn, reactive as Oc, markRaw as Ec, getCurrentInstance as Zu, watchEffect as ef, nextTick as tf, unref as nf, Teleport as rf, customRef as of, Fragment as xt, renderList as Ct, withModifiers as Qe, createElementVNode as Ke, createTextVNode as sf, toDisplayString as lf, resolveComponent as ur, createBlock as Xe, withCtx as Me, createVNode as Fe, createSlots as af, withKeys as cf } from "vue";
const Wr = (n, e) => {
...
}, uf = ["aria-label", "data-tooltip", "title", "innerHTML"];
...
const hf = /* @__PURE__ */ Wr(df, [["render", ff]]), pf = {
  computed: {
    hasDropdown() {
...
const yf = /* @__PURE__ */ Wr(pf, [["render", gf]]), vf = {
  props: {
    content: {
      type: String,
      required: !1
...
const kf = /* @__PURE__ */ Wr(vf, [["render", wf]]);
function ge(n) {
  this.content = n;
}
ge.prototype = {
...
x.empty = new x([], 0);
const Co = { index: 0, offset: 0 };
function ii(n, e) {
  return Co.index = n, Co.offset = e, Co;
}
function Ti(n, e) {
  if (n === e)
    return !0;
...
function Ic(n, e, t, r) {
  ...
  if (i == e.index(r) && r < n.depth - t.openStart) {
    ...
    if (!t.openStart && !t.openEnd && n.depth == r && e.depth == r) {
      ...
      return pn(o, Bc(n, s, l, e, r));
    }
  else
    return pn(o, Oi(n, e, r));
}
function Pc(n, e) {
...
function Bc(n, e, t, r, i) {
  let o = n.depth > i && rs(n, e, i + 1), s = r.depth > i && rs(t, r, i + 1), l = [];
  return vr(null, n, i, l), o && s && e.index(i) == t.index(i) ? (Pc(o, s), hn(pn(o, Bc(n, e, t, r, i + 1)), l)) : (o && hn(pn(o, Oi(n, e, i + 1)), l), vr(e, t, i, l), s && hn(pn(s, Oi(t, r, i + 1)), l)), vr(r, null, i, l), new x(l);
}
function Oi(n, e, t) {
  let r = [];
  if (vr(null, n, t, r), n.depth > t) {
    let i = rs(n, e, t + 1);
    hn(pn(i, Oi(n, e, t + 1)), r);
  }
...
let mn = class is {
  ...
  */
  hasMarkup(e, t, r) {
    return this.type == e && Ti(this.attrs, t || e.defaultAttrs || Mf) && J.sameSet(this.marks, r || J.none);
  }
  /**
  ...
  */
  copy(e = null) {
    return e == this.content ? this : new is(this.type, this.attrs, e, this.marks);
  }
  /**
  ...
  */
  mark(e) {
    return e == this.marks ? this : new is(this.type, this.attrs, this.content, e);
  }
  /**
...
class io {
  ...
  */
  static compile(e, t) {
    ...
    return e.forEach((o, s) => r[o] = new io(o, i++, t, s)), r;
  }
  /**
...
class Bf {
  ...
  */
  constructor(e) {
    ...
    for (let i in e)
      t[i] = e[i];
    t.nodes = ge.from(e.nodes), t.marks = ge.from(e.marks || {}), this.nodes = Nl.compile(this.spec.nodes, this), this.marks = io.compile(this.spec.marks, this);
    let r = /* @__PURE__ */ Object.create(null);
  ...
  */
  text(e, t) {
    ...
    return new Ni(r, r.defaultAttrs, e, J.setFrom(t));
  }
  /**
  ...
  */
  matchTag(e, t, r) {
    for (let i = r ? this.tags.indexOf(r) + 1 : 0; i < this.tags.length; i++) {
      let o = this.tags[i];
      if (Vf(e, o.tag) && (o.namespace === void 0 || e.namespaceURI == o.namespace) && (!o.context || t.matchesContext(o.context))) {
        if (o.getAttrs) {
          let s = o.getAttrs(e);
          if (s === !1)
            continue;
...
const _c = {
  ...
  style: !0,
  title: !0
}, Kc = { ol: !0, ul: !0 }, Di = 1, Ri = 2, br = 4;
function Rl(n, e, t) {
  return e != null ? (e ? Di : 0) | (e === "full" ? Ri : 0) : n && n.whitespace == "pre" ? Di | Ri : t & ~br;
}
class oi {
...
`) : t = t.replace(/\r?\n|\r/g, " ");
  ...
  addElement(e, t) {
    ...
    Kc.hasOwnProperty(r) && this.parser.normalizeLists && Hf(e);
...
`));
  ...
  addPendingMark(e) {
    let t = jf(e, this.top.pendingMarks);
...
class ut {
  ...
  */
  serializeFragment(e, t = {}, r) {
    r || (r = To(t).createDocumentFragment());
    let i = r, o = [];
    return e.forEach((s) => {
  ...
  */
  serializeNodeInner(e, t) {
    let { dom: r, contentDOM: i } = ut.renderSpec(To(t), this.nodes[e.type.name](e));
    if (i) {
      if (e.isLeaf)
  ...
  */
  serializeMark(e, t, r = {}) {
    ...
    return i && ut.renderSpec(To(r), i(e, t));
  }
  /**
  ...
  _map(e, t, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= u) {
        ...
        if (r)
          return h;
        let p = e == (t < 0 ? a : u) ? null : Wf(l / 3, e - a), m = e == a ? Gc : e == u ? Jc : yi;
        return (t < 0 ? e != a : e != u) && (m |= Yc), new ss(h, m, p);
      }
      i += d - c;
    }
    return r ? e + i : new ss(e + i, 0, null);
  }
  /**
  @internal
  */
  touches(e, t) {
    let r = 0, i = Bl(t), o = this.inverted ? 2 : 1, s = this.inverted ? 1 : 2;
    for (let l = 0; l < this.ranges.length; l += 3) {
...
class fe extends Ie {
  ...
  */
  ...
  apply(e) {
    return this.structure && ls(e, this.from, this.to) ? ae.fail("Structure replace would overwrite content") : ae.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
...
class he extends Ie {
  ...
  */
  ...
  apply(e) {
    if (this.structure && (ls(e, this.from, this.gapFrom) || ls(e, this.gapTo, this.to)))
...
function Uf(n, e, t, r = t.contentMatch) {
...
function ir(n) {
  ...
  for (let r = n.depth; ; --r) {
    ...
    if (r < n.depth && i.canReplace(o, s, t))
      return r;
    if (r == 0 || i.type.spec.isolating || !Jf(i, o, s))
      break;
  }
  return null;
}
...
function Zf(n, e, t, r, i) {
  ...
  n.doc.nodesBetween(e, t, (s, l) => {
    if (s.isTextblock && !s.hasMarkup(r, i) && eh(n.doc, n.mapping.slice(o).map(l), r)) {
...
function Ws(n, e, t = e, r = A.empty) {
  ...
  return ed(i, o, r) ? new fe(e, t, r) : new oh(i, o, r).fit();
}
function ed(n, e, t) {
  ...
  findFittable() {
    ...
    for (let t = 1; t <= 2; t++)
      for (let r = t == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
        let i, o = null;
        r ? (o = Oo(this.unplaced.content, r - 1).firstChild, i = o.content) : i = this.unplaced.content;
        let s = i.firstChild;
  ...
  findCloseLevel(e) {
    e:
      for (let t = Math.min(this.depth, e.depth); t >= 0; t--) {
        let { match: r, type: i } = this.frontier[t], o = t < e.depth && e.end(t + 1) == e.pos + (e.depth - (t + 1)), s = Eo(e, t, i, r, o);
        if (s) {
          for (let l = t - 1; l >= 0; l--) {
            let { match: a, type: c } = this.frontier[l], d = Eo(e, l, c, a, !0);
            if (!d || d.childCount)
              continue e;
          }
...
class R {
  ...
  */
  static findFrom(e, t, r = !1) {
    let i = e.parent.inlineContent ? new P(e) : In(e.node(0), e.parent, e.pos, e.index(), t, r);
    if (i)
      return i;
...
class Do {
  constructor(e, t) {
    this.schema = e, this.plugins = [], this.pluginsByKey = /* @__PURE__ */ Object.create(null), this.fields = hh.slice(), t && t.forEach((r) => {
...
class Hn {
  ...
  */
  static create(e) {
    let t = new Do(e.doc ? e.doc.type.schema : e.schema, e.plugins), r = new Hn(t);
  ...
  */
  reconfigure(e) {
    let t = new Do(this.schema, e.plugins), r = t.fields, i = new Hn(t);
  ...
  */
  static fromJSON(e, t, r) {
    ...
    let i = new Do(e.schema, e.plugins), o = new Hn(i);
...
function Kl(n, e, t, r, i) {
  for (; ; ) {
    ...
    if (e == (i < 0 ? 0 : dt(n))) {
      let o = n.parentNode;
      if (!o || o.nodeType != 1 || gh(n) || ph.test(n.nodeName) || n.contentEditable == "false")
        return !1;
      e = Pe(n) + (i < 0 ? 0 : 1), n = o;
...
const pt = typeof navigator < "u" ? navigator : null, ql = typeof document < "u" ? document : null, Xt = pt && pt.userAgent || "", as = /Edge\/(\d+)/.exec(Xt), ld = /MSIE \d/.exec(Xt), cs = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Xt), Ne = !!(ld || cs || as), _t = ld ? document.documentMode : cs ? +cs[1] : as ? +as[1] : 0, nt = !Ne && /gecko\/(\d+)/i.test(Xt);
nt && +(/Firefox\/(\d+)/.exec(Xt) || [0, 0])[1];
const ds = !Ne && /Chrome\/(\d+)/.exec(Xt), we = !!ds, bh = ds ? +ds[1] : 0, Te = !Ne && !!pt && /Apple Computer/.test(pt.vendor), Yn = Te && (/Mobile\/\w+/.test(Xt) || !!pt && pt.maxTouchPoints > 2), je = Yn || (pt ? /Mac/.test(pt.platform) : !1), wh = pt ? /Win/.test(pt.platform) : !1, Ze = /Android \d/.test(Xt), lo = !!ql && "webkitFontSmoothing" in ql.documentElement.style, kh = lo ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function xh(n) {
  return {
    left: 0,
...
function Ul(n, e, t) {
  ...
  for (let s = t || n.dom; s; s = Nr(s)) {
    if (s.nodeType != 1)
      continue;
    let l = s, a = l == o.body, c = a ? xh(o) : Ch(l), d = 0, u = 0;
...
function Mh({ refDOM: n, refTop: e, stack: t }) {
...
function dd(n, e) {
  ...
  return !t && a && (t = a, i = c, r = 0), t && t.nodeType == 3 ? Ah(t, i) : !t || r && t.nodeType == 1 ? { node: n, offset: o } : dd(t, i);
}
function Ah(n, e) {
...
function Dh(n, e) {
  let t = n.dom.ownerDocument, r, i = 0, o = vh(t, e.left, e.top);
  o && ({ node: r, offset: i } = o);
  ...
  if (s = Oh(s, e), r) {
    ...
    r == n.dom && i == r.childNodes.length - 1 && r.lastChild.nodeType == 1 && e.top > r.lastChild.getBoundingClientRect().bottom ? l = n.state.doc.content.size : (i == 0 || r.nodeType != 1 || r.childNodes[i - 1].nodeName != "BR") && (l = Nh(n, r, i, e));
  }
  l == null && (l = Eh(n, s, e));
...
const Rh = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function fd(n, e, t) {
  let { node: r, offset: i, atom: o } = n.docView.domFromPos(e, t < 0 ? -1 : 1), s = lo || nt;
  if (r.nodeType == 3)
    if (s && (Rh.test(r.nodeValue) || (t < 0 ? !i : i == r.nodeValue.length))) {
      let a = It(Mt(r, i, i), t);
  ...
  if (!n.state.doc.resolve(e - (o || 0)).parent.inlineContent) {
    if (o == null && i && (t < 0 || i == dt(r))) {
      ...
      if (a.nodeType == 1)
        return Lo(a.getBoundingClientRect(), !1);
    }
    if (o == null && i < dt(r)) {
      let a = r.childNodes[i];
      if (a.nodeType == 1)
        return Lo(a.getBoundingClientRect(), !0);
    }
...
function Ph(n, e, t) {
  ...
  return !Ih.test(r.parent.textContent) || !l.modify ? t == "left" || t == "backward" ? o : s : hd(n, e, () => {
...
function Bh(n, e, t) {
  return Gl == e && Yl == t ? Xl : (Gl = e, Yl = t, Xl = t == "up" || t == "down" ? Lh(n, e, t) : Ph(n, e, t));
}
const qe = 0, Ql = 1, cn = 2, mt = 3;
class _r {
  constructor(e, t, r, i) {
...
`), d && h == f.nodeValue.length)
    ...
    if (!(i || d && Te) && wn(l.node, l.offset, c.anchorNode, c.anchorOffset) && wn(a.node, a.offset, c.focusNode, c.focusOffset))
      return;
    let u = !1;
    if ((c.extend || e == t) && !d) {
...
class kn extends _r {
  ...
  slice(e, t, r) {
    ...
    t < s && (o = hs(o, t, s, r)), e > 0 && (o = hs(o, 0, e, r));
    for (let l = 0; l < o.length; l++)
      o[l].parent = i;
...
class Kt extends _r {
  ...
  static create(e, t, r, i, o, s) {
    ...
    let f = d;
    return d = vd(d, r, t), c ? a = new Hh(e, t, r, i, d, u || null, f, c, o, s + 1) : t.isText ? new ao(e, t, r, i, d, f, o) : new Kt(e, t, r, i, d, u || null, f, o, s + 1);
  }
  parseRule() {
  ...
  matchesNode(e, t, r) {
    return this.dirty == qe && e.eq(this.node) && fs(t, this.outerDeco) && r.eq(this.innerDeco);
  }
  get size() {
  ...
  // `this.children`.
  updateChildren(e, t) {
    let r = this.node.inlineContent, i = t, o = e.composing ? this.localCompositionInfo(e, t) : null, s = o && o.pos > -1 ? o : null, l = o && o.pos < 0, a = new Fh(this, s && s.node, e);
    Wh(this.node, this.innerDeco, (c, d, u) => {
    ...
    }), a.syncToMarks([], r, e), this.node.isTextblock && a.addTextblockHacks(), a.destroyRest(), (a.changed || this.dirty == cn) && (s && this.protectLocalComposition(e, s), gd(this.contentDOM, this.children, e), Yn && _h(this.dom));
  }
  localCompositionInfo(e, t) {
    let { from: r, to: i } = e.state.selection;
    if (!(e.state.selection instanceof P) || r < t || i > t + this.node.content.size)
      return null;
    let o = e.domSelectionRange(), s = Kh(o.focusNode, o.focusOffset);
    if (!s || !this.dom.contains(s.parentNode))
      return null;
    if (this.node.inlineContent) {
      let l = s.nodeValue, a = qh(this.node.content, l, r - t, i - t);
  ...
  protectLocalComposition(e, { node: t, pos: r, text: i }) {
    ...
    e.input.compositionNodes.push(s), this.children = hs(this.children, r, r + i.length, e, s);
  }
  ...
  updateOuterDeco(e) {
    ...
    this.dom = yd(this.dom, this.nodeDOM, us(this.outerDeco, this.node, t), us(e, this.node, t)), this.dom != r && (r.pmViewDesc = void 0, this.dom.pmViewDesc = this), this.outerDeco = e;
  }
...
class ao extends Kt {
  ...
  update(e, t, r, i) {
    return this.dirty == mt || this.dirty != qe && !this.inParent() || !e.sameMarkup(this.node) ? !1 : (this.updateOuterDeco(t), (this.dirty != qe || e.text != this.node.text) && e.text != this.nodeDOM.nodeValue && (this.nodeDOM.nodeValue = e.text, i.trackWrites == this.nodeDOM && (i.trackWrites = null)), this.node = e, this.dirty = qe, !0);
  }
  inParent() {
...
function vd(n, e, t) {
  return yd(n, n, dn, us(e, t, n.nodeType != 1));
}
function fs(n, e) {
  if (n.length != e.length)
    return !1;
...
class Fh {
  constructor(e, t, r) {
    this.lock = t, this.view = r, this.index = 0, this.stack = [], this.changed = !1, this.top = e, this.preMatch = $h(e.node.content, e);
  }
  ...
  updateNextNode(e, t, r, i, o, s) {
    for (let l = this.index; l < this.top.children.length; l++) {
      ...
      if (a instanceof Kt) {
        ...
        if (c != null && c != o)
          return !1;
        let d = a.dom, u, f = this.isLocked(d) && !(e.isText && a.node && a.node.isText && a.nodeDOM.nodeValue == e.text && a.dirty != mt && fs(t, a.outerDeco));
        ...
        if (!f && (u = this.recreateWrapper(a, e, t, r, i, s)))
          return this.top.children[this.index] = u, u.dirty = cn, u.updateChildren(i, s + 1), u.dirty = qe, this.changed = !0, this.index++, !0;
        break;
      }
    }
    return !1;
...
function Us(n, e = null) {
  ...
  if (so(t)) {
    for (a = l; i && !i.node; )
      i = i.parent;
    let d = i.node;
    if (i && d.isAtom && L.isSelectable(d) && i.parent && !(d.isInline && mh(t.focusNode, t.focusOffset, i.dom))) {
      let u = i.posBefore;
...
function Ot(n, e = !1) {
  ...
  if (wd(n, t), !!bd(n)) {
    ...
    if (n.domObserver.disconnectSelection(), n.cursorWrapper)
      ...
      ta && !(t instanceof P) && (t.$from.parent.inlineContent || (o = na(n, t.from)), !t.empty && !t.$from.parent.inlineContent && (s = na(n, t.to))), n.docView.setSelection(r, i, n.root, e), ta && (o && ra(o), s && ra(s)), t.visible ? n.dom.classList.remove("ProseMirror-hideselection") : (n.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && Uh(n));
    }
    n.domObserver.setCurSelection(), n.domObserver.connectSelection();
  }
}
const ta = Te || we && bh < 63;
function na(n, e) {
...
function Jh(n) {
  ...
  i ? t.setEnd(r.parentNode, Pe(r) + 1) : t.setEnd(r, 0), t.collapse(!1), e.removeAllRanges(), e.addRange(t), !i && !n.state.selection.visible && Ne && _t <= 11 && (r.disabled = !0, r.disabled = !1);
}
function wd(n, e) {
  if (e instanceof L) {
...
function sa(n, e, t) {
  ...
  if (r instanceof P) {
    ...
    if (n.endOfTextblock(e > 0 ? "forward" : "backward")) {
      ...
      return o.isAtom || (s = n.docView.descAt(l)) && !s.contentDOM ? L.isSelectable(o) ? sn(n, new L(e < 0 ? n.state.doc.resolve(i.pos - o.nodeSize) : i)) : lo ? sn(n, new P(n.state.doc.resolve(e < 0 ? l : l + o.nodeSize))) : !1 : !1;
    }
  } else {
    if (r instanceof L && r.node.isInline)
      return sn(n, new P(e > 0 ? r.$to : r.$from));
    {
      let i = ps(n.state, e);
      return i ? sn(n, i) : !1;
    }
...
function Yh(n) {
  ...
  if (!t)
    return;
  let i, o, s = !1;
  for (nt && t.nodeType == 1 && r < Li(t) && kr(t.childNodes[r]) && (s = !0); ; )
    if (r > 0) {
      if (t.nodeType != 1)
        break;
      {
...
`))), 0, 0) : A.empty;
  ...
  if (l || (l = (n.someProp("clipboardParser") || n.someProp("domParser") || Un.fromSchema(n.state.schema)).parseSlice(s, {
    ...
    context: i,
    ruleFromNode(f) {
      return f.nodeName == "BR" && !f.nextSibling && f.parentNode && !ep.test(f.parentNode.nodeName) ? { ignore: !0 } : null;
    }
  })), d)
    l = ip(ua(l, +d[1], +d[2]), d[4]);
  else if (l = A.maxOpen(tp(l.content, i), !0), l.openStart || l.openEnd) {
    let u = 0, f = 0;
...
const ep = /^(a|abbr|acronym|b|cite|code|del|em|i|ins|kbd|label|output|q|ruby|s|samp|span|strong|sub|sup|time|u|tt|var)$/i;
function tp(n, e) {
  if (n.childCount < 2)
    return n;
  for (let t = e.depth; t >= 0; t--) {
...
function gs(n, e, t, r, i, o) {
  ...
  return n.childCount > 1 && (o = 0), i < r - 1 && (l = gs(l, e, t, r, i + 1, o)), i >= t && (l = e < 0 ? s.contentMatchAt(0).fillBefore(l, o <= i).append(l) : l.append(s.contentMatchAt(s.childCount).fillBefore(x.empty, !0))), n.replaceChild(e < 0 ? 0 : n.childCount - 1, s.copy(l));
}
function ua(n, e, t) {
  return e < n.openStart && (n = new A(gs(n.content, -1, e, n.openStart, 0, n.openEnd), e, n.openEnd)), t < n.openEnd && (n = new A(gs(n.content, 1, t, n.openEnd, 0, 0), n.openStart, t)), n;
}
const Ed = {
  thead: ["table"],
  tbody: ["table"],
...
const Ae = {}, Oe = {}, op = { touchstart: !0, touchmove: !0 };
class sp {
  constructor() {
...
function lp(n) {
  for (let e in Ae) {
    ...
    n.dom.addEventListener(e, n.input.eventHandlers[e] = (r) => {
      cp(n, r) && !Gs(n, r) && (n.editable || !(r.type in Oe)) && t(n, r);
    }, op[e] ? { passive: !0 } : void 0);
  }
  Te && n.dom.addEventListener("input", () => null), ys(n);
}
function Wt(n, e) {
...
function dp(n, e) {
  !Gs(n, e) && Ae[e.type] && (n.editable || !(e.type in Oe)) && Ae[e.type](n, e);
}
Oe.keydown = (n, e) => {
  let t = e;
  if (n.input.shiftKey = t.keyCode == 16 || t.shiftKey, !Rd(n, t) && (n.input.lastKeyCode = t.keyCode, n.input.lastKeyCodeTime = Date.now(), !(Ze && we && t.keyCode == 13)))
    if (t.keyCode != 229 && n.domObserver.forceFlush(), Yn && t.keyCode == 13 && !t.ctrlKey && !t.altKey && !t.metaKey) {
      ...
      n.someProp("handleKeyDown", (r) => r(n, t)) || Zh(n, t) ? t.preventDefault() : Wt(n, "key");
};
Oe.keyup = (n, e) => {
...
Oe.keypress = (n, e) => {
  let t = e;
  if (Rd(n, t) || !t.charCode || t.ctrlKey && !t.altKey || je && t.metaKey)
    return;
...
function pp(n, e, t, r, i) {
  return Ys(n, "handleClickOn", e, t, r) || n.someProp("handleClick", (o) => o(n, e, r)) || (i ? hp(n, t) : fp(n, t));
}
function mp(n, e, t, r) {
  return Ys(n, "handleDoubleClickOn", e, t, r) || n.someProp("handleDoubleClick", (i) => i(n, e, r));
}
function gp(n, e, t, r) {
  return Ys(n, "handleTripleClickOn", e, t, r) || n.someProp("handleTripleClick", (i) => i(n, e, r)) || yp(n, t, r);
}
function yp(n, e, t) {
  if (t.button != 0)
    return !1;
  let r = n.state.doc;
  if (e == -1)
    return r.inlineContent ? (qn(n, P.create(r, 0, r.content.size), "pointer"), !0) : !1;
  let i = r.resolve(e);
  for (let o = i.depth + 1; o > 0; o--) {
    let s = o > i.depth ? i.nodeAfter : i.node(o), l = i.before(o);
    if (s.inlineContent)
      qn(n, P.create(r, l + 1, l + 1 + s.content.size), "pointer");
...
const Dd = je ? "metaKey" : "ctrlKey";
Ae.mousedown = (n, e) => {
  let t = e;
  n.input.shiftKey = t.shiftKey;
  let r = Xs(n), i = Date.now(), o = "singleClick";
  i - n.input.lastClick.time < 500 && up(t, n.input.lastClick) && !t[Dd] && (n.input.lastClick.type == "singleClick" ? o = "doubleClick" : n.input.lastClick.type == "doubleClick" && (o = "tripleClick")), n.input.lastClick = { time: i, x: t.clientX, y: t.clientY, type: o };
  let s = n.posAtCoords(co(t));
  s && (o == "singleClick" ? (n.input.mouseDown && n.input.mouseDown.done(), n.input.mouseDown = new vp(n, s, t, !!r)) : (o == "doubleClick" ? mp : gp)(n, s.pos, s.inside, t) ? t.preventDefault() : Wt(n, "pointer"));
};
class vp {
  constructor(e, t, r, i) {
  ...
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let t = this.pos;
    this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(co(e))), this.updateAllowDefault(e), this.allowDefault || !t ? Wt(this.view, "pointer") : pp(this.view, t.pos, t.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
...
Oe.compositionstart = Oe.compositionupdate = (n) => {
  if (!n.composing) {
    ...
    else if (Ii(n), nt && e.selection.empty && t.parentOffset && !t.textOffset && t.nodeBefore.marks.length) {
...
function Id(n) {
  for (n.composing && (n.input.composing = !1, n.input.compositionEndedAt = wp()); n.input.compositionNodes.length > 0; )
...
const Xn = Ne && _t < 15 || Yn && kh < 604;
Ae.copy = Oe.cut = (n, e) => {
  let t = e, r = n.state.selection, i = t.type == "cut";
  if (r.empty)
    return;
  let o = Xn ? null : t.clipboardData, s = r.content(), { dom: l, text: a } = Sd(n, s);
  o ? (t.preventDefault(), o.clearData(), o.setData("text/html", l.innerHTML), o.setData("text/plain", a)) : kp(n, l), i && n.dispatch(n.state.tr.deleteSelection().scrollIntoView().setMeta("uiEvent", "cut"));
};
function xp(n) {
...
function Dr(n, e, t, r, i) {
  ...
  if (!o)
    return !1;
  let s = xp(o), l = s ? n.state.tr.replaceSelectionWith(s, r) : n.state.tr.replaceSelection(o);
...
Oe.paste = (n, e) => {
  ...
  r && Dr(n, r.getData("text/plain"), r.getData("text/html"), i, t) ? t.preventDefault() : Cp(n, t);
};
class Sp {
  constructor(e, t) {
...
const Pd = je ? "altKey" : "ctrlKey";
Ae.dragstart = (n, e) => {
  let t = e, r = n.input.mouseDown;
  if (r && r.done(), !t.dataTransfer)
    return;
  let i = n.state.selection, o = i.empty ? null : n.posAtCoords(co(t));
  ...
  t.dataTransfer.clearData(), t.dataTransfer.setData(Xn ? "Text" : "text/html", l.innerHTML), t.dataTransfer.effectAllowed = "copyMove", Xn || t.dataTransfer.setData("text/plain", a), n.dragging = new Sp(s, !t[Pd]);
};
Ae.dragend = (n) => {
  let e = n.dragging;
  window.setTimeout(() => {
...
class Z {
  ...
  */
  constructor(e, t) {
    this.local = e.length ? e : Pn, this.children = t.length ? t : Pn;
  }
  /**
  ...
  */
  static create(e, t) {
    return t.length ? Pi(t, e, 0, gn) : be;
  }
  /**
  ...
  */
  mapInner(e, t, r, i, o) {
    ...
    return this.children.length ? Mp(this.children, s || [], e, t, r, i, o) : s ? new Z(s.sort(yn), Pn) : be;
  }
  /**
    ...
    e.forEach((l, a) => {
      ...
      if (d = zd(t, l, c)) {
        for (i || (i = this.children.slice()); o < i.length && i[o] < a; )
          o += 3;
        i[o] == a ? i[o + 2] = i[o + 2].addInner(l, d, c + 1) : i.splice(o, 0, a, a + l.nodeSize, Pi(d, l, c + 1, gn)), o += 3;
      }
    });
    let s = Bd(o ? Hd(t) : t, -r);
    for (let l = 0; l < s.length; l++)
...
function Mp(n, e, t, r, i, o, s) {
  ...
  if (a) {
    let c = Tp(l, n, e, t, i, o, s), d = Pi(c, r, 0, s);
    e = d.local;
...
function Pi(n, e, t, r) {
  ...
  e.forEach((l, a) => {
    ...
    if (c) {
      o = !0;
      let d = Pi(c, l, t + a + 1, r);
      d != be && i.push(a, a + l.nodeSize, d);
    }
  });
  let s = Bd(o ? Hd(n) : n, -t).sort(yn);
  for (let l = 0; l < s.length; l++)
...
class Np {
  constructor(e, t) {
    this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new Ep(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let i = 0; i < r.length; i++)
        this.queue.push(r[i]);
      Ne && _t <= 11 && r.some((i) => i.type == "childList" && i.removedNodes.length || i.type == "characterData" && i.oldValue.length > i.target.nodeValue.length) ? this.flushSoon() : this.flush();
    }), Op && (this.onCharData = (r) => {
  ...
  start() {
    this.observer && (this.observer.takeRecords(), this.observer.observe(this.view.dom, Ap)), this.onCharData && this.view.dom.addEventListener("DOMCharacterDataModified", this.onCharData), this.connectSelection();
  }
  stop() {
    if (this.observer) {
  ...
  onSelectionChange() {
    if (oa(this.view)) {
      if (this.suppressingSelectionUpdates)
        return Ot(this.view);
      if (Ne && _t <= 11 && !this.view.state.selection.empty) {
  ...
  flush() {
    ...
    let c = null;
    o < 0 && i && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && so(r) && (c = Us(e)) && c.eq(R.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, Ot(e), this.currentSelection.set(r), e.scrollToSelection()) : (o > -1 || i) && (o > -1 && (e.docView.markDirty(o, s), Dp(e)), this.handleDOMChange(o, s, l, a), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(r) || Ot(e), this.currentSelection.set(r));
  }
  registerMutation(e, t) {
    ...
    if (e.type == "childList") {
      ...
      if (Ne && _t <= 11 && e.addedNodes.length)
        for (let d = 0; d < e.addedNodes.length; d++) {
...
function Lp(n, e, t) {
  ...
  if (d && n.dom.contains(d.nodeType == 1 ? d : d.parentNode) && (c = [{ node: d, offset: a.anchorOffset }], so(a) || c.push({ node: a.focusNode, offset: a.focusOffset })), we && n.input.lastKeyCode === 8)
    for (let g = o; g > i; g--) {
...
const Pp = /^(a|abbr|acronym|b|bd[io]|big|br|button|cite|code|data(list)?|del|dfn|em|i|ins|kbd|label|map|mark|meter|output|q|ruby|s|samp|small|span|strong|su[bp]|time|u|tt|var)$/i;
function Bp(n, e, t, r, i) {
  if (e < 0) {
    let S = n.input.lastSelectionTime > Date.now() - 50 ? n.input.lastSelectionOrigin : null, B = Us(n, S);
  ...
  let l = n.state.selection, a = Lp(n, e, t), c = n.state.doc, d = c.slice(a.from, a.to), u, f;
  ...
  let h = Vp(d.content, a.doc.content, a.from, u, f);
  if ((Yn && n.input.lastIOSEnter > Date.now() - 225 || Ze) && i.some((S) => S.nodeType == 1 && !Pp.test(S.nodeName)) && (!h || h.endA >= h.endB) && n.someProp("handleKeyDown", (S) => S(n, on(13, "Enter")))) {
  ...
  n.input.domChangeCount++, n.state.selection.from < n.state.selection.to && h.start == h.endB && n.state.selection instanceof P && (h.start > n.state.selection.from && h.start <= n.state.selection.from + 2 && n.state.selection.from >= a.from ? h.start = n.state.selection.from : h.endA < n.state.selection.to && h.endA >= n.state.selection.to - 2 && n.state.selection.to <= a.to && (h.endB += n.state.selection.to - h.endA, h.endA = n.state.selection.to)), Ne && _t <= 11 && h.endB == h.start + 1 && h.endA == h.start && h.start > a.from && a.doc.textBetween(h.start - a.from - 1, h.start - a.from + 1) == "  " && (h.start--, h.endA--, h.endB--);
  ...
  if (n.state.selection.anchor > h.start && Hp(c, h.start, h.endA, p, m) && n.someProp("handleKeyDown", (S) => S(n, on(8, "Backspace")))) {
  ...
  if (v) {
    if (p.pos == m.pos)
      Ne && _t <= 11 && p.parentOffset == 0 && (n.domObserver.suppressSelectionUpdates(), setTimeout(() => Ot(n), 20)), T = n.state.tr.delete(C, y), b = c.resolve(h.start).marksAcross(c.resolve(h.endA));
    else if (
      // Adding or removing a mark
      h.endA == h.endB && (O = zp(p.parent.content.cut(p.parentOffset, m.parentOffset), g.parent.content.cut(g.parentOffset, h.endA - g.start())))
    )
  ...
  if (T || (T = n.state.tr.replace(C, y, a.doc.slice(h.start - a.from, h.endB - a.from))), a.sel) {
    ...
    S && !(we && Ze && n.composing && S.empty && (h.start != h.endB || n.input.lastAndroidDelete < Date.now() - 100) && (S.head == C || S.head == T.mapping.map(y) - 1) || Ne && S.empty && S.head == C) && T.setSelection(S);
  }
...
class Fp {
  ...
  */
  ...
  updateStateInner(e, t) {
    ...
    if (s || this._props.plugins != t.plugins || this._props.nodeViews != t.nodeViews) {
      let f = wa(this);
      jp(f, this.nodeViews) && (this.nodeViews = f, i = !0);
    }
    (s || t.handleDOMEvents != this._props.handleDOMEvents) && ys(this), this.editable = ba(this), va(this);
    let l = Po(this), a = ya(this), c = r.plugins != e.plugins && !r.doc.eq(e.doc) ? "reset" : e.scrollToSelection > r.scrollToSelection ? "to selection" : "preserve", d = i || !this.docView.matchesNode(e.doc, a, l);
    (d || !e.selection.eq(r.selection)) && (o = !0);
    let u = c == "preserve" && o && this.dom.style.overflowAnchor == null && Sh(this);
    if (o) {
      this.domObserver.stop();
      let f = d && (Ne || we) && !this.composing && !r.selection.empty && !e.selection.empty && $p(r.selection, e.selection);
      if (d) {
      ...
      f || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && Gh(this)) ? Ot(this, f) : (wd(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
    }
    this.updatePluginViews(r), c == "reset" ? this.dom.scrollTop = 0 : c == "to selection" ? this.scrollToSelection() : u && Mh(u);
  }
  /**
  @internal
  */
  ...
  */
  focus() {
    this.domObserver.stop(), this.editable && Th(this.dom), Ot(this), this.domObserver.start();
  }
  /**
  ...
  */
  destroy() {
    this.docView && (ap(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], Po(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null);
  }
  /**
  ...
  */
  domSelectionRange() {
    return Te && this.root.nodeType === 11 && yh(this.dom.ownerDocument) == this.dom ? Rp(this) : this.domSelection();
  }
  /**
  @internal
  */
...
var Jt = {
  ...
  221: "}",
  222: '"'
}, Wp = typeof navigator < "u" && /Mac/.test(navigator.platform), _p = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
...
for (var zo in Jt)
  Bi.hasOwnProperty(zo) || (Bi[zo] = Jt[zo]);
function Kp(n) {
  var e = Wp && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey || _p && n.shiftKey && n.key && n.key.length == 1 || n.key == "Unidentified", t = !e && n.key || (n.shiftKey ? Bi : Jt)[n.keyCode] || n.key || "Unidentified";
  return t == "Esc" && (t = "Escape"), t == "Del" && (t = "Delete"), t == "Left" && (t = "ArrowLeft"), t == "Up" && (t = "ArrowUp"), t == "Right" && (t = "ArrowRight"), t == "Down" && (t = "ArrowDown"), t;
}
const qp = typeof navigator < "u" ? /Mac|iP(hone|[oa]d)/.test(navigator.platform) : !1;
function Up(n) {
...
const Yp = (n, e) => n.selection.empty ? !1 : (e && e(n.tr.deleteSelection().scrollIntoView()), !0);
function Xp(n, e) {
...
function mm(n, e = null) {
  return function(t, r) {
    ...
    if (s.depth >= 2 && i.node(s.depth - 1).type.compatibleContent(n) && s.startIndex == 0) {
      ...
      a = new Ei(d, d, s.depth), s.endIndex < s.parent.childCount && (s = new Ei(i, t.doc.resolve(o.end(s.depth)), s.depth)), l = !0;
    }
    let c = js(a, n, e, s);
    return c ? (r && r(gm(t.tr, s, c, l, n).scrollIntoView()), !0) : !1;
  };
}
...
function ym(n) {
  return function(e, t) {
    ...
    return o ? t ? r.node(o.depth - 1).type == n ? vm(e, t, n, o) : bm(e, t, o) : !0 : !1;
  };
}
function vm(n, e, t, r) {
  let i = n.tr, o = r.end, s = r.$to.end(r.depth);
  o < s && (i.step(new he(o - 1, s, o, s, new A(x.from(t.create(null, r.parent.copy())), 1, 0), 1, !0)), r = new Ei(i.doc.resolve(r.$from.pos), i.doc.resolve(s), r.depth));
  const l = ir(r);
  if (l == null)
    return !1;
  i.lift(r, l);
...
function _d(n) {
  const e = [], { nodeExtensions: t, markExtensions: r } = ho(n), i = [...t, ...r], o = {
    default: null,
    rendered: !0,
    renderHTML: null,
    parseHTML: null,
  ...
  return n.style ? n : {
    ...
    getAttrs: (t) => {
      ...
      const i = e.reduce((o, s) => {
        const l = s.attribute.parseHTML ? s.attribute.parseHTML(t) : Cm(t.getAttribute(s.name));
        return l == null ? o : {
          ...o,
          [s.name]: l
        };
...
function Sa(n) {
  return Object.fromEntries(
    // @ts-ignore
    Object.entries(n).filter(([e, t]) => e === "attrs" && xm(t) ? !1 : t != null)
  );
}
function Sm(n, e) {
  var t;
  const r = _d(n), { nodeExtensions: i, markExtensions: o } = ho(n), s = (t = i.find((c) => E(c, "topNode"))) === null || t === void 0 ? void 0 : t.name, l = Object.fromEntries(i.map((c) => {
...
function Fo(n) {
  ...
  return s.forEach((f) => {
    ...
    if (!h)
      return;
    const p = a.state.tr, m = uo({
      state: a.state,
      transaction: p
    }), g = {
      from: r - (h[0].length - o.length),
      to: i
    }, { commands: v, chain: w, can: C } = new fo({
      editor: t,
      state: m
    });
    f.handler({
...
function Nm(n) {
  const { editor: e, state: t, from: r, to: i, rule: o } = n, { commands: s, chain: l, can: a } = new fo({
    editor: e,
    state: t
  }), c = [];
...
class Vn {
  constructor(e, t) {
    this.splittableMarks = [], this.editor = t, this.extensions = Vn.resolve(e), this.schema = Sm(this.extensions, t), this.extensions.forEach((r) => {
      var i;
  ...
  static resolve(e) {
    const t = Vn.sort(Vn.flatten(e)), r = Rm(t.map((i) => i.name));
  ...
  get nodeViews() {
    const { editor: e } = this, { nodeExtensions: t } = ho(this.extensions);
...
function mo(n, e) {
  const t = { ...n };
  return $o(n) && $o(e) && Object.keys(e).forEach((r) => {
    $o(e[r]) ? r in n ? t[r] = mo(n[r], e[r]) : Object.assign(t, { [r]: e[r] }) : Object.assign(t, { [r]: e[r] });
  }), t;
}
class se {
  constructor(e = {}) {
  ...
  configure(e = {}) {
    const t = this.extend();
    return t.options = mo(this.options, e), t.storage = z(E(t, "addStorage", {
      name: t.name,
      options: t.options
    })), t;
  }
...
const Im = se.create({
...
}), !0), Bm = (n = !1) => ({ commands: e }) => e.setContent("", n), zm = () => ({ state: n, tr: e, dispatch: t }) => {
...
}, Hm = (n) => (e) => n(e), Vm = () => ({ state: n, dispatch: e }) => am(n, e), Fm = () => ({ tr: n, dispatch: e }) => {
  ...
  return !1;
}, jm = (n) => ({ tr: e, dispatch: t }) => {
  const { from: r, to: i } = n;
  return t && e.delete(r, i), !0;
}, Wm = () => ({ state: n, dispatch: e }) => Yp(n, e), _m = () => ({ commands: n }) => n.keyboardShortcut("Enter"), Km = () => ({ state: n, dispatch: e }) => lm(n, e);
function zi(n, e, t = { strict: !0 }) {
  const r = Object.keys(e);
  return r.length ? r.every((i) => t.strict ? e[i] === n[i] : nl(e[i]) ? e[i].test(n[i]) : e[i] === n[i]) : !0;
}
function bs(n, e, t = {}) {
  return n.find((r) => r.type === e && zi(r.attrs, t));
}
function qm(n, e, t = {}) {
  return !!bs(n, e, t);
}
function rl(n, e, t = {}) {
  ...
  if (n.parentOffset === r.offset && r.offset !== 0 && (r = n.parent.childBefore(n.parentOffset)), !r.node)
    return;
  const i = bs([...r.node.marks], e, t);
  if (!i)
    return;
  let o = r.index, s = n.start() + r.offset, l = o + 1, a = s + r.node.nodeSize;
  for (bs([...r.node.marks], e, t); o > 0 && i.isInSet(n.parent.child(o - 1).marks); )
...
const Um = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
...
function Gd(n, e = null) {
  ...
  return e === "all" ? P.create(n, At(0, i, o), At(n.content.size, i, o)) : P.create(n, At(e, i, o), At(e, i, o));
}
function ol() {
  return [
    "iPad Simulator",
...
const Gm = (n = null, e = {}) => ({ editor: t, view: r, tr: i, dispatch: o }) => {
  e = {
    scrollIntoView: !0,
    ...e
  };
...
}, Ym = (n, e) => (t) => n.every((r, i) => e(r, { ...t, index: i })), Xm = (n, e) => ({ tr: t, commands: r }) => r.insertContentAt({ from: t.selection.from, to: t.selection.to }, n, e);
function Ta(n) {
  const e = `<body>${n}</body>`;
...
function Hi(n, e, t) {
  if (t = {
    ...
    try {
      ...
      return console.warn("[tiptap warn]: Invalid content.", "Passed value:", n, "Error:", r), Hi("", e, t);
    }
  if (typeof n == "string") {
...
const Zm = (n) => n.toString().startsWith("<"), eg = (n, e, t) => ({ tr: r, dispatch: i, editor: o }) => {
  if (i) {
    t = {
      parseOptions: {},
      updateSelection: !0,
    ...
    c ? Array.isArray(e) ? r.insertText(e.map((f) => f.text || "").join(""), l, a) : typeof e == "object" && e && e.text ? r.insertText(e.text, l, a) : r.insertText(e, l, a) : r.replaceWith(l, a, s), t.updateSelection && Qm(r, r.steps.length - 1, -1);
  }
  return !0;
}, tg = () => ({ state: n, dispatch: e }) => rm(n, e), ng = () => ({ state: n, dispatch: e }) => im(n, e), rg = () => ({ state: n, dispatch: e }) => Qp(n, e), ig = () => ({ state: n, dispatch: e }) => tm(n, e);
function Yd() {
...
const sg = (n) => ({ editor: e, view: t, tr: r, dispatch: i }) => {
...
function Lr(n, e, t = {}) {
  ...
  const a = i - r, c = l.filter((u) => s ? s.name === u.node.type.name : !0).filter((u) => zi(u.node.attrs, t, { strict: !1 }));
  return o ? !!c.length : c.reduce((u, f) => u + f.to - f.from, 0) >= a;
}
const lg = (n, e = {}) => ({ state: t, dispatch: r }) => {
  const i = me(n, t.schema);
  return Lr(t, i, e) ? om(t, r) : !1;
}, ag = () => ({ state: n, dispatch: e }) => cm(n, e), cg = (n) => ({ state: e, dispatch: t }) => {
  const r = me(n, e.schema);
  return ym(r)(e, t);
}, dg = () => ({ state: n, dispatch: e }) => sm(n, e);
function go(n, e) {
...
const ug = (n, e) => ({ tr: t, state: r, dispatch: i }) => {
  let o = null, s = null;
  const l = go(typeof n == "string" ? n : n.name, r.schema);
...
}, fg = () => ({ tr: n, dispatch: e }) => (e && n.scrollIntoView(), !0), hg = () => ({ tr: n, commands: e }) => e.setTextSelection({
  from: 0,
  to: n.doc.content.size
}), pg = () => ({ state: n, dispatch: e }) => Zp(n, e), mg = () => ({ state: n, dispatch: e }) => nm(n, e), gg = () => ({ state: n, dispatch: e }) => dm(n, e), yg = () => ({ state: n, dispatch: e }) => hm(n, e), vg = () => ({ state: n, dispatch: e }) => fm(n, e);
function Xd(n, e, t = {}) {
  return Hi(n, e, { slice: !1, parseOptions: t });
}
const bg = (n, e = !1, t = {}) => ({ tr: r, editor: i, dispatch: o }) => {
...
function Zd(n, e) {
  const t = go(typeof e == "string" ? e : e.name, n.schema);
  return t === "node" ? Mg(n, e) : t === "mark" ? yo(n, e) : {};
}
function Tg(n, e = JSON.stringify) {
  const t = {};
  return n.filter((r) => {
    const i = e(r);
...
function ws(n, e, t = {}) {
  ...
  if (r)
    return !!(n.storedMarks || n.selection.$from.marks()).filter((u) => o ? o.name === u.type.name : !0).find((u) => zi(u.attrs, t, { strict: !1 }));
  let s = 0;
  const l = [];
  if (i.forEach(({ $from: u, $to: f }) => {
    ...
    return !1;
  const a = l.filter((u) => o ? o.name === u.mark.type.name : !0).filter((u) => zi(u.mark.attrs, t, { strict: !1 })).reduce((u, f) => u + f.to - f.from, 0), c = l.filter((u) => o ? u.mark.type !== o && u.mark.type.excludes(o) : !0).reduce((u, f) => u + f.to - f.from, 0);
  return (a > 0 ? a + c : a) >= s;
}
function Eg(n, e, t = {}) {
  if (!e)
    return Lr(n, null, t) || ws(n, null, t);
  const r = go(e, n.schema);
  return r === "node" ? Lr(n, e, t) : r === "mark" ? ws(n, e, t) : !1;
}
function Oa(n, e) {
  const { nodeExtensions: t } = ho(e), r = t.find((s) => s.name === n);
  if (!r)
    return !1;
  const i = {
    name: r.name,
...
const Lg = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  ...
  return Rg(r, t, a);
}, Ig = (n, e) => ({ tr: t }) => (t.setMeta(n, e), !0), Pg = (n, e = {}) => ({ state: t, dispatch: r, chain: i }) => {
  ...
  return !0;
}, zg = (n) => ({ tr: e, dispatch: t }) => {
  if (t) {
    const { doc: r } = e, { from: i, to: o } = typeof n == "number" ? { from: n, to: n } : n, s = P.atStart(r).from, l = P.atEnd(r).to, a = At(i, s, l), c = At(o, s, l), d = P.create(r, a, c);
    e.setSelection(d);
  }
  return !0;
}, Hg = (n) => ({ state: e, dispatch: t }) => {
  const r = me(n, e.schema);
  return wm(r)(e, t);
};
function Ea(n, e) {
...
const Vg = ({ keepMarks: n = !0 } = {}) => ({ tr: e, state: t, dispatch: r, editor: i }) => {
  ...
  if (r) {
    ...
    const f = l.depth === 0 ? void 0 : kg(l.node(-1).contentMatchAt(l.indexAfter(-1)));
    let h = u && f ? [
      {
        type: f,
        attrs: d
  ...
  return !0;
}, Fg = (n) => ({ tr: e, state: t, dispatch: r, editor: i }) => {
  var o;
...
}, $g = (n, e, t, r = {}) => ({ editor: i, tr: o, state: s, dispatch: l, chain: a, commands: c, can: d }) => {
  ...
  if (C.depth >= 1 && T && C.depth - T.depth <= 1) {
    ...
    if (Oa(T.node.type.name, u) && h.validContent(T.node.content) && l)
      return a().command(() => (o.setNodeMarkup(T.pos, h), !0)).command(() => jo(o, h)).command(() => Wo(o, h)).run();
  }
  return !t || !y || !l ? a().command(() => d().wrapInList(h, r) ? !0 : c.clearNodes()).wrapInList(h, r).command(() => jo(o, h)).command(() => Wo(o, h)).run() : a().command(() => {
    const b = d().wrapInList(h, r), O = y.filter((S) => f.includes(S.type.name));
    return o.ensureMarks(O), b ? !0 : c.clearNodes();
  }).wrapInList(h, r).command(() => jo(o, h)).command(() => Wo(o, h)).run();
}, jg = (n, e = {}, t = {}) => ({ state: r, commands: i }) => {
  const { extendEmptyMarkRange: o = !1 } = t, s = Qt(n, r.schema);
  return ws(r, s, e) ? i.unsetMark(s, { extendEmptyMarkRange: o }) : i.setMark(s, e);
}, Wg = (n, e, t = {}) => ({ state: r, commands: i }) => {
  const o = me(n, r.schema), s = me(e, r.schema);
  return Lr(r, o, t) ? i.setNode(s) : i.setNode(o, t);
}, _g = (n, e = {}) => ({ state: t, commands: r }) => {
  const i = me(n, t.schema);
...
var Xg = /* @__PURE__ */ Object.freeze({
  ...
  scrollIntoView: fg,
  selectAll: hg,
  selectNodeBackward: pg,
  selectNodeForward: mg,
  selectParentNode: gg,
  selectTextblockEnd: yg,
...
let s1 = class extends km {
   ...
   */
  injectCSS() {
    this.options.injectCSS && document && (this.css = o1(i1, this.options.injectNonce));
  }
  /**
  ...
  createExtensionManager() {
    const t = [...this.options.enableCoreExtensions ? Object.values(r1) : [], ...this.options.extensions].filter((r) => ["extension", "node", "mark"].includes(r == null ? void 0 : r.type));
  ...
  createView() {
    ...
    this.view = new Fp(this.options.element, {
   ...
   */
  getHTML() {
    return Cg(this.state.doc.content, this.schema);
  }
  /**
  ...
  return new po({
    ...
    handler: ({ state: e, range: t, match: r }) => {
      ...
      if (s) {
        ...
        if (Vi(t.from, t.to, e.doc).filter((h) => h.mark.type.excluded.find((m) => m === n.type && m !== h.mark.type)).filter((h) => h.to > d).length)
          return null;
...
var De = "top", Je = "bottom", Ge = "right", Re = "left", ll = "auto", Kr = [De, Je, Ge, Re], Zn = "start", Pr = "end", d1 = "clippingParents", tu = "viewport", pr = "popper", u1 = "reference", Na = /* @__PURE__ */ Kr.reduce(function(n, e) {
  return n.concat([e + "-" + Zn, e + "-" + Pr]);
}, []), nu = /* @__PURE__ */ [].concat(Kr, [ll]).reduce(function(n, e) {
  return n.concat([e, e + "-" + Zn, e + "-" + Pr]);
}, []), f1 = "beforeRead", h1 = "read", p1 = "afterRead", m1 = "beforeMain", g1 = "main", y1 = "afterMain", v1 = "beforeWrite", b1 = "write", w1 = "afterWrite", k1 = [f1, h1, p1, m1, g1, y1, v1, b1, w1];
function gt(n) {
...
function x1(n) {
  ...
  Object.keys(e.elements).forEach(function(t) {
    ...
    !Ue(o) || !gt(o) || (Object.assign(o.style, r), Object.keys(i).forEach(function(s) {
      var l = i[s];
...
function C1(n) {
  ...
  return Object.assign(e.elements.popper.style, t.popper), e.styles = t, e.elements.arrow && Object.assign(e.elements.arrow.style, t.arrow), function() {
    Object.keys(e.elements).forEach(function(r) {
      ...
      !Ue(i) || !gt(i) || (Object.assign(i.style, l), Object.keys(o).forEach(function(a) {
        i.removeAttribute(a);
      }));
    });
  };
...
var vn = Math.max, Fi = Math.min, er = Math.round;
function xs() {
...
function tr(n, e, t) {
  ...
  e && Ue(n) && (i = n.offsetWidth > 0 && er(r.width) / n.offsetWidth || 1, o = n.offsetHeight > 0 && er(r.height) / n.offsetHeight || 1);
  var s = Cn(n) ? ze(n) : window, l = s.visualViewport, a = !iu() && t, c = (r.left + (a && l ? l.offsetLeft : 0)) / i, d = (r.top + (a && l ? l.offsetTop : 0)) / o, u = r.width / i, f = r.height / o;
  return {
    width: u,
    height: f,
    top: d,
...
function M1(n) {
  var e = /firefox/i.test(xs()), t = /Trident/i.test(xs());
  if (t && Ue(n)) {
    var r = Et(n);
    if (r.position === "fixed")
      return null;
  ...
  var i = vo(n);
  for (al(i) && (i = i.host); Ue(i) && ["html", "body"].indexOf(gt(i)) < 0; ) {
    var o = Et(i);
...
function qr(n) {
  for (var e = ze(n), t = Da(n); t && S1(t) && Et(t).position === "static"; )
    t = Da(t);
  return t && (gt(t) === "html" || gt(t) === "body" && Et(t).position === "static") ? e : t || M1(n) || e;
}
function dl(n) {
...
function O1(n) {
  var e, t = n.state, r = n.name, i = n.options, o = t.elements.arrow, s = t.modifiersData.popperOffsets, l = ht(t.placement), a = dl(l), c = [Re, Ge].indexOf(l) >= 0, d = c ? "height" : "width";
  if (!(!o || !s)) {
    var u = A1(i.padding, t), f = cl(o), h = a === "y" ? De : Re, p = a === "y" ? Je : Ge, m = t.rects.reference[d] + t.rects.reference[a] - s[a] - t.rects.popper[d], g = s[a] - t.rects.reference[a], v = qr(o), w = v ? a === "y" ? v.clientHeight || 0 : v.clientWidth || 0 : 0, C = m / 2 - g / 2, y = u[h], T = w - f[d] - u[p], b = w / 2 - f[d] / 2 + C, O = xr(y, b, T), S = a;
...
function Ra(n) {
  ...
  if (c) {
    ...
    if (b === ze(t) && (b = Zt(t), Et(b).position !== "static" && l === "absolute" && (O = "scrollHeight", S = "scrollWidth")), b = b, i === De || (i === Re || i === Ge) && o === Pr) {
      y = Je;
...
function V1(n, e) {
  var t = ze(n), r = Zt(n), i = t.visualViewport, o = r.clientWidth, s = r.clientHeight, l = 0, a = 0;
  if (i) {
...
function cu(n) {
  return ["html", "body", "#document"].indexOf(gt(n)) >= 0 ? n.ownerDocument.body : Ue(n) && hl(n) ? n : cu(vo(n));
}
function Cr(n, e) {
  var t;
  e === void 0 && (e = []);
  var r = cu(n), i = r === ((t = n.ownerDocument) == null ? void 0 : t.body), o = ze(r), s = i ? [o].concat(o.visualViewport || [], hl(r) ? r : []) : r, l = e.concat(s);
  return i ? l : (
...
function Ia(n, e, t) {
  return e === tu ? Cs(V1(n, t)) : Cn(e) ? $1(e, t) : Cs(F1(Zt(n)));
}
function j1(n) {
  var e = Cr(vo(n)), t = ["absolute", "fixed"].indexOf(Et(n).position) >= 0, r = t && Ue(n) ? qr(n) : n;
  return Cn(r) ? e.filter(function(i) {
    return Cn(i) && ou(i, r) && gt(i) !== "body";
  }) : [];
}
function W1(n, e, t, r) {
  var i = e === "clippingParents" ? j1(n) : [].concat(e), o = [].concat(i, [t]), s = o[0], l = o.reduce(function(a, c) {
    var d = Ia(n, c, r);
    return a.top = vn(d.top, a.top), a.right = Fi(d.right, a.right), a.bottom = Fi(d.bottom, a.bottom), a.left = vn(d.left, a.left), a;
  }, Ia(n, s, r));
...
function Br(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = r === void 0 ? n.placement : r, o = t.strategy, s = o === void 0 ? n.strategy : o, l = t.boundary, a = l === void 0 ? d1 : l, c = t.rootBoundary, d = c === void 0 ? tu : c, u = t.elementContext, f = u === void 0 ? pr : u, h = t.altBoundary, p = h === void 0 ? !1 : h, m = t.padding, g = m === void 0 ? 0 : m, v = lu(typeof g != "number" ? g : au(g, Kr)), w = f === pr ? u1 : pr, C = n.rects.popper, y = n.elements[p ? w : f], T = W1(Cn(y) ? y : y.contextElement || Zt(n.elements.popper), a, d, s), b = tr(n.elements.reference), O = du({
    reference: b,
    element: C,
    strategy: "absolute",
    placement: i
  }), S = Cs(Object.assign({}, C, O)), B = f === pr ? S : b, H = {
...
function q1(n) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !0 : s, a = t.fallbackPlacements, c = t.padding, d = t.boundary, u = t.rootBoundary, f = t.altBoundary, h = t.flipVariations, p = h === void 0 ? !0 : h, m = t.allowedAutoPlacements, g = e.options.placement, v = ht(g), w = v === g, C = a || (w || !p ? [bi(g)] : K1(g)), y = [g].concat(C).reduce(function(vt, Ye) {
      return vt.concat(ht(Ye) === ll ? _1(e, {
        placement: Ye,
        boundary: d,
        rootBoundary: u,
        padding: c,
      ...
      var q = y[H], j = ht(q), _ = nr(q) === Zn, X = [De, Je].indexOf(j) >= 0, ee = X ? "width" : "height", Y = Br(e, {
        placement: q,
        boundary: d,
        rootBoundary: u,
        altBoundary: f,
    ...
    if (S)
      for (var de = p ? 3 : 1, ve = function(Ye) {
        var bt = y.find(function(Tn) {
          var wt = O.get(Tn);
          if (wt)
            return wt.slice(0, Ye).every(function(An) {
              return An;
            });
        });
        if (bt)
...
function J1(n) {
  var e = n.state, t = n.name, r = e.rects.reference, i = e.rects.popper, o = e.modifiersData.preventOverflow, s = Br(e, {
    ...
    altBoundary: !0
  }), a = Pa(s, r), c = Pa(l, i, o), d = Ba(a), u = Ba(c);
  e.modifiersData[t] = {
...
function Y1(n, e, t) {
  var r = ht(n), i = [Re, De].indexOf(r) >= 0 ? -1 : 1, o = typeof t == "function" ? t(Object.assign({}, e, {
    placement: n
  })) : t, s = o[0], l = o[1];
...
function n0(n) {
  var e = n.state, t = n.options, r = n.name, i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !1 : s, a = t.boundary, c = t.rootBoundary, d = t.altBoundary, u = t.padding, f = t.tether, h = f === void 0 ? !0 : f, p = t.tetherOffset, m = p === void 0 ? 0 : p, g = Br(e, {
    boundary: a,
    rootBoundary: c,
    padding: u,
    altBoundary: d
  }), v = ht(e.placement), w = nr(e.placement), C = !w, y = dl(v), T = t0(y), b = e.modifiersData.popperOffsets, O = e.rects.reference, S = e.rects.popper, B = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, H = typeof B == "number" ? {
    mainAxis: B,
    altAxis: B
  ...
  if (b) {
    if (o) {
      var _, X = y === "y" ? De : Re, ee = y === "y" ? Je : Ge, Y = y === "y" ? "height" : "width", W = b[y], U = W + g[X], Q = W - g[ee], de = h ? -S[Y] / 2 : 0, ve = w === Zn ? O[Y] : S[Y], Ce = w === Zn ? -S[Y] : -O[Y], He = e.elements.arrow, vt = h && He ? cl(He) : {
        width: 0,
        height: 0
      }, Ye = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : su(), bt = Ye[X], Tn = Ye[ee], wt = xr(0, O[Y], vt[Y]), An = C ? O[Y] / 2 - de - wt - bt - H.mainAxis : ve - wt - bt - H.mainAxis, Nt = C ? -O[Y] / 2 + de + wt + Tn + H.mainAxis : Ce + wt + Tn + H.mainAxis, On = e.elements.arrow && qr(e.elements.arrow), Ur = On ? y === "y" ? On.clientTop || 0 : On.clientLeft || 0 : 0, sr = (_ = q == null ? void 0 : q[y]) != null ? _ : 0, Jr = W + An - sr - Ur, Gr = W + Nt - sr, lr = xr(h ? Fi(U, Jr) : U, W, h ? vn(Q, Gr) : Q);
      b[y] = lr, j[y] = lr - W;
    }
    if (l) {
      var ar, Yr = y === "x" ? De : Re, Xr = y === "x" ? Je : Ge, kt = b[T], Dt = T === "y" ? "height" : "width", cr = kt + g[Yr], en = kt - g[Xr], dr = [De, Re].indexOf(v) !== -1, Qr = (ar = q == null ? void 0 : q[T]) != null ? ar : 0, Zr = dr ? cr : kt - O[Dt] - S[Dt] - Qr + H.altAxis, ei = dr ? kt + O[Dt] + S[Dt] - Qr - H.altAxis : en, ti = h && dr ? T1(Zr, kt, ei) : xr(h ? Zr : cr, kt, h ? ei : en);
      b[T] = ti, j[T] = ti - kt;
    }
    e.modifiersData[r] = j;
  }
...
function l0(n, e, t) {
  t === void 0 && (t = !1);
  var r = Ue(e), i = Ue(e) && s0(e), o = Zt(e), s = tr(n, i, t), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, a = {
    x: 0,
  ...
  hl(o)) && (l = o0(e)), Ue(e) ? (a = tr(e, !0), a.x += e.clientLeft, a.y += e.clientTop) : o && (a.x = fl(o))), {
  ...
  return function(l, a, c) {
    ...
    var d = {
      ...
      setOptions: function(v) {
        ...
        var C = c0(u0([].concat(r, d.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!f) {
          ...
          if (Ha(w, C)) {
            d.rects = {
              reference: l0(w, qr(C), d.options.strategy === "fixed"),
              popper: cl(C)
...
var h0 = [B1, e0, I1, ru, Q1, U1, r0, N1, G1], p0 = /* @__PURE__ */ f0({
  defaultModifiers: h0
}), m0 = "tippy-box", uu = "tippy-content", g0 = "tippy-backdrop", fu = "tippy-arrow", hu = "tippy-svg-arrow", rn = {
  passive: !0,
  capture: !0
}, pu = function() {
...
function M0(n) {
  return zr(n) ? [n] : x0(n) ? $i(n) : Array.isArray(n) ? n : $i(document.querySelectorAll(n));
}
function Ko(n, e) {
...
function N0() {
  document.addEventListener("touchstart", O0, rn), window.addEventListener("blur", E0);
}
var D0 = typeof window < "u" && typeof document < "u", R0 = D0 ? (
  // @ts-ignore
  !!window.msCrypto
) : !1;
function Rn(n) {
...
var Hr;
process.env.NODE_ENV !== "production" && I0();
function I0() {
  Hr = /* @__PURE__ */ new Set();
}
function Tt(n, e) {
...
function P0(n) {
  ...
  Ss(e, ["tippy() was passed", "`" + String(n) + "`", "as its targets (first) argument. Valid types are: String, Element,", "Element[], or NodeList."].join(" ")), Ss(t, ["tippy() was passed a plain object which is not supported as an argument", "for virtual positioning. Use props.getReferenceClientRect instead."].join(" "));
}
var vu = {
  animateFill: !1,
  followCursor: !1,
  ...
  triggerTarget: null
}, vu, B0), z0 = Object.keys(Be), H0 = function(e) {
...
function V0(n, e) {
  var t = e ? Object.keys(bu(Object.assign({}, Be, {
    plugins: e
  }))) : z0, r = t.reduce(function(i, o) {
...
function qa(n, e) {
  ...
  }, e.ignoreAttributes ? {} : V0(n, e.plugins));
...
function wu(n, e) {
  ...
  var t = Object.keys(n);
  t.forEach(function(r) {
    var i = v0(Be, Object.keys(vu)), o = !y0(i, r);
...
function Ua(n) {
  var e = Sr();
  return n === !0 ? e.className = fu : (e.className = hu, zr(n) ? e.appendChild(n) : Ms(e, n)), e;
}
function Ja(n, e) {
  zr(e.content) ? (Ms(n, ""), n.appendChild(e.content)) : typeof e.content != "function" && (e.allowHTML ? Ms(n, e.content) : n.textContent = e.content);
}
function Ts(n) {
  var e = n.firstElementChild, t = $i(e.children);
  return {
    box: e,
...
function ku(n) {
  var e = Sr(), t = Sr();
  t.className = m0, t.setAttribute("data-state", "hidden"), t.setAttribute("tabindex", "-1");
  var r = Sr();
  r.className = uu, r.setAttribute("data-state", "hidden"), Ja(r, n.props), e.appendChild(t), t.appendChild(r), i(n.props, n.props);
  function i(o, s) {
    var l = Ts(e), a = l.box, c = l.content, d = l.arrow;
...
var $0 = 1, ai = [], Uo = [];
function j0(n, e) {
  var t = qa(n, Object.assign({}, Be, bu($a(e)))), r, i, o, s = !1, l = !1, a = !1, c = !1, d, u, f, h = [], p = Va(Jr, t.interactiveDebounce), m, g = $0++, v = null, w = w0(t.plugins), C = {
  ...
  if (!t.render)
    return process.env.NODE_ENV !== "production" && Ss(!0, "render() function has not been supplied."), y;
  ...
  function X() {
    var k = _().parentNode;
    return k ? T0(k) : document;
  }
  function ee() {
    return Ts(b);
  }
  function Y(k) {
    return y.state.isMounted && !y.state.isVisible || ct.isTouch || d && d.type === "focus" ? 0 : _o(y.props.delay, k ? 0 : 1, Be.delay);
  }
  function W(k) {
  ...
  function Q() {
    var k = y.props.aria;
    if (k.content) {
      var N = "aria-" + k.content, I = b.id, K = Bn(y.props.triggerTarget || n);
      K.forEach(function($) {
  ...
  function de() {
    if (!(B || !y.props.aria.expanded)) {
      var k = Bn(y.props.triggerTarget || n);
  ...
  function Ce(k) {
    if (!(ct.isTouch && (a || k.type === "mousedown"))) {
      ...
      if (!(y.props.interactive && Wa(b, N))) {
        if (Bn(y.props.triggerTarget || n).some(function(I) {
          return Wa(I, N);
        })) {
  ...
  function Ye() {
    var k = X();
    k.addEventListener("mousedown", Ce, !0), k.addEventListener("touchend", Ce, rn), k.addEventListener("touchstart", vt, rn), k.addEventListener("touchmove", He, rn);
  }
  function bt() {
    var k = X();
    k.removeEventListener("mousedown", Ce, !0), k.removeEventListener("touchend", Ce, rn), k.removeEventListener("touchstart", vt, rn), k.removeEventListener("touchmove", He, rn);
  }
  function Tn(k, N) {
    An(k, function() {
  ...
  function An(k, N) {
    var I = ee().box;
    function K($) {
      $.target === I && (qo(I, "remove", K), N());
    }
    if (k === 0)
      return N();
    qo(I, "remove", u), qo(I, "add", K), u = K;
  }
  function Nt(k, N, I) {
    I === void 0 && (I = !1);
    var K = Bn(y.props.triggerTarget || n);
  ...
  function On() {
    q() && (Nt("touchstart", sr, {
      ...
      passive: !0
    })), b0(y.props.trigger).forEach(function(k) {
      if (k !== "manual")
        switch (Nt(k, sr), k) {
          case "mouseenter":
            Nt("mouseleave", Gr);
  ...
  function sr(k) {
    ...
    if (!(!y.state.isEnabled || ar(k) || l)) {
      ...
      d = k, m = k.currentTarget, de(), !y.state.isVisible && C0(k) && ai.forEach(function($) {
        return $(k);
  ...
  function Jr(k) {
    ...
    if (!(k.type === "mousemove" && I)) {
      var K = Dt().concat(b).map(function($) {
        var Se, Ve = $._tippy, En = (Se = Ve.popperInstance) == null ? void 0 : Se.state;
        return En ? {
  ...
  function Yr() {
    Xr();
    var k = y.props, N = k.popperOptions, I = k.placement, K = k.offset, $ = k.getReferenceClientRect, Se = k.moveTransition, Ve = j() ? Ts(b).arrow : null, En = $ ? {
      ...
      fn: function(ni) {
        ...
        if (j()) {
          ...
          ["placement", "reference-hidden", "escaped"].forEach(function(ri) {
            ri === "placement" ? xo.setAttribute("data-placement", Nn.placement) : Nn.attributes.popper["data-popper-" + ri] ? xo.setAttribute("data-" + ri, "") : xo.removeAttribute("data-" + ri);
    ...
    }), tn.push.apply(tn, (N == null ? void 0 : N.modifiers) || []), y.popperInstance = p0(En, b, Object.assign({}, N, {
      placement: I,
      onFirstUpdate: f,
      modifiers: tn
    }));
...
`, "See: https://atomiks.github.io/tippyjs/v6/accessibility/#interactivity"].join(" "));
  ...
  function Dt() {
    return $i(b.querySelectorAll("[data-tippy-root]"));
  }
  function cr(k) {
  ...
  function ei(k) {
    if (process.env.NODE_ENV !== "production" && Tt(y.state.isDestroyed, Rn("setProps")), !y.state.isDestroyed) {
      ...
      y.props = I, On(), N.interactiveDebounce !== I.interactiveDebounce && (ve(), p = Va(Jr, I.interactiveDebounce)), N.triggerTarget && !I.triggerTarget ? Bn(N.triggerTarget).forEach(function(K) {
  ...
  function Uu() {
    ...
    var k = y.state.isVisible, N = y.state.isDestroyed, I = !y.state.isEnabled, K = ct.isTouch && !y.props.touch, $ = _o(y.props.duration, 0, Be.duration);
    if (!(k || N || I || K) && !_().hasAttribute("disabled") && (U("onShow", [y], !1), y.props.onShow(y) !== !1)) {
      if (y.state.isVisible = !0, j() && (b.style.visibility = "visible"), W(), Ye(), y.state.isMounted || (b.style.transition = "none"), j()) {
        var Se = ee(), Ve = Se.box, En = Se.content;
        Ko([Ve, En], 0);
      }
      f = function() {
        var tn;
        if (!(!y.state.isVisible || c)) {
          if (c = !0, b.offsetHeight, b.style.transition = y.props.moveTransition, j() && y.props.animation) {
            var ko = ee(), ni = ko.box, Nn = ko.content;
            Ko([ni, Nn], $), ja([ni, Nn], "visible");
          }
          Q(), de(), Fa(Uo, y), (tn = y.popperInstance) == null || tn.forceUpdate(), U("onMount", [y]), y.props.animation && j() && wt($, function() {
  ...
  function Ju() {
    ...
    var k = !y.state.isVisible, N = y.state.isDestroyed, I = !y.state.isEnabled, K = _o(y.props.duration, 1, Be.duration);
    if (!(k || N || I) && (U("onHide", [y], !1), y.props.onHide(y) !== !1)) {
      if (y.state.isVisible = !1, y.state.isShown = !1, c = !1, s = !1, j() && (b.style.visibility = "hidden"), ve(), bt(), W(!0), j()) {
        ...
        y.props.animation && (Ko([Se, Ve], K), ja([Se, Ve], "hidden"));
      }
  ...
  function Yu() {
    process.env.NODE_ENV !== "production" && Tt(y.state.isDestroyed, Rn("unmount")), y.state.isVisible && y.hide(), y.state.isMounted && (Xr(), Dt().forEach(function(k) {
      k._tippy.unmount();
    }), b.parentNode && b.parentNode.removeChild(b), Uo = Uo.filter(function(k) {
      return k !== y;
...
function Mn(n, e) {
  ...
  process.env.NODE_ENV !== "production" && (P0(n), wu(e, t)), N0();
...
const U0 = jr({
  ...
  setup(n) {
    ...
    return ef(() => {
      const r = n.editor;
      r && r.options.element && e.value && tf(() => {
...
const G0 = /^\s*>\s$/, Su = le.create({
...
}), Y0 = /(?:^|\s)((?:\*\*)((?:[^*]+))(?:\*\*))$/, X0 = /(?:^|\s)((?:\*\*)((?:[^*]+))(?:\*\*))/g, Q0 = /(?:^|\s)((?:__)((?:[^__]+))(?:__))$/, Z0 = /(?:^|\s)((?:__)((?:[^__]+))(?:__))/g, ey = Le.create({
  name: "bold",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addCommands() {
    return {
      toggleBulletList: () => ({ commands: n, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(ty.name, this.editor.getAttributes(Ya.name)).run() : n.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
...
function my() {
  return new oe({
    props: {
      ...
      handleClick: yy,
      handleKeyDown: gy,
      handleDOMEvents: { beforeinput: vy }
    }
  });
}
const gy = tl({
...
`;
  ...
  addInputRules() {
    return this.options.levels.map((n) => ks({
...
var ji = 200, pe = function() {
};
pe.prototype.append = function(e) {
  return e.length ? (e = pe.from(e), !this.length && e || e.length < ji && this.leafAppend(e) || this.length < ji && e.leafPrepend(this) || this.appendInner(e)) : this;
};
...
class et {
  ...
  addTransform(e, t, r, i) {
    ...
    let c = s - r.depth;
    return c > Ty && (l = My(l, c), s -= c), new et(l.append(o), s);
  }
  remapping(e, t) {
    let r = new Wn();
  ...
  rebased(e, t) {
    ...
    return u.emptyItemCount() > Sy && (u = u.compress(this.items.length - r.length)), u;
  }
  emptyItemCount() {
    let e = 0;
...
function Ay(n, e, t, r) {
  ...
  t.getMeta(Ey) && (n = new Pt(n.done, n.undone, null, 0, -1));
  let s = t.getMeta("appendedTransaction");
  if (t.steps.length == 0)
    return n;
  if (s && s.getMeta(Ut))
    return s.getMeta(Ut).redo ? new Pt(n.done.addTransform(t, void 0, r, wi(e)), n.undone, Qa(t.mapping.maps[t.steps.length - 1]), n.prevTime, n.prevComposition) : new Pt(n.done, n.undone.addTransform(t, void 0, r, wi(e)), null, n.prevTime, n.prevComposition);
  if (t.getMeta("addToHistory") !== !1 && !(s && s.getMeta("addToHistory") === !1)) {
    let l = t.getMeta("composition"), a = n.prevTime == 0 || !s && n.prevComposition != l && (n.prevTime < (t.time || 0) - r.newGroupDelay || !Oy(t, n.prevRanges)), c = s ? Jo(n.prevRanges, t.mapping) : Qa(t.mapping.maps[t.steps.length - 1]);
    return new Pt(n.done.addTransform(t, a ? e.selection.getBookmark() : void 0, r, wi(e)), et.empty, c, t.time, l ?? n.prevComposition);
  } else
    return (o = t.getMeta("rebased")) ? new Pt(n.done.rebased(t, o), n.undone.rebased(t, o), Jo(n.prevRanges, t.mapping), n.prevTime, n.prevComposition) : new Pt(n.done.addMaps(t.mapping.maps), n.undone.addMaps(t.mapping.maps), Jo(n.prevRanges, t.mapping), n.prevTime, n.prevComposition);
}
function Oy(n, e) {
  if (!e)
    return !1;
...
function Tu(n, e, t, r) {
  ...
  if (!s)
    return;
  let l = s.selection.resolve(s.transform.doc), a = (r ? n.done : n.undone).addTransform(s.transform, e.selection.getBookmark(), o, i), c = new Pt(r ? a : s.remaining, r ? s.remaining : a, null, 0, -1);
...
const Ut = new ce("history"), Ey = new ce("closeHistory");
function Ny(n = {}) {
  return n = {
    depth: n.depth || 100,
    ...
    state: {
      init() {
        return new Pt(et.empty, et.empty, null, 0, -1);
      },
      apply(e, t, r) {
        return Ay(t, r, e, n);
      }
...
const Au = (n, e) => {
...
}), Ly = /(?:^|\s)((?:\*)((?:[^*]+))(?:\*))$/, Iy = /(?:^|\s)((?:\*)((?:[^*]+))(?:\*))/g, Py = /(?:^|\s)((?:_)((?:[^_]+))(?:_))$/, By = /(?:^|\s)((?:_)((?:[^_]+))(?:_))/g, zy = Le.create({
  name: "italic",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addCommands() {
    return {
      toggleOrderedList: () => ({ commands: n, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(Vy.name, this.editor.getAttributes(ec.name)).run() : n.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
  ...
  addExtensions() {
    ...
    const w = [];
    return this.options.blockquote !== !1 && w.push(Su.configure((n = this.options) === null || n === void 0 ? void 0 : n.blockquote)), this.options.bold !== !1 && w.push(ey.configure((e = this.options) === null || e === void 0 ? void 0 : e.bold)), this.options.bulletList !== !1 && w.push(ny.configure((t = this.options) === null || t === void 0 ? void 0 : t.bulletList)), this.options.code !== !1 && w.push(oy.configure((r = this.options) === null || r === void 0 ? void 0 : r.code)), this.options.codeBlock !== !1 && w.push(ay.configure((i = this.options) === null || i === void 0 ? void 0 : i.codeBlock)), this.options.document !== !1 && w.push(cy.configure((o = this.options) === null || o === void 0 ? void 0 : o.document)), this.options.dropcursor !== !1 && w.push(fy.configure((s = this.options) === null || s === void 0 ? void 0 : s.dropcursor)), this.options.gapcursor !== !1 && w.push(wy.configure((l = this.options) === null || l === void 0 ? void 0 : l.gapcursor)), this.options.hardBreak !== !1 && w.push(ky.configure((a = this.options) === null || a === void 0 ? void 0 : a.hardBreak)), this.options.heading !== !1 && w.push(xy.configure((c = this.options) === null || c === void 0 ? void 0 : c.heading)), this.options.history !== !1 && w.push(Dy.configure((d = this.options) === null || d === void 0 ? void 0 : d.history)), this.options.horizontalRule !== !1 && w.push(Ry.configure((u = this.options) === null || u === void 0 ? void 0 : u.horizontalRule)), this.options.italic !== !1 && w.push(zy.configure((f = this.options) === null || f === void 0 ? void 0 : f.italic)), this.options.listItem !== !1 && w.push(Hy.configure((h = this.options) === null || h === void 0 ? void 0 : h.listItem)), this.options.orderedList !== !1 && w.push(Fy.configure((p = this.options) === null || p === void 0 ? void 0 : p.orderedList)), this.options.paragraph !== !1 && w.push($y.configure((m = this.options) === null || m === void 0 ? void 0 : m.paragraph)), this.options.strike !== !1 && w.push(_y.configure((g = this.options) === null || g === void 0 ? void 0 : g.strike)), this.options.text !== !1 && w.push(Ky.configure((v = this.options) === null || v === void 0 ? void 0 : v.text)), w;
  }
}), Uy = "ö", Jy = "ελ1υ2бг1ел3дети4ею2католик6ом3мкд2он1сква6онлайн5рг3рус2ф2сайт3рб3укр3қаз3հայ3ישראל5קום3ابوظبي5تصالات6رامكو5لاردن4بحرين5جزائر5سعودية6عليان5مغرب5مارات5یران5بارت2زار4يتك3ھارت5تونس4سودان3رية5شبكة4عراق2ب2مان4فلسطين6قطر3كاثوليك6وم3مصر2ليسيا5وريتانيا7قع4همراه5پاکستان7ڀارت4कॉम3नेट3भारत0म्3ोत5संगठन5বাংলা5ভারত2ৰত4ਭਾਰਤ4ભારત4ଭାରତ4இந்தியா6லங்கை6சிங்கப்பூர்11భారత్5ಭಾರತ4ഭാരതം5ලංකා4คอม3ไทย3ລາວ3გე2みんな3アマゾン4クラウド4グーグル4コム2ストア3セール3ファッション6ポイント4世界2中信1国1國1文网3亚马逊3企业2佛山2信息2健康2八卦2公司1益2台湾1灣2商城1店1标2嘉里0大酒店5在线2大拿2天主教3娱乐2家電2广东2微博2慈善2我爱你3手机2招聘2政务1府2新加坡2闻2时尚2書籍2机构2淡马锡3游戏2澳門2点看2移动2组织机构4网址1店1站1络2联通2谷歌2购物2通販2集团2電訊盈科4飞利浦3食品2餐厅2香格里拉3港2닷넷1컴2삼성2한국2", rr = (n, e) => {
  for (const t in e)
    n[t] = e[t];
  return n;
}, As = "numeric", Os = "ascii", Es = "alpha", ki = "asciinumeric", di = "alphanumeric", Ns = "domain", Eu = "emoji", Gy = "scheme", Yy = "slashscheme", nc = "whitespace";
function Xy(n, e) {
  return n in e || (e[n] = []), e[n];
}
function un(n, e, t) {
  e[As] && (e[ki] = !0, e[di] = !0), e[Os] && (e[ki] = !0, e[Es] = !0), e[ki] && (e[di] = !0), e[Es] && (e[di] = !0), e[di] && (e[Ns] = !0), e[Eu] && (e[Ns] = !0);
  for (const r in e) {
    const i = Xy(r, t);
...
Ee.prototype = {
  ...
  tr(n, e, t, r) {
    r = r || Ee.groups;
    let i;
    return e && e.j ? i = e : (i = new Ee(e), t && r && un(e, t, r)), this.jr.push([n, i]), i;
  },
  /**
  ...
  tt(n, e, t, r) {
    ...
    const o = e;
    let s, l = i.go(n);
    if (l ? (s = new Ee(), rr(s.j, l.j), s.jr.push.apply(s.jr, l.jr), s.jd = l.jd, s.t = l.t) : s = new Ee(), o) {
      if (r)
        if (s.t && typeof s.t == "string") {
          const a = rr(Qy(s.t, r), t);
          un(o, a, r);
        } else
          t && un(o, t, r);
      s.t = o;
...
const D = (n, e, t, r, i) => n.ta(e, t, r, i), $e = (n, e, t, r, i) => n.tr(e, t, r, i), rc = (n, e, t, r, i) => n.ts(e, t, r, i), M = (n, e, t, r, i) => n.tt(e, t, r, i), St = "WORD", Ds = "UWORD", Vr = "LOCALHOST", Rs = "TLD", Ls = "UTLD", xi = "SCHEME", zn = "SLASH_SCHEME", gl = "NUM", Nu = "WS", yl = "NL", Fn = "OPENBRACE", Mr = "OPENBRACKET", Tr = "OPENANGLEBRACKET", Ar = "OPENPAREN", ln = "CLOSEBRACE", $n = "CLOSEBRACKET", jn = "CLOSEANGLEBRACKET", an = "CLOSEPAREN", Wi = "AMPERSAND", _i = "APOSTROPHE", Ki = "ASTERISK", Bt = "AT", qi = "BACKSLASH", Ui = "BACKTICK", Ji = "CARET", Ht = "COLON", vl = "COMMA", Gi = "DOLLAR", st = "DOT", Yi = "EQUALS", bl = "EXCLAMATION", lt = "HYPHEN", Xi = "PERCENT", Qi = "PIPE", Zi = "PLUS", eo = "POUND", to = "QUERY", wl = "QUOTE", kl = "SEMI", at = "SLASH", Or = "TILDE", no = "UNDERSCORE", Du = "EMOJI", ro = "SYM";
...
const Ln = /[a-z]/, Yo = /\p{L}/u, Xo = /\p{Emoji}/u, Qo = /\d/, ic = /\s/, oc = `
`, Zy = "️", ev = "‍";
let ui = null, fi = null;
function tv(n) {
  n === void 0 && (n = []);
  ...
  Ee.groups = e;
  const t = new Ee();
  ui == null && (ui = sc(Uy)), fi == null && (fi = sc(Jy)), M(t, "'", _i), M(t, "{", Fn), M(t, "[", Mr), M(t, "<", Tr), M(t, "(", Ar), M(t, "}", ln), M(t, "]", $n), M(t, ">", jn), M(t, ")", an), M(t, "&", Wi), M(t, "*", Ki), M(t, "@", Bt), M(t, "`", Ui), M(t, "^", Ji), M(t, ":", Ht), M(t, ",", vl), M(t, "$", Gi), M(t, ".", st), M(t, "=", Yi), M(t, "!", bl), M(t, "-", lt), M(t, "%", Xi), M(t, "|", Qi), M(t, "+", Zi), M(t, "#", eo), M(t, "?", to), M(t, '"', wl), M(t, "/", at), M(t, ";", kl), M(t, "~", Or), M(t, "_", no), M(t, "\\", qi);
  const r = $e(t, Qo, gl, {
    [As]: !0
  });
  $e(r, Qo, r);
  ...
  for (let u = 0; u < n.length; u++) {
    ...
    f.indexOf("-") >= 0 ? p[Ns] = !0 : Ln.test(f) ? Qo.test(f) ? p[ki] = !0 : p[Os] = !0 : p[As] = !0, rc(t, f, f, p);
  }
...
function nv(n, e) {
  const t = rv(e.replace(/[A-Z]/g, (l) => l.toLowerCase())), r = t.length, i = [];
  let o = 0, s = 0;
  for (; s < r; ) {
...
function ov(n) {
  ...
  const t = e.domain.concat([Wi, Ki, Bt, qi, Ui, Ji, Gi, Yi, lt, gl, Xi, Qi, Zi, eo, at, ro, Or, no]), r = [_i, jn, ln, $n, an, Ht, vl, st, bl, Tr, Fn, Mr, Ar, to, wl, kl], i = [Wi, _i, Ki, qi, Ui, Ji, ln, Gi, Yi, lt, Fn, Xi, Qi, Zi, eo, to, at, ro, Or, no], o = ue(), s = M(o, Or);
  D(s, i, s), D(s, e.domain, s);
  const l = ue(), a = ue(), c = ue();
  D(o, e.domain, l), D(o, e.scheme, a), D(o, e.slashscheme, c), D(l, i, s), D(l, e.domain, l);
  const d = M(l, Bt);
  M(s, Bt, d), M(a, Bt, d), M(c, Bt, d);
  const u = M(s, st);
  ...
  const C = ue(nn);
  D(w, e.tld, C), D(w, e.utld, C), D(C, e.domain, l), D(C, i, s), M(C, st, w), M(C, lt, v), M(C, Bt, d);
  const y = M(C, Ht), T = ue(nn);
  D(y, e.numeric, T);
  const b = ue(nn), O = ue();
  D(b, t, b), D(b, r, O), D(O, t, b), D(O, r, O), M(C, at, b), M(T, at, b);
  const S = M(a, Ht), B = M(c, Ht), H = M(B, at), q = M(H, at);
  ...
  return D(j, r), D(_, r), D(X, r), D(ee, r), D(Y, t, Y), D(W, t, W), D(U, t, U), D(Q, t, Q), D(Y, r, Y), D(W, r, W), D(U, r, U), D(Q, r, Q), D(de, t, de), D(ve, t, W), D(Ce, t, U), D(He, t, Q), D(de, r, de), D(ve, r, ve), D(Ce, r, Ce), D(He, r, He), M(W, $n, b), M(U, jn, b), M(Q, an, b), M(Y, ln, b), M(ve, $n, b), M(Ce, jn, b), M(He, an, b), M(de, an, b), M(o, Vr, C), M(o, yl, iv), {
    start: o,
    tokens: Ru
  };
}
function sv(n, e, t) {
  ...
  for (; i < r; ) {
    ...
    if (f < 0)
      ...
      s.length > 0 && (o.push(Zo(cc, e, s)), s = []), i -= f, d -= f;
      const h = u.t, p = t.slice(i - d, i);
      o.push(Zo(h, e, p));
    }
  }
  return s.length > 0 && o.push(Zo(cc, e, s)), o;
}
function Zo(n, e, t) {
...
}), av = "until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.", ne = {
  scanner: null,
  parser: null,
  tokenQueue: [],
  pluginQueue: [],
...
function dc(n, e) {
  if (e === void 0 && (e = !1), ne.initialized && lv(`linkifyjs: already initialized - will not register custom scheme "${n}" ${av}`), !/^[0-9a-z]+(-[0-9a-z]+)*$/.test(n))
...
function dv() {
  ne.scanner = tv(ne.customSchemes);
  for (let n = 0; n < ne.tokenQueue.length; n++)
    ne.tokenQueue[n][1]({
      scanner: ne.scanner
    });
  ne.parser = ov(ne.scanner.tokens);
...
function Iu(n) {
  return ne.initialized || dv(), sv(ne.parser.start, n, nv(ne.scanner.start, n));
}
function Cl(n, e, t) {
...
function uv(n) {
  return new oe({
    ...
    appendTransaction: (e, t, r) => {
      ...
      if (!i || o)
        return;
      const { tr: s } = r, l = wg(t.doc, [...e]), { mapping: a } = l;
      if (Og(l).forEach(({ oldRange: d, newRange: u }) => {
        Vi(d.from, d.to, t.doc).filter((m) => m.mark.type === n.type).forEach((m) => {
          const g = a.map(m.from), v = a.map(m.to), w = Vi(g, v, r.doc).filter((S) => S.mark.type === n.type);
          if (!w.length)
            return;
        ...
        const f = xg(r.doc, u, (m) => m.isTextblock);
        let h, p;
...
const pv = Le.create({
  ...
  addProseMirrorPlugins() {
    const n = [];
    return this.options.autolink && n.push(uv({
      type: this.type,
      validate: this.options.validate
    })), this.options.openOnClick && n.push(fv({
      type: this.type
...
if (typeof WeakMap < "u") {
  ...
  Is = (e) => n.get(e), Ps = (e, t) => (n.set(e, t), t);
} else {
  const n = [];
  let t = 0;
  Is = (r) => {
...
function vv(n, e, t) {
  ...
  for (let i = 0; i < n.map.length; i++) {
    ...
    for (let c = 0; c < a.colspan; c++) {
      ...
      u != null && (!a.colwidth || a.colwidth[c] != u) && ((l || (l = bv(a)))[c] = u);
    }
...
function Av(n, e, t) {
  ...
  if (r instanceof L && (s = r.node.type.spec.tableRole)) {
    ...
    r instanceof P && Mv(r) ? o = P.create(i, r.from) : r instanceof P && Tv(r) && (o = P.create(i, r.$from.start(), r.$from.end()));
  return o && (e || (e = n.tr)).setSelection(o), e;
}
var Ov = new ce("fix-tables");
function Hu(n, e, t, r) {
...
function Ev(n, e, t, r) {
  ...
  return r.setMeta(Ov, { fixTables: !0 });
}
function Nv(n) {
  if (!n.size)
    return null;
...
function Rv({ width: n, height: e, rows: t }, r, i) {
  if (n != r) {
    const o = [], s = [];
...
function pc(n, e, t, r, i) {
  ...
  Lv(u, s, o, t, c, d, f) && h(), fc(u, s, o, t, a, c, l, f) && h(), fc(u, s, o, t, a, c, d, f) && h(), hc(u, s, o, t, l, d, a, f) && h(), hc(u, s, o, t, l, d, c, f) && h();
  for (let p = l; p < d; p++) {
...
function hi(n, e) {
  return (t, r, i) => {
    ...
    {
      const l = t.doc.resolve(s), a = Pu(l, n, e);
      let c;
...
function Bv(n, e, t) {
  ...
  if (i instanceof F) {
    ...
    return r = Rv(r, l.right - l.left, l.bottom - l.top), pc(n.state, n.dispatch, s, l, r), !0;
  } else if (r) {
    const o = wo(n.state), s = o.start(-1);
    return pc(
      n.state,
      n.dispatch,
      s,
...
function zv(n, e) {
  ...
  else if (e.shiftKey && r && (i = or(n.state.selection.$anchor)) != null && ((t = es(n, e)) == null ? void 0 : t.pos) != i.pos)
  ...
  function l(a) {
    ...
    else if (mc(n, c.target) != r && (u = es(n, e), !u))
      return s();
    u && o(u, c);
  }
...
var Hv = class {
  ...
  update(e) {
    return e.type != this.node.type ? !1 : (this.node = e, Hs(e, this.colgroup, this.table, this.cellMinWidth), !0);
  }
  ignoreMutation(e) {
...
function jv(n, e, t) {
  ...
  if (!r || r.activeHandle == -1 || r.dragging)
    return !1;
  const i = n.state.doc.nodeAt(r.activeHandle), o = Wv(n, r.activeHandle, i.attrs);
  n.dispatch(
...
function Kv(n, e, t) {
  ...
  for (let c = 0; c < o.height; c++) {
    ...
    if (f.colwidth && f.colwidth[h] == t)
      continue;
    const p = f.colwidth ? f.colwidth.slice() : Uv(f.colspan);
...
function yt(n) {
  const e = n.selection, t = wo(n), r = t.node(-1), i = t.start(-1), o = ie.get(r);
...
function ju(n, { map: e, tableStart: t, table: r }, i) {
  let o = i > 0 ? -1 : 0;
  Cv(e, r, i + o) && (o = i == 0 || i == e.width ? null : 0);
...
function Xv(n, { map: e, table: t, tableStart: r }, i) {
...
function Qv(n, e) {
  ...
  if (e) {
    ...
    if (t.left == 0 && t.right == t.map.width)
      return !1;
    for (let i = t.right - 1; Xv(r, t, i), i != t.left; i--) {
...
function Wu(n, { map: e, tableStart: t, table: r }, i) {
  ...
  const l = [];
  let a = i > 0 ? -1 : 0;
  Zv(e, r, i + a) && (a = i == 0 || i == e.height ? null : 0);
...
function nb(n, { map: e, table: t, tableStart: r }, i) {
  let o = 0;
  for (let a = 0; a < i; a++)
...
function rb(n, e) {
  ...
  if (e) {
    ...
    if (t.top == 0 && t.bottom == t.map.height)
      return !1;
    for (let i = t.bottom - 1; nb(r, t, i), i != t.top; i--) {
      const o = t.tableStart ? r.doc.nodeAt(t.tableStart - 1) : r.doc;
      if (!o)
        throw RangeError("No table found");
...
function ib({ width: n, height: e, map: t }, r) {
...
function wc(n, e) {
  const t = xe(n.schema);
  return ob(({ node: r }) => t[r.type.spec.tableRole])(n, e);
}
function ob(n) {
  return (e, t) => {
    var r;
...
function xc(n) {
  return function(e, t) {
    ...
    if (t) {
      ...
      t(
        e.tr.setSelection(P.between(i, xv(i))).scrollIntoView()
      );
    }
    return !0;
  };
...
const gi = ({ editor: n }) => {
  ...
  addCommands() {
    return {
      ...
      addColumnBefore: () => ({ state: n, dispatch: e }) => Gv(n, e),
      addColumnAfter: () => ({ state: n, dispatch: e }) => Yv(n, e),
      deleteColumn: () => ({ state: n, dispatch: e }) => Qv(n, e),
      addRowBefore: () => ({ state: n, dispatch: e }) => eb(n, e),
      addRowAfter: () => ({ state: n, dispatch: e }) => tb(n, e),
      deleteRow: () => ({ state: n, dispatch: e }) => rb(n, e),
      deleteTable: () => ({ state: n, dispatch: e }) => db(n, e),
      ...
      toggleHeaderCell: () => ({ state: n, dispatch: e }) => ab(n, e),
      mergeOrSplit: () => ({ state: n, dispatch: e }) => bc(n, e) ? !0 : wc(n, e),
      setCellAttribute: (n, e) => ({ state: t, dispatch: r }) => sb(n, e)(t, r),
...
const Eb = function({
  ...
  const a = i.node(0), c = i.start(0), d = _u(a, (v) => v);
...
function Ku(n, e) {
  if (ts(n) && ts(e))
    for (const t in e)
      ts(e[t]) ? (n[t] || Object.assign(n, { [t]: {} }), Ku(n[t], e[t])) : Db(e[t]) ? (n[t] || (n[t] = []), Mi(n[t], e[t])) : Object.assign(n, { [t]: e[t] });
  return n;
}
...
}), Lb = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/, Ib = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/g, Pb = (n) => n.match(Lb), Mc = (n) => n ? "https://www.youtube-nocookie.com/embed/" : "https://www.youtube.com/embed/", Bb = (n) => {
  const {
    url: e,
    allowFullscreen: t,
    autoplay: r,
...
function Fb(n) {
  var e;
  const { char: t, allowSpaces: r, allowedPrefixes: i, startOfLine: o, $position: s } = n, l = a1(t), a = new RegExp(`\\s${l}$`), c = o ? "^" : "", d = r ? new RegExp(`${c}${l}.*?(?=\\s${l}|$)`, "gm") : new RegExp(`${c}(?:^)?${l}[^\\s${l}]*`, "gm"), u = ((e = s.nodeBefore) === null || e === void 0 ? void 0 : e.isText) && s.nodeBefore.text;
  if (!u)
    return null;
...
const $b = new ce("suggestion");
function jb({ pluginKey: n = $b, editor: e, char: t = "@", allowSpaces: r = !1, allowedPrefixes: i = [" "], startOfLine: o = !1, decorationTag: s = "span", decorationClass: l = "suggestion", command: a = () => null, items: c = () => [], render: d = () => ({}), allow: u = () => !0 }) {
  let f;
...
}, Kb = { class: "bg-white border border-slate-400 rounded overflow-hidden shadow" }, qb = ["onClick"], Ub = ["innerHTML"], Jb = {
  key: 1,
...
function Gb(n, e, t, r, i, o) {
  return V(), te("div", Kb, [
    t.items.length ? (V(!0), te(xt, { key: 0 }, Ct(o.itemsWithInsertCommand, (s, l) => (V(), te("button", {
      ...
      key: l,
      onClick: Qe((a) => o.selectItem(l), ["prevent"])
    }, [
      Ke("span", {
        innerHTML: s.icon
      }, null, 8, Ub),
      sf(" " + lf(s.title), 1)
    ], 10, qb))), 128)) : (V(), te("div", Jb, "No result"))
  ]);
}
const Yb = /* @__PURE__ */ Wr(_b, [["render", Gb]]);
function qu() {
  return [
    {
      name: "paragraph",
...
const nw = {
  ...
  data() {
    return {
      ...
      editor: null,
      allBlockTools: Mi(qu(), this.blockTools),
      allInlineTools: Mi(Qb(), this.inlineTools),
      allAlignmentTools: Mi(
        Zb(),
        this.alignmentTools
      ),
      tableRowTools: ew(),
...
}, rw = { id: "gutentap" }, iw = { class: "flex flex-row" }, ow = /* @__PURE__ */ Ke("svg", {
  width: "24",
  height: "24",
...
}, aw = /* @__PURE__ */ Ke("div", { class: "p-3 uppercase text-gray-600 text-xs pb-1 tracking-wide" }, " Transform to ", -1), cw = {
  key: 1,
  class: "pr-2 flex flex-col"
}, dw = ["disabled"], uw = /* @__PURE__ */ Ke("svg", {
  width: "24",
  height: "24",
  class: "w-5 h-5 md:w-6 md:h-6",
  viewBox: "0 0 24 24",
  ...
  uw
], hw = ["disabled"], pw = /* @__PURE__ */ Ke("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  width: "24",
  height: "24",
  fill: "currentColor",
  ...
  return V(), te("div", rw, [
    i.editor && i.tableRowTools ? (V(), Xe(c, {
      ...
      default: Me(() => [
        Fe(a, null, {
          dropdown: Me(() => [
            (V(!0), te(xt, null, Ct(i.tableRowTools, (u) => (V(), Xe(l, {
              innerHTML: u.icon + " " + u.title,
              key: u.title,
              label: u.title,
              onClick: Qe((f) => u.command(i.editor), ["prevent"])
    ...
    i.editor && i.tableColumnTools ? (V(), Xe(c, {
      ...
      default: Me(() => [
        Fe(a, null, {
          dropdown: Me(() => [
            (V(!0), te(xt, null, Ct(i.tableColumnTools, (u) => (V(), Xe(l, {
        ...
        return [
          Ke("div", iw, [
                ...
                (u = i.currentBlockTool) != null && u.canBeConverted ? {
                  ...
                  fn: Me(() => [
                    ...
                    (V(!0), te(xt, null, Ct(i.allBlockTools.filter(
                      ...
                      key: g.title,
                      label: g.title,
                      onClick: Qe((v) => g.convertCommand(i.editor), ["prevent"]),
                      activeClass: "hidden",
            ...
            i.dragging ? it("", !0) : (V(), te("div", cw, [
              Ke("button", {
                onClick: e[2] || (e[2] = Qe((g) => o.moveNode("UP"), ["prevent"])),
                disabled: !o.canMoveNodeUp(),
                "data-tooltip": "Move up",
                class: "mt-1 md:mt-2"
              }, fw, 8, dw),
              Ke("button", {
                onClick: e[3] || (e[3] = Qe((g) => o.moveNode("DOWN"), ["prevent"])),
          ...
          i.dragging ? it("", !0) : (V(), te("div", gw, [
            (V(!0), te(xt, null, Ct(o.activeAlignmentTools, (g, v) => (V(), Xe(a, { key: v }, {
              dropdown: Me(() => [
                (V(!0), te(xt, null, Ct(g, (w) => (V(), Xe(l, {
                  key: w.title,
                  content: w.icon + " " + w.title,
                  label: w.title,
                  onClick: Qe((C) => w.command(i.editor), ["prevent"]),
          ...
          !i.dragging && ((h = (f = i.currentBlockTool) == null ? void 0 : f.tools) != null && h.length) ? (V(), te("div", yw, [
            (V(!0), te(xt, null, Ct((p = i.currentBlockTool) == null ? void 0 : p.tools, (g) => {
              ...
              return V(), Xe(s, {
                ...
                onClick: Qe((C) => g.command.call(0, i.editor), ["prevent"]),
          ...
          (m = i.currentBlockTool) != null && m.hasInlineTools && !i.dragging ? (V(), te("div", vw, [
            (V(!0), te(xt, null, Ct(i.allInlineTools, (g) => (V(), Xe(a, {
              align: "right",
              key: g.title
            }, {
              dropdown: Me(() => [
                (V(!0), te(xt, null, Ct(g.tools, (v) => (V(), Xe(l, {
                  key: v.name,
                  content: v.icon + " " + v.title,
                  onClick: Qe((w) => v.command(i.editor), ["prevent"]),
              ...
              default: Me(() => [
                Fe(s, {
                  ...
                  label: g.title,
                  activeClass: g.isActiveClass,
                  onClick: Qe((v) => g.command(i.editor), ["prevent"]),
                  active: g.isActiveTest(i.editor)
            ...
            Fe(a, { align: "right" }, {
              dropdown: Me(() => [
                Fe(l, {
                  ...
                  label: "Delete block",
                  onClick: e[4] || (e[4] = Qe((g) => o.deleteNode(i.topLevelNodeType), ["prevent"]))
                }, null, 8, ["content"])
              ]),
              default: Me(() => [
                Fe(s, {
    ...
    Fe(d, {
      ...
      onKeyup: e[7] || (e[7] = cf((u) => i.isTyping = !1, ["esc"])),
      ref: "editor",
      editor: i.editor
    }, null, 8, ["class", "editor"])
  ]);
