import { openBlock as Z, createElementBlock as ae, normalizeClass as En, renderSlot as Tc, createCommentVNode as kt, defineComponent as qr, ref as go, onMounted as bf, onBeforeUnmount as Ia, h as tn, getCurrentInstance as Fm, watchEffect as Vm, nextTick as zm, unref as Gm, Teleport as Um, provide as Sc, reactive as wf, markRaw as Tf, customRef as $m, resolveComponent as pn, createBlock as pt, withCtx as Le, createElementVNode as lt, createVNode as Ye, Fragment as Kt, renderList as Xt, createTextVNode as Wm, toDisplayString as qm, createSlots as jm, withKeys as Ym } from "vue";
const jr = (t, e) => {
...
}, Xm = ["aria-label", "data-tooltip", "title", "innerHTML"];
function Jm(t, e, n, r, i, s) {
  return Z(), ae("button", {
...
const Qm = /* @__PURE__ */ jr(Km, [["render", Jm]]), Zm = {
  computed: {
    hasDropdown() {
...
}, eg = { class: "group text-sm relative" };
function tg(t, e, n, r, i, s) {
  return Z(), ae("div", eg, [
    Tc(t.$slots, "default"),
    s.hasDropdown ? (Z(), ae("div", {
      key: 0,
      class: En(["z-10 bg-white shadow py-2 group-focus-within:block hidden overflow-hidden whitespace-nowrap absolute bottom-full sm:bottom-auto sm:top-full mt-4 rounded border border-slate-400", n.align == "left" ? "left-0" : "right-0"])
    }, [
      Tc(t.$slots, "dropdown")
    ], 2)) : kt("", !0)
  ]);
}
const ng = /* @__PURE__ */ jr(Zm, [["render", tg]]), rg = {
  props: {
    content: {
      type: String,
      required: !1
...
const og = /* @__PURE__ */ jr(rg, [["render", sg]]);
function De(t) {
  this.content = t;
}
De.prototype = {
  ...
  update: function(t, e, n) {
    ...
    return i == -1 ? s.push(n || t, e) : (s[i + 1] = e, n && (s[i] = n)), new De(s);
  },
  // :: (string) → OrderedMap
  ...
  addBefore: function(t, e, n) {
    ...
    return i.splice(s == -1 ? i.length : s, 0, e, n), new De(i);
  },
...
function Sf(t, e, n) {
  for (let r = 0; ; r++) {
    ...
    if (i.content.size || s.content.size) {
      let o = Sf(i.content, s.content, n + 1);
      if (o != null)
        return o;
    }
    n += i.nodeSize;
...
function If(t, e, n, r) {
  for (let i = t.childCount, s = e.childCount; ; ) {
    ...
    if (o.content.size || l.content.size) {
      let c = If(o.content, l.content, n - 1, r - 1);
      if (c)
        return c;
    }
    n -= a, r -= a;
...
class H {
  ...
  */
  insertAt(e, n) {
    let r = Mf(this.content, e + this.openStart, n);
  ...
  */
  removeBetween(e, n) {
    return new H(Cf(this.content, e + this.openStart, n + this.openStart), this.openStart, this.openEnd);
  }
  /**
...
function Of(t, e, n, r) {
  ...
  if (i == e.index(r) && r < t.depth - n.openStart) {
    ...
    if (!n.openStart && !n.openEnd && t.depth == r && e.depth == r) {
      ...
      let { start: o, end: l } = ag(n, t);
      return Yn(s, Rf(t, o, l, e, r));
    }
  else
...
function Rf(t, e, n, r, i) {
  ...
  return ui(null, t, i, l), s && o && e.index(i) == n.index(i) ? (Af(s, o), jn(Yn(s, Rf(t, e, n, r, i + 1)), l)) : (s && jn(Yn(s, Ns(t, e, i + 1)), l), ui(e, n, i, l), o && jn(Yn(o, Ns(n, r, i + 1)), l)), ui(r, null, i, l), new x(l);
}
function Ns(t, e, n) {
  let r = [];
...
let Kn = class Dl {
  ...
  */
  hasMarkup(e, n, r) {
    return this.type == e && ks(this.attrs, n || e.defaultAttrs || dg) && ie.sameSet(this.marks, r || ie.none);
  }
  /**
  ...
  */
  replace(e, n, r) {
    return lg(this.resolve(e), this.resolve(n), r);
  }
  /**
...
let Mc = class Pf {
  ...
  */
  constructor(e, n, r) {
    this.name = e, this.schema = n, this.spec = r, this.markSet = null, this.groups = r.group ? r.group.split(" ") : [], this.attrs = Lf(r.attrs), this.defaultAttrs = Df(this.attrs), this.contentMatch = null, this.inlineContent = null, this.isBlock = !(r.inline || e == "text"), this.isText = e == "text";
  }
  /**
  ...
  */
  static compile(e, n) {
    ...
    e.forEach((s, o) => r[s] = new Pf(s, n, o));
...
class yo {
  ...
  */
  constructor(e, n, r, i) {
    this.name = e, this.rank = n, this.schema = r, this.spec = i, this.attrs = Lf(i.attrs), this.excluded = null;
    let s = Df(this.attrs);
  ...
  */
  create(e = null) {
    return !e && this.instance ? this.instance : new ie(this, Nf(this.attrs, e));
  }
  /**
  @internal
  */
...
class wg {
  ...
  */
  constructor(e) {
    ...
    for (let i in e)
      n[i] = e[i];
    n.nodes = De.from(e.nodes), n.marks = De.from(e.marks || {}), this.nodes = Mc.compile(this.spec.nodes, this), this.marks = yo.compile(this.spec.marks, this);
    let r = /* @__PURE__ */ Object.create(null);
  ...
  */
  matchTag(e, n, r) {
    for (let i = r ? this.tags.indexOf(r) + 1 : 0; i < this.tags.length; i++) {
      let s = this.tags[i];
      if (Ig(e, s.tag) && (s.namespace === void 0 || e.namespaceURI == s.namespace) && (!s.context || n.matchesContext(s.context))) {
        if (s.getAttrs) {
          let o = s.getAttrs(e);
          if (o === !1)
            continue;
...
class es {
  ...
  applyPending(e) {
    for (let n = 0, r = this.pendingMarks; n < r.length; n++) {
      let i = r[n];
      (this.type ? this.type.allowsMarkType(i.type) : Mg(i.type, e)) && !i.isInSet(this.activeMarks) && (this.activeMarks = i.addToSet(this.activeMarks), this.pendingMarks = i.removeFromSet(this.pendingMarks));
    }
  }
  inlineContext(e) {
    return this.type ? this.type.inlineContent : this.content.length ? this.content[0].isInline : e.parentNode && !Bf.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
  }
}
class Rc {
  constructor(e, n, r) {
...
`));
  ...
  addPendingMark(e) {
    let n = Og(e, this.top.pendingMarks);
...
function Sg(t) {
  for (let e = t.firstChild, n = null; e; e = e.nextSibling) {
    ...
    r && Hf.hasOwnProperty(r) && n ? (n.appendChild(e), e = n) : r == "li" ? n = e : r && (n = null);
  }
}
function Ig(t, e) {
...
class Vt {
  ...
  */
  serializeNodeInner(e, n) {
    let { dom: r, contentDOM: i } = Vt.renderSpec(qo(n), this.nodes[e.type.name](e));
    if (i) {
      if (e.isLeaf)
  ...
  */
  serializeMark(e, n, r = {}) {
    ...
    return i && Vt.renderSpec(qo(r), i(e, n));
  }
  /**
  ...
  static renderSpec(e, n, r = null) {
    ...
    for (let d = c; d < n.length; d++) {
      ...
      if (u === 0) {
        ...
        let { dom: f, contentDOM: h } = Vt.renderSpec(e, u, r);
...
const Ff = 65535, Vf = Math.pow(2, 16);
function Ag(t, e) {
  return t + e * Vf;
}
function kc(t) {
...
class Nl {
  ...
  */
  get deleted() {
    return (this.delInfo & Uf) > 0;
  }
  /**
  Tells you whether the token before the mapped position was deleted.
  */
  get deletedBefore() {
    return (this.delInfo & (zf | Ts)) > 0;
  }
  /**
  ...
  _map(e, n, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= u) {
        ...
        if (r)
          return h;
        let p = e == (n < 0 ? a : u) ? null : Ag(l / 3, e - a), m = e == a ? Gf : e == u ? zf : Ts;
        return (n < 0 ? e != a : e != u) && (m |= Uf), new Nl(h, m, p);
      }
      i += d - c;
    }
...
class Ar {
  ...
  */
  slice(e = 0, n = this.maps.length) {
    return new Ar(this.maps, this.mirror, e, n);
  }
  /**
  @internal
  */
  copy() {
    return new Ar(this.maps.slice(), this.mirror && this.mirror.slice(), this.from, this.to);
  }
  /**
  ...
  t.doc.nodesBetween(e, n, (a, c, d) => {
    ...
    if (!r.isInSet(u) && d.type.allowsMarkType(r.type)) {
      ...
      for (let m = 0; m < u.length; m++)
        u[m].isInSet(p) || (o && o.to == f && o.mark.eq(u[m]) ? o.to = h : i.push(o = new zt(f, h, u[m])));
...
function _g(t, e, n, r) {
  ...
  }), i.forEach((o) => t.step(new zt(o.from, o.to, o.style)));
}
function kg(t, e, n, r = n.contentMatch) {
  ...
  for (let l = 0; l < i.childCount; l++) {
    ...
    if (!d)
      ...
      for (let u = 0; u < a.marks.length; u++)
        n.allowsMarkType(a.marks[u].type) || t.step(new zt(o, c, a.marks[u]));
    }
    o = c;
  }
  if (!r.validEnd) {
...
function Yr(t) {
  ...
  for (let r = t.depth; ; --r) {
    ...
    if (r < t.depth && i.canReplace(s, o, n))
      return r;
    if (r == 0 || i.type.spec.isolating || !Dg(i, s, o))
      break;
  }
  return null;
}
...
function Hg(t, e, n, r, i) {
  ...
  t.doc.nodesBetween(e, n, (o, l) => {
    if (o.isTextblock && !o.hasMarkup(r, i) && Fg(t.doc, t.mapping.slice(s).map(l), r)) {
...
function Rn(t, e) {
  ...
  return $f(n.nodeBefore, n.nodeAfter) && n.parent.canReplace(r, r + 1);
}
function $f(t, e) {
...
function Wf(t, e, n = -1) {
  ...
  for (let i = r.depth; ; i--) {
    let s, o, l = r.index(i);
    if (i == r.depth ? (s = r.nodeBefore, o = r.nodeAfter) : n > 0 ? (s = r.node(i + 1), l++, o = r.node(i).maybeChild(l)) : (s = r.node(i).maybeChild(l - 1), o = r.node(i + 1)), s && !s.isTextblock && $f(s, o) && r.node(i).canReplace(l, l + 1))
      return e;
    if (i == 0)
      break;
...
function Oa(t, e, n = e, r = H.empty) {
  ...
  return jf(i, s, r) ? new Oe(e, n, r) : new $g(i, s, r).fit();
}
function jf(t, e, n) {
...
class $g {
  ...
  placeNodes({ sliceDepth: e, frontierDepth: n, parent: r, inject: i, wrap: s }) {
    ...
    for (; c < l.childCount; ) {
      ...
      if (!g)
        break;
      c++, (c > 1 || a == 0 || m.content.size) && (u = g, d.push(Yf(m.mark(f.allowedMarks(m.marks)), c == 1 ? a : 0, c == l.childCount ? h : -1)));
    }
...
function Yf(t, e, n) {
  if (e <= 0)
    return t;
  let r = t.content;
  return e > 1 && (r = r.replaceChild(0, Yf(r.firstChild, e - 1, r.childCount == 1 ? n - 1 : 0))), e > 0 && (r = t.type.contentMatch.fillBefore(r).append(r), n <= 0 && (r = r.append(t.type.contentMatch.matchFragment(r).fillBefore(x.empty, !0)))), t.copy(r);
}
function Ko(t, e, n, r, i) {
  ...
  return l && !Wg(n, s.content, o) ? l : null;
}
function Wg(t, e, n) {
    ...
    if (p)
      for (let m = 0; m < o.length; m++) {
        ...
        if (E.canReplaceWith(b, b, p.type, p.marks))
          return t.replace(i.before(g), v ? s.after(g) : n, new H(Kf(r.content, 0, r.openStart, h), h, r.openEnd));
      }
  }
...
function Kf(t, e, n, r, i) {
  if (e < n) {
    let s = t.firstChild;
    t = t.replaceChild(0, s.copy(Kf(s.content, e + 1, n, r, s)));
  }
  if (e > r) {
...
function Kg(t, e, n) {
  let r = t.doc.resolve(e), i = t.doc.resolve(n), s = Xf(r, i);
  for (let o = 0; o < s.length; o++) {
...
class Aa {
  ...
  */
  constructor(e) {
    this.doc = e, this.steps = [], this.docs = [], this.mapping = new Ar();
  }
  /**
...
class q {
  ...
  */
  constructor(e, n, r) {
    this.$anchor = e, this.$head = n, this.ranges = r || [new Jf(e.min(n), e.max(n))];
  }
  /**
  ...
  */
  static findFrom(e, n, r = !1) {
    let i = e.parent.inlineContent ? new Y(e) : gr(e.node(0), e.parent, e.pos, e.index(), n, r);
    if (i)
      return i;
    for (let s = e.depth - 1; s >= 0; s--) {
      let o = n < 0 ? gr(e.node(0), e.node(s), e.before(s + 1), e.index(s), n, r) : gr(e.node(0), e.node(s), e.after(s + 1), e.index(s) + 1, n, r);
      if (o)
        return o;
    }
    return null;
  ...
  */
  static atEnd(e) {
    return gr(e, e, e.content.size, e.childCount, -1) || new Rt(e);
  }
  /**
...
function gr(t, e, n, r, i, s = !1) {
  ...
  for (let o = r - (i > 0 ? 0 : 1); i > 0 ? o < e.childCount : o >= 0; o += i) {
    ...
    if (l.isAtom) {
      ...
      let a = gr(t, l, n + i, i < 0 ? l.childCount : 0, i, s);
      if (a)
        return a;
    }
    n += l.nodeSize * i;
...
class di {
  constructor(e, n, r) {
    this.name = e, this.init = Fc(n.init, r), this.apply = Fc(n.apply, r);
  }
}
const Qg = [
  new di("doc", {
...
class br {
  ...
  */
  applyInner(e) {
    ...
    let n = new br(this.config), r = this.config.fields;
  ...
  */
  static create(e) {
    let n = new Jo(e.doc ? e.doc.type.schema : e.schema, e.plugins), r = new br(n);
  ...
  */
  reconfigure(e) {
    let n = new Jo(this.schema, e.plugins), r = n.fields, i = new br(n);
  ...
  */
  static fromJSON(e, n, r) {
    ...
    let i = new Jo(e.schema, e.plugins), s = new br(i);
...
function Qf(t, e, n) {
  for (let r in t) {
    let i = t[r];
    i instanceof Function ? i = i.bind(e) : r == "handleDOMEvents" && (i = Qf(i, e, {})), n[r] = i;
  }
  return n;
}
class me {
  ...
  */
  constructor(e) {
    this.spec = e, this.props = {}, e.props && Qf(e.props, this, this.props), this.key = e.key ? e.key.key : Zf("plugin");
  }
  /**
...
function zc(t, e, n, r, i) {
  for (; ; ) {
    ...
    if (e == (i < 0 ? 0 : Ft(t))) {
      let s = t.parentNode;
      if (!s || s.nodeType != 1 || t0(t) || Zg.test(t.nodeName) || t.contentEditable == "false")
        return !1;
      e = st(t) + (i < 0 ? 0 : 1), t = s;
...
const $t = typeof navigator < "u" ? navigator : null, Gc = typeof document < "u" ? document : null, xn = $t && $t.userAgent || "", Pl = /Edge\/(\d+)/.exec(xn), eh = /MSIE \d/.exec(xn), Bl = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(xn), Qe = !!(eh || Bl || Pl), Tn = eh ? document.documentMode : Bl ? +Bl[1] : Pl ? +Pl[1] : 0, xt = !Qe && /gecko\/(\d+)/i.test(xn);
xt && +(/Firefox\/(\d+)/.exec(xn) || [0, 0])[1];
const Hl = !Qe && /Chrome\/(\d+)/.exec(xn), Be = !!Hl, i0 = Hl ? +Hl[1] : 0, Ue = !Qe && !!$t && /Apple Computer/.test($t.vendor), Pr = Ue && (/Mobile\/\w+/.test(xn) || !!$t && $t.maxTouchPoints > 2), mt = Pr || ($t ? /Mac/.test($t.platform) : !1), s0 = $t ? /Win/.test($t.platform) : !1, Ct = /Android \d/.test(xn), bo = !!Gc && "webkitFontSmoothing" in Gc.documentElement.style, o0 = bo ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function l0(t) {
  return {
    left: 0,
...
function Uc(t, e, n) {
  ...
  for (let o = n || t.dom; o; o = Ci(o)) {
    if (o.nodeType != 1)
      continue;
    let l = o, a = l == s.body, c = a ? l0(s) : a0(l), d = 0, u = 0;
    if (e.top < c.top + an(r, "top") ? u = -(c.top - e.top + an(i, "top")) : e.bottom > c.bottom - an(r, "bottom") && (u = e.bottom - c.bottom + an(i, "bottom")), e.left < c.left + an(r, "left") ? d = -(c.left - e.left + an(i, "left")) : e.right > c.right - an(r, "right") && (d = e.right - c.right + an(i, "right")), d || u)
      if (a)
...
function c0(t) {
  ...
  return { refDOM: r, refTop: i, stack: th(t.dom) };
}
function th(t) {
...
function d0({ refDOM: t, refTop: e, stack: n }) {
...
function rh(t, e) {
  ...
  return !n && a && (n = a, i = c, r = 0), n && n.nodeType == 3 ? f0(n, i) : !n || r && n.nodeType == 1 ? { node: t, offset: s } : rh(n, i);
}
function f0(t, e) {
...
function p0(t, e, n) {
  let { node: r, offset: i } = rh(e, n), s = -1;
...
function g0(t, e) {
  let n = t.dom.ownerDocument, r, i = 0, s = r0(n, e.left, e.top);
  s && ({ node: r, offset: i } = s);
  ...
  if (o = h0(o, e), r) {
    ...
    r == t.dom && i == r.childNodes.length - 1 && r.lastChild.nodeType == 1 && e.top > r.lastChild.getBoundingClientRect().bottom ? l = t.state.doc.content.size : (i == 0 || r.nodeType != 1 || r.childNodes[i - 1].nodeName != "BR") && (l = m0(t, r, i, e));
  }
  l == null && (l = p0(t, o, e));
...
function sh(t, e, n) {
  ...
  if (r.nodeType == 3)
    if (o && (y0.test(r.nodeValue) || (n < 0 ? !i : i == r.nodeValue.length))) {
      let a = un(Qt(r, i, i), n);
      if (xt && i && /\s/.test(r.nodeValue[i - 1]) && i < r.nodeValue.length) {
        let c = un(Qt(r, i - 1, i - 1), -1);
        if (c.top == a.top) {
          let d = un(Qt(r, i, i + 1), -1);
          if (d.top != a.top)
      ...
      return n < 0 && !i ? (c++, d = -1) : n >= 0 && i == r.nodeValue.length ? (a--, d = 1) : n < 0 ? a-- : c++, ni(un(Qt(r, a, c), d), d < 0);
    }
  ...
  if (s == null && i && (n < 0 || i == Ft(r))) {
    let a = r.childNodes[i - 1], c = a.nodeType == 3 ? Qt(a, Ft(a) - (o ? 0 : 1)) : a.nodeType == 1 && (a.nodeName != "BR" || !a.nextSibling) ? a : null;
    if (c)
      return ni(un(c, 1), !1);
  }
  if (s == null && i < Ft(r)) {
    ...
    for (; a.pmViewDesc && a.pmViewDesc.ignoreForCoords; )
      a = a.nextSibling;
    let c = a ? a.nodeType == 3 ? Qt(a, 0, o ? 0 : 1) : a.nodeType == 1 ? a : null : null;
    if (c)
      return ni(un(c, -1), !0);
  }
  return ni(un(r.nodeType == 3 ? Qt(r) : r, -n), n >= 0);
}
function ni(t, e) {
  if (t.width == 0)
    return t;
  ...
  return oh(t, e, () => {
    ...
    for (let l = s.firstChild; l; l = l.nextSibling) {
      ...
      if (l.nodeType == 1)
        ...
        a = Qt(l, 0, l.nodeValue.length).getClientRects();
      else
        continue;
...
function b0(t, e, n) {
  ...
  return !v0.test(r.parent.textContent) || !l.modify ? n == "left" || n == "backward" ? s : o : oh(t, e, () => {
...
function w0(t, e, n) {
  return Wc == e && qc == n ? jc : (Wc = e, qc = n, jc = n == "up" || n == "down" ? E0(t, e, n) : b0(t, e, n));
}
const vt = 0, Yc = 1, zn = 2, Wt = 3;
class Hi {
  constructor(e, n, r, i) {
  ...
  domFromPos(e, n) {
    ...
    for (let s; r && !(s = this.children[r - 1]).size && s instanceof lh && s.side >= 0; r--)
      ;
    if (n <= 0) {
      let s, o = !0;
      for (; s = r ? this.children[r - 1] : null, !(!s || s.dom.parentNode == this.contentDOM); r--, o = !1)
        ;
      return s && n && o && !s.border && !s.domAtom ? s.domFromPos(s.size, n) : { node: this.contentDOM, offset: s ? st(s.dom) + 1 : 0 };
    } else {
      let s, o = !0;
      for (; s = r < this.children.length ? this.children[r] : null, !(!s || s.dom.parentNode == this.contentDOM); r++, o = !1)
        ;
      return s && o && !s.border && !s.domAtom ? s.domFromPos(0, n) : { node: this.contentDOM, offset: s ? st(s.dom) : this.contentDOM.childNodes.length };
    }
  }
...
`), d && h == f.nodeValue.length)
          for (let p = f, m; p; p = p.parentNode) {
            if (m = p.nextSibling) {
              m.nodeName == "BR" && (l = a = { node: m.parentNode, offset: st(m) + 1 });
              break;
            }
            let g = p.pmViewDesc;
    ...
    if (!(i || d && Ue) && rr(l.node, l.offset, c.anchorNode, c.anchorOffset) && rr(a.node, a.offset, c.focusNode, c.focusOffset))
      return;
    let u = !1;
    if ((c.extend || e == n) && !d) {
  ...
  markDirty(e, n) {
    for (let r = 0, i = 0; i < this.children.length; i++) {
      ...
      if (r == o ? e <= o && n >= r : e < o && n > r) {
        ...
        if (e >= l && n <= a) {
          this.dirty = e == r || n == o ? zn : Yc, e == l && n == a && (s.contentLost || s.dom.parentNode != this.contentDOM) ? s.dirty = Wt : s.markDirty(e - l, n - l);
          return;
        } else
          s.dirty = s.dom == s.contentDOM && s.dom.parentNode == this.contentDOM && !s.children.length ? zn : Wt;
      }
      r = o;
    }
    this.dirty = zn;
...
class ir extends Hi {
  ...
  static create(e, n, r, i) {
    ...
    return (!o || !o.dom) && (o = Vt.renderSpec(document, n.type.spec.toDOM(n, r))), new ir(e, n, o.dom, o.contentDOM || o.dom);
  }
  parseRule() {
    return this.dirty & Wt || this.mark.type.spec.reparseInView ? null : { mark: this.mark.type.name, attrs: this.mark.attrs, contentElement: this.contentDOM || void 0 };
  }
  matchesMark(e) {
...
class Sn extends Hi {
  ...
  static create(e, n, r, i, s, o) {
    ...
    if (n.isText) {
      ...
      d || ({ dom: d, contentDOM: u } = Vt.renderSpec(document, n.type.spec.toDOM(n)));
    !u && !n.isText && d.nodeName != "BR" && (d.hasAttribute("contenteditable") || (d.contentEditable = "false"), n.type.spec.draggable && (d.draggable = !0));
    let f = d;
    return d = uh(d, r, n), c ? a = new S0(e, n, r, i, d, u || null, f, c, s, o + 1) : n.isText ? new wo(e, n, r, i, d, f, s) : new Sn(e, n, r, i, d, u || null, f, s, o + 1);
  }
  parseRule() {
  ...
  matchesNode(e, n, r) {
    return this.dirty == vt && e.eq(this.node) && Vl(n, this.outerDeco) && r.eq(this.innerDeco);
  }
  get size() {
  ...
  // `this.children`.
  updateChildren(e, n) {
    let r = this.node.inlineContent, i = n, s = e.composing ? this.localCompositionInfo(e, n) : null, o = s && s.pos > -1 ? s : null, l = s && s.pos < 0, a = new C0(this, o && o.node, e);
    A0(this.node, this.innerDeco, (c, d, u) => {
    ...
    }), a.syncToMarks([], r, e), this.node.isTextblock && a.addTextblockHacks(), a.destroyRest(), (a.changed || this.dirty == zn) && (o && this.protectLocalComposition(e, o), ch(this.contentDOM, this.children, e), Pr && R0(this.dom));
  }
  localCompositionInfo(e, n) {
    let { from: r, to: i } = e.state.selection;
    if (!(e.state.selection instanceof Y) || r < n || i > n + this.node.content.size)
      return null;
    let s = e.domSelectionRange(), o = x0(s.focusNode, s.focusOffset);
    if (!o || !this.dom.contains(o.parentNode))
      return null;
    if (this.node.inlineContent) {
      let l = o.nodeValue, a = _0(this.node.content, l, r - n, i - n);
  ...
  updateOuterDeco(e) {
    if (Vl(e, this.outerDeco))
      return;
    let n = this.nodeDOM.nodeType != 1, r = this.dom;
    this.dom = dh(this.dom, this.nodeDOM, Fl(this.outerDeco, this.node, n), Fl(e, this.node, n)), this.dom != r && (r.pmViewDesc = void 0, this.dom.pmViewDesc = this), this.outerDeco = e;
  }
...
class wo extends Sn {
  ...
  update(e, n, r, i) {
    return this.dirty == Wt || this.dirty != vt && !this.inParent() || !e.sameMarkup(this.node) ? !1 : (this.updateOuterDeco(n), (this.dirty != vt || e.text != this.node.text) && e.text != this.nodeDOM.nodeValue && (this.nodeDOM.nodeValue = e.text, i.trackWrites == this.nodeDOM && (i.trackWrites = null)), this.node = e, this.dirty = vt, !0);
  }
  inParent() {
...
function ch(t, e, n) {
  ...
  for (let s = 0; s < e.length; s++) {
    ...
    if (o instanceof ir) {
      ...
      ch(o.contentDOM, o.children, n), r = a ? a.nextSibling : t.firstChild;
    }
  }
  for (; r; )
    r = Xc(r), i = !0;
...
function uh(t, e, n) {
  return dh(t, t, Gn, Fl(e, n, t.nodeType != 1));
}
function Vl(t, e) {
  if (t.length != e.length)
    return !1;
...
class C0 {
  constructor(e, n, r) {
    this.lock = n, this.view = r, this.index = 0, this.stack = [], this.changed = !1, this.top = e, this.preMatch = M0(e.node.content, e);
  }
  ...
  updateNodeAt(e, n, r, i, s) {
    ...
    return o.dirty == Wt && o.dom == o.contentDOM && (o.dirty = zn), o.update(e, n, r, s) ? (this.destroyBetween(this.index, i), this.index++, !0) : !1;
  }
  ...
  updateNextNode(e, n, r, i, s, o) {
    for (let l = this.index; l < this.top.children.length; l++) {
      ...
      if (a instanceof Sn) {
        ...
        if (c != null && c != s)
          return !1;
        let d = a.dom, u, f = this.isLocked(d) && !(e.isText && a.node && a.node.isText && a.nodeDOM.nodeValue == e.text && a.dirty != Wt && Vl(n, a.outerDeco));
  ...
  addTextblockHacks() {
    ...
    (!e || // Empty textblock
    !(e instanceof wo) || /\n$/.test(e.node.text) || this.view.requiresGeckoHackNode && /\s$/.test(e.node.text)) && ((Ue || Be) && e && e.dom.contentEditable == "false" && this.addHackNode("IMG", n), this.addHackNode("BR", this.top));
  }
  addHackNode(e, n) {
...
function _a(t, e = null) {
  ...
  if (vo(n)) {
    for (a = l; i && !i.node; )
      i = i.parent;
    let d = i.node;
    if (i && d.isAtom && W.isSelectable(d) && i.parent && !(d.isInline && e0(n.focusNode, n.focusOffset, i.dom))) {
      let u = i.posBefore;
...
function fh(t) {
  return t.editable ? t.hasFocus() : ph(t) && document.activeElement && document.activeElement.contains(t.dom);
}
function nn(t, e = !1) {
  ...
  if (hh(t, n), !!fh(t)) {
    ...
    if (t.domObserver.disconnectSelection(), t.cursorWrapper)
      ...
      Jc && !(n instanceof Y) && (n.$from.parent.inlineContent || (s = Qc(t, n.from)), !n.empty && !n.$from.parent.inlineContent && (o = Qc(t, n.to))), t.docView.setSelection(r, i, t.root, e), Jc && (s && Zc(s), o && Zc(o)), n.visible ? t.dom.classList.remove("ProseMirror-hideselection") : (t.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && k0(t));
    }
    t.domObserver.setCurSelection(), t.domObserver.connectSelection();
  }
}
const Jc = Ue || Be && i0 < 63;
function Qc(t, e) {
...
function k0(t) {
  ...
  e.addEventListener("selectionchange", t.input.hideSelectionGuard = () => {
    (n.anchorNode != r || n.anchorOffset != i) && (e.removeEventListener("selectionchange", t.input.hideSelectionGuard), setTimeout(() => {
      (!fh(t) || t.state.selection.visible) && t.dom.classList.remove("ProseMirror-hideselection");
    }, 20));
  });
}
function D0(t) {
  let e = t.domSelection(), n = document.createRange(), r = t.cursorWrapper.dom, i = r.nodeName == "IMG";
  i ? n.setEnd(r.parentNode, st(r) + 1) : n.setEnd(r, 0), n.collapse(!1), e.removeAllRanges(), e.addRange(n), !i && !t.state.selection.visible && Qe && Tn <= 11 && (r.disabled = !0, r.disabled = !1);
}
function hh(t, e) {
  if (e instanceof W) {
...
function td(t) {
  return t.editable && !t.hasFocus() ? !1 : ph(t);
}
function ph(t) {
...
function L0(t) {
  ...
  if (!n)
    return;
  let i, s, o = !1;
  for (xt && n.nodeType == 1 && r < Fs(n) && pi(n.childNodes[r]) && (o = !0); ; )
    if (r > 0) {
      if (n.nodeType != 1)
        break;
      {
        ...
        break;
      {
        ...
        for (; l && pi(l); )
          i = n.parentNode, s = st(l), l = l.previousSibling;
        if (l)
          n = l, r = Fs(n);
        else {
  ...
  for (; ; )
    if (r < i) {
        ...
        break;
      {
        let l = n.nextSibling;
        for (; l && pi(l); )
          s = l.parentNode, o = st(l) + 1, l = l.nextSibling;
        if (l)
          n = l, r = 0, i = Fs(n);
        else {
          if (n = n.parentNode, n == t.dom)
...
function rd(t, e) {
  ...
  if (!(Be || s0) && n.parent.inlineContent) {
...
function yh(t, e) {
  ...
  let o = t.someProp("clipboardSerializer") || Vt.fromSchema(t.state.schema), l = Sh(), a = l.createElement("div");
  a.appendChild(o.serializeFragment(r, { document: l }));
  let c = a.firstChild, d, u = 0;
  for (; c && c.nodeType == 1 && (d = Th[c.nodeName.toLowerCase()]); ) {
...
`))), 0, 0) : H.empty;
    ...
    if (u)
      ...
      let f = i.marks(), { schema: h } = t.state, p = Vt.fromSchema(h);
  ...
  if (l || (l = (t.someProp("clipboardParser") || t.someProp("domParser") || Dr.fromSchema(t.state.schema)).parseSlice(o, {
    preserveWhitespace: !!(a || d),
    context: i,
    ruleFromNode(f) {
      return f.nodeName == "BR" && !f.nextSibling && f.parentNode && !F0.test(f.parentNode.nodeName) ? { ignore: !0 } : null;
    }
  })), d)
    l = U0(ld(l, +d[1], +d[2]), d[4]);
  else if (l = H.maxOpen(V0(l.content, i), !0), l.openStart || l.openEnd) {
    let u = 0, f = 0;
...
function V0(t, e) {
  ...
  for (let n = e.depth; n >= 0; n--) {
    ...
    if (t.forEach((l) => {
      ...
      if (!a)
        return o = null;
      if (c = o.length && s.length && bh(a, s, l, o[o.length - 1], 0))
        o[o.length - 1] = c;
      else {
        o.length && (o[o.length - 1] = wh(o[o.length - 1], s.length));
        let d = vh(l, a);
...
function bh(t, e, n, r, i) {
  if (i < t.length && i < e.length && t[i] == e[i]) {
    let s = bh(t, e, n, r.lastChild, i + 1);
    if (s)
      return r.copy(r.content.replaceChild(r.childCount - 1, s));
    if (r.contentMatchAt(r.childCount).matchType(i == t.length - 1 ? n.type : t[i + 1]))
      return r.copy(r.content.append(x.from(vh(n, t, i + 1))));
  }
}
function wh(t, e) {
  if (e == 0)
    return t;
  let n = t.content.replaceChild(t.childCount - 1, wh(t.lastChild, e - 1)), r = t.contentMatchAt(t.childCount).fillBefore(x.empty, !0);
...
function z0(t) {
  ...
  let n = Sh().createElement("div"), r = /<([a-z][^>\s]+)/i.exec(t), i;
  if ((i = r && Th[r[1].toLowerCase()]) && (t = i.map((s) => "<" + s + ">").join("") + t + i.map((s) => "</" + s + ">").reverse().join("")), n.innerHTML = t, i)
    for (let s = 0; s < i.length; s++)
...
const $e = {}, We = {}, $0 = { touchstart: !0, touchmove: !0 };
class W0 {
  constructor() {
...
function q0(t) {
  for (let e in $e) {
    ...
    t.dom.addEventListener(e, t.input.eventHandlers[e] = (r) => {
      Y0(t, r) && !Da(t, r) && (t.editable || !(r.type in We)) && n(t, r);
    }, $0[e] ? { passive: !0 } : void 0);
  }
  Ue && t.dom.addEventListener("input", () => null), Wl(t);
}
function wn(t, e) {
...
function K0(t, e) {
  !Da(t, e) && $e[e.type] && (t.editable || !(e.type in We)) && $e[e.type](t, e);
}
We.keydown = (t, e) => {
  let n = e;
  if (t.input.shiftKey = n.keyCode == 16 || n.shiftKey, !Ch(t, n) && (t.input.lastKeyCode = n.keyCode, t.input.lastKeyCodeTime = Date.now(), !(Ct && Be && n.keyCode == 13)))
    if (n.keyCode != 229 && t.domObserver.forceFlush(), Pr && n.keyCode == 13 && !n.ctrlKey && !n.altKey && !n.metaKey) {
      let r = Date.now();
      t.input.lastIOSEnter = r, t.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
        t.input.lastIOSEnter == r && (t.someProp("handleKeyDown", (i) => i(t, Bn(13, "Enter"))), t.input.lastIOSEnter = 0);
      }, 200);
    } else
      t.someProp("handleKeyDown", (r) => r(t, n)) || H0(t, n) ? n.preventDefault() : wn(t, "key");
};
We.keyup = (t, e) => {
...
We.keypress = (t, e) => {
  let n = e;
  if (Ch(t, n) || !n.charCode || n.ctrlKey && !n.altKey || mt && n.metaKey)
    return;
...
function J0(t, e) {
  ...
  return r && r.isAtom && W.isSelectable(r) ? (_r(t, new W(n), "pointer"), !0) : !1;
}
function Q0(t, e) {
  if (e == -1)
    return !1;
  ...
  return i != null ? (_r(t, W.create(t.state.doc, i), "pointer"), !0) : !1;
}
function Z0(t, e, n, r, i) {
  return Na(t, "handleClickOn", e, n, r) || t.someProp("handleClick", (s) => s(t, e, r)) || (i ? Q0(t, n) : J0(t, n));
}
function e1(t, e, n, r) {
  return Na(t, "handleDoubleClickOn", e, n, r) || t.someProp("handleDoubleClick", (i) => i(t, e, r));
}
function t1(t, e, n, r) {
  return Na(t, "handleTripleClickOn", e, n, r) || t.someProp("handleTripleClick", (i) => i(t, e, r)) || n1(t, n, r);
}
function n1(t, e, n) {
  if (n.button != 0)
    return !1;
  let r = t.state.doc;
  if (e == -1)
    return r.inlineContent ? (_r(t, Y.create(r, 0, r.content.size), "pointer"), !0) : !1;
  let i = r.resolve(e);
  for (let s = i.depth + 1; s > 0; s--) {
    let o = s > i.depth ? i.nodeAfter : i.node(s), l = i.before(s);
    if (o.inlineContent)
      _r(t, Y.create(r, l + 1, l + 1 + o.content.size), "pointer");
    else if (W.isSelectable(o))
      _r(t, W.create(r, l), "pointer");
    else
      continue;
    return !0;
  }
...
const Ih = mt ? "metaKey" : "ctrlKey";
$e.mousedown = (t, e) => {
  let n = e;
  t.input.shiftKey = n.shiftKey;
  let r = La(t), i = Date.now(), s = "singleClick";
  i - t.input.lastClick.time < 500 && X0(n, t.input.lastClick) && !n[Ih] && (t.input.lastClick.type == "singleClick" ? s = "doubleClick" : t.input.lastClick.type == "doubleClick" && (s = "tripleClick")), t.input.lastClick = { time: i, x: n.clientX, y: n.clientY, type: s };
  let o = t.posAtCoords(To(n));
  o && (s == "singleClick" ? (t.input.mouseDown && t.input.mouseDown.done(), t.input.mouseDown = new r1(t, o, n, !!r)) : (s == "doubleClick" ? e1 : t1)(t, o.pos, o.inside, n) ? n.preventDefault() : wn(t, "pointer"));
};
class r1 {
  constructor(e, n, r, i) {
    this.view = e, this.pos = n, this.event = r, this.flushed = i, this.delayedSelectionSync = !1, this.mightDrag = null, this.startDoc = e.state.doc, this.selectNode = !!r[Ih], this.allowDefault = r.shiftKey;
    let s, o;
    if (n.inside > -1)
    ...
    this.view.root.removeEventListener("mouseup", this.up), this.view.root.removeEventListener("mousemove", this.move), this.mightDrag && this.target && (this.view.domObserver.stop(), this.mightDrag.addAttr && this.target.removeAttribute("draggable"), this.mightDrag.setUneditable && this.target.removeAttribute("contentEditable"), this.view.domObserver.start()), this.delayedSelectionSync && setTimeout(() => nn(this.view)), this.view.input.mouseDown = null;
  }
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let n = this.pos;
    this.view.state.doc != this.startDoc && (n = this.view.posAtCoords(To(e))), this.updateAllowDefault(e), this.allowDefault || !n ? wn(this.view, "pointer") : Z0(this.view, n.pos, n.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
    ...
    // works around that.
    Be && !this.view.state.selection.visible && Math.min(Math.abs(n.pos - this.view.state.selection.from), Math.abs(n.pos - this.view.state.selection.to)) <= 2) ? (_r(this.view, q.near(this.view.state.doc.resolve(n.pos)), "pointer"), e.preventDefault()) : wn(this.view, "pointer");
  }
  move(e) {
...
We.compositionstart = We.compositionupdate = (t) => {
  if (!t.composing) {
    ...
    else if (Vs(t), xt && e.selection.empty && n.parentOffset && !n.textOffset && n.nodeBefore.marks.length) {
...
We.compositionend = (t, e) => {
  t.composing && (t.input.composing = !1, t.input.compositionEndedAt = e.timeStamp, t.input.compositionID++, Mh(t, 20));
};
function Mh(t, e) {
  clearTimeout(t.input.composingTimeout), e > -1 && (t.input.composingTimeout = setTimeout(() => Vs(t), e));
}
function Oh(t) {
  for (t.composing && (t.input.composing = !1, t.input.compositionEndedAt = s1()); t.input.compositionNodes.length > 0; )
...
function Vs(t, e = !1) {
  if (!(Ct && t.domObserver.flushingSoon >= 0)) {
    if (t.domObserver.forceFlush(), Oh(t), e || t.docView && t.docView.dirty) {
      let n = _a(t);
...
const Br = Qe && Tn < 15 || Pr && o0 < 604;
$e.copy = We.cut = (t, e) => {
  let n = e, r = t.state.selection, i = n.type == "cut";
  if (r.empty)
    return;
  let s = Br ? null : n.clipboardData, o = r.content(), { dom: l, text: a } = yh(t, o);
  s ? (n.preventDefault(), s.clearData(), s.setData("text/html", l.innerHTML), s.setData("text/plain", a)) : o1(t, l), i && t.dispatch(t.state.tr.deleteSelection().scrollIntoView().setMeta("uiEvent", "cut"));
};
function l1(t) {
...
function Mi(t, e, n, r, i) {
  let s = Eh(t, e, n, r, t.state.selection.$from);
  if (t.someProp("handlePaste", (a) => a(t, i, s || H.empty)))
    return !0;
  if (!s)
    return !1;
  let o = l1(s), l = o ? t.state.tr.replaceSelectionWith(o, r) : t.state.tr.replaceSelection(s);
...
We.paste = (t, e) => {
  ...
  if (t.composing && !Ct)
    return;
  let r = Br ? null : n.clipboardData, i = t.input.shiftKey && t.input.lastKeyCode != 45;
  r && Mi(t, r.getData("text/plain"), r.getData("text/html"), i, n) ? n.preventDefault() : a1(t, n);
};
class c1 {
  constructor(e, n) {
...
$e.dragstart = (t, e) => {
  ...
  let o = t.state.selection.content(), { dom: l, text: a } = yh(t, o);
  n.dataTransfer.clearData(), n.dataTransfer.setData(Br ? "Text" : "text/html", l.innerHTML), n.dataTransfer.effectAllowed = "copyMove", Br || n.dataTransfer.setData("text/plain", a), t.dragging = new c1(o, !n[Ah]);
};
$e.dragend = (t) => {
  let e = t.dragging;
  window.setTimeout(() => {
...
We.drop = (t, e) => {
  ...
  o ? t.someProp("transformPasted", (p) => {
    o = p(o, t);
  }) : o = Eh(t, n.dataTransfer.getData(Br ? "Text" : "text/plain"), Br ? null : n.dataTransfer.getData("text/html"), !1, s);
  let l = !!(r && !n[Ah]);
  ...
  if (!o)
    return;
  n.preventDefault();
  let a = o ? qf(t.state.doc, s.pos, o) : s.pos;
  a == null && (a = s.pos);
  let c = t.state.tr;
  l && c.deleteSelection();
...
$e.focus = (t) => {
  t.input.lastFocus = Date.now(), t.focused || (t.domObserver.stop(), t.dom.classList.add("ProseMirror-focused"), t.domObserver.start(), t.focused = !0, setTimeout(() => {
    t.docView && t.hasFocus() && !t.domObserver.currentSelection.eq(t.domSelectionRange()) && nn(t);
  }, 20));
};
$e.blur = (t, e) => {
  let n = e;
...
class se {
  ...
  */
  constructor(e, n) {
    this.local = e.length ? e : yr, this.children = n.length ? n : yr;
  }
  /**
  ...
  */
  mapInner(e, n, r, i, s) {
    ...
    return this.children.length ? d1(this.children, o || [], e, n, r, i, s) : o ? new se(o.sort(Jn), yr) : Pe;
  }
  /**
...
function d1(t, e, n, r, i, s, o) {
  ...
  if (a) {
    let c = u1(l, t, e, n, i, s, o), d = zs(c, r, 0, o);
    e = d.local;
...
class m1 {
  constructor(e, n) {
    this.view = e, this.handleDOMChange = n, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new p1(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let i = 0; i < r.length; i++)
        this.queue.push(r[i]);
      Qe && Tn <= 11 && r.some((i) => i.type == "childList" && i.removedNodes.length || i.type == "characterData" && i.oldValue.length > i.target.nodeValue.length) ? this.flushSoon() : this.flush();
    }), h1 && (this.onCharData = (r) => {
  ...
  onSelectionChange() {
    if (td(this.view)) {
      if (this.suppressingSelectionUpdates)
        return nn(this.view);
      if (Qe && Tn <= 11 && !this.view.state.selection.empty) {
  ...
  flush() {
    ...
    let c = null;
    s < 0 && i && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && vo(r) && (c = _a(e)) && c.eq(q.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, nn(e), this.currentSelection.set(r), e.scrollToSelection()) : (s > -1 || i) && (s > -1 && (e.docView.markDirty(s, o), g1(e)), this.handleDOMChange(s, o, l, a), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(r) || nn(e), this.currentSelection.set(r));
  }
  registerMutation(e, n) {
    ...
    if (e.type == "childList") {
      ...
      if (Qe && Tn <= 11 && e.addedNodes.length)
        for (let d = 0; d < e.addedNodes.length; d++) {
      ...
      let o = i && i.parentNode == e.target ? st(i) + 1 : 0, l = r.localPosFromDOM(e.target, o, -1), a = s && s.parentNode == e.target ? st(s) : e.target.childNodes.length, c = r.localPosFromDOM(e.target, a, 1);
      return { from: l, to: c };
    } else
...
function E1(t, e, n) {
  ...
  let u = t.state.doc, f = t.someProp("domParser") || Dr.fromSchema(t.state.schema), h = u.resolve(o), p = null, m = f.parse(r, {
    topNode: h.parent,
...
const b1 = /^(a|abbr|acronym|b|bd[io]|big|br|button|cite|code|data(list)?|del|dfn|em|i|ins|kbd|label|map|mark|meter|output|q|ruby|s|samp|small|span|strong|su[bp]|time|u|tt|var)$/i;
function w1(t, e, n, r, i) {
  ...
  let l = t.state.selection, a = E1(t, e, n), c = t.state.doc, d = c.slice(a.from, a.to), u, f;
  ...
  let h = I1(d.content, a.doc.content, a.from, u, f);
  if ((Pr && t.input.lastIOSEnter > Date.now() - 225 || Ct) && i.some((S) => S.nodeType == 1 && !b1.test(S.nodeName)) && (!h || h.endA >= h.endB) && t.someProp("handleKeyDown", (S) => S(t, Bn(13, "Enter")))) {
  ...
  if ((Pr && t.input.lastIOSEnter > Date.now() - 225 && (!v || i.some((S) => S.nodeName == "DIV" || S.nodeName == "P")) || !v && p.pos < a.doc.content.size && !p.sameParent(m) && (E = q.findFrom(a.doc.resolve(p.pos + 1), 1, !0)) && E.head == m.pos) && t.someProp("handleKeyDown", (S) => S(t, Bn(13, "Enter")))) {
    t.input.lastIOSEnter = 0;
    return;
  }
  if (t.state.selection.anchor > h.start && S1(c, h.start, h.endA, p, m) && t.someProp("handleKeyDown", (S) => S(t, Bn(8, "Backspace")))) {
  ...
  if (v) {
    if (p.pos == m.pos)
      Qe && Tn <= 11 && p.parentOffset == 0 && (t.domObserver.suppressSelectionUpdates(), setTimeout(() => nn(t), 20)), T = t.state.tr.delete(b, y), w = c.resolve(h.start).marksAcross(c.resolve(h.endA));
    else if (
      // Adding or removing a mark
      h.endA == h.endB && (C = T1(p.parent.content.cut(p.parentOffset, m.parentOffset), g.parent.content.cut(g.parentOffset, h.endA - g.start())))
    )
  ...
  if (T || (T = t.state.tr.replace(b, y, a.doc.slice(h.start - a.from, h.endB - a.from))), a.sel) {
    ...
    S && !(Be && Ct && t.composing && S.empty && (h.start != h.endB || t.input.lastAndroidDelete < Date.now() - 100) && (S.head == b || S.head == T.mapping.map(y) - 1) || Qe && S.empty && S.head == b) && T.setSelection(S);
  }
...
class C1 {
  ...
  */
  ...
  updateStateInner(e, n) {
    ...
    e.storedMarks && this.composing && (Oh(this), s = !0), this.state = e;
    ...
    if (o || this._props.plugins != n.plugins || this._props.nodeViews != n.nodeViews) {
      let f = gd(this);
      O1(f, this.nodeViews) && (this.nodeViews = f, i = !0);
    }
    ...
    let u = c == "preserve" && s && this.dom.style.overflowAnchor == null && c0(this);
    if (s) {
      this.domObserver.stop();
      let f = d && (Qe || Be) && !this.composing && !r.selection.empty && !e.selection.empty && M1(r.selection, e.selection);
      if (d) {
      ...
      f || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && N0(this)) ? nn(this, f) : (hh(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
    }
    this.updatePluginViews(r), c == "reset" ? this.dom.scrollTop = 0 : c == "to selection" ? this.scrollToSelection() : u && d0(u);
  }
  /**
  @internal
  */
  ...
  */
  focus() {
    this.domObserver.stop(), this.editable && u0(this.dom), nn(this), this.domObserver.start();
  }
  /**
  ...
  */
  domSelectionRange() {
    return Ue && this.root.nodeType === 11 && n0(this.dom.ownerDocument) == this.dom ? y1(this) : this.domSelection();
  }
  /**
  @internal
  */
...
function pd(t) {
  if (t.markCursor) {
    ...
    e.className = "ProseMirror-separator", e.setAttribute("mark-placeholder", "true"), e.setAttribute("alt", ""), t.cursorWrapper = { dom: e, deco: He.widget(t.state.selection.head, e, { raw: !0, marks: t.markCursor }) };
  } else
...
var On = {
  ...
  221: "}",
  222: '"'
}, A1 = typeof navigator < "u" && /Mac/.test(navigator.platform), R1 = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
for (var Ne = 0; Ne < 10; Ne++)
  On[48 + Ne] = On[96 + Ne] = String(Ne);
for (var Ne = 1; Ne <= 24; Ne++)
  On[Ne + 111] = "F" + Ne;
for (var Ne = 65; Ne <= 90; Ne++)
  On[Ne] = String.fromCharCode(Ne + 32), Gs[Ne] = String.fromCharCode(Ne);
for (var rl in On)
  Gs.hasOwnProperty(rl) || (Gs[rl] = On[rl]);
function x1(t) {
  var e = A1 && t.metaKey && t.shiftKey && !t.ctrlKey && !t.altKey || R1 && t.shiftKey && t.key && t.key.length == 1 || t.key == "Unidentified", n = !e && t.key || (t.shiftKey ? Gs : On)[t.keyCode] || t.key || "Unidentified";
  return n == "Esc" && (n = "Escape"), n == "Del" && (n = "Delete"), n == "Left" && (n = "ArrowLeft"), n == "Up" && (n = "ArrowUp"), n == "Right" && (n = "ArrowRight"), n == "Down" && (n = "ArrowDown"), n;
}
const _1 = typeof navigator < "u" ? /Mac|iP(hone|[oa]d)/.test(navigator.platform) : !1;
function k1(t) {
...
function N1(t) {
  return new me({ props: { handleKeyDown: Fa(t) } });
}
function Fa(t) {
  let e = D1(t);
  return function(n, r) {
    let i = x1(r), s, o = e[il(i, r)];
...
const L1 = (t, e) => t.selection.empty ? !1 : (e && e(t.tr.deleteSelection().scrollIntoView()), !0);
function P1(t, e) {
...
const B1 = (t, e, n) => {
  ...
  let s = i.nodeBefore;
  if (!s.type.spec.isolating && Lh(t, i, e))
    return !0;
  if (r.parent.content.size == 0 && (Hr(s, "end") || W.isSelectable(s))) {
    let o = Oa(t.doc, r.before(), r.after(), H.empty);
    if (o && o.slice.size < o.to - o.from) {
      if (e) {
        let l = t.tr.step(o);
        l.setSelection(Hr(s, "end") ? q.findFrom(l.doc.resolve(l.mapping.map(i.pos, -1)), -1) : W.create(l.doc, i.pos - s.nodeSize)), e(l.scrollIntoView());
      }
      return !0;
    }
  }
...
const V1 = (t, e, n) => {
  ...
  if (Lh(t, i, e))
    return !0;
  if (r.parent.content.size == 0 && (Hr(s, "start") || W.isSelectable(s))) {
    let o = Oa(t.doc, r.before(), r.after(), H.empty);
    if (o && o.slice.size < o.to - o.from) {
      if (e) {
        let l = t.tr.step(o);
        l.setSelection(Hr(s, "start") ? q.findFrom(l.doc.resolve(l.mapping.map(i.pos)), 1) : W.create(l.doc, l.mapping.map(i.pos))), e(l.scrollIntoView());
      }
      return !0;
    }
  }
...
const G1 = (t, e) => {
  ...
  if (r) {
    if (n.node.isTextblock || !Rn(t.doc, n.from))
      return !1;
    i = n.from;
  } else if (i = Wf(t.doc, n.from, -1), i == null)
    return !1;
  if (e) {
    let s = t.tr.join(i);
  ...
  if (n instanceof W) {
    if (n.node.isTextblock || !Rn(t.doc, n.to))
      return !1;
    r = n.to;
  } else if (r = Wf(t.doc, n.to, 1), r == null)
    return !1;
...
const q1 = (t, e) => {
  ...
  if (!n.parent.type.spec.code || !n.sameParent(r))
    return !1;
  let i = n.node(-1), s = n.indexAfter(-1), o = Nh(i.contentMatchAt(s));
  ...
  if (n instanceof Rt || r.parent.inlineContent || i.parent.inlineContent)
    return !1;
  let s = Nh(i.parent.contentMatchAt(i.indexAfter()));
  if (!s || !s.isTextblock)
    return !1;
  if (e) {
...
function ey(t, e = null) {
  return function(n, r) {
    ...
    let c = Ma(a, t, e, o);
    return c ? (r && r(ty(n.tr, o, c, l, t).scrollIntoView()), !0) : !1;
  };
}
function ty(t, e, n, r, i) {
  ...
  for (let d = e.startIndex, u = e.endIndex, f = !0; d < u; d++, f = !1)
    !f && Rr(t.doc, a, l) && (t.split(a, l), a += 2 * l), a += c.child(d).nodeSize;
  return t;
}
function ny(t) {
  return function(e, n) {
    let { $from: r, $to: i } = e.selection, s = r.blockRange(i, (o) => o.childCount > 0 && o.firstChild.type == t);
    return s ? n ? r.node(s.depth - 1).type == t ? ry(e, n, t, s) : iy(e, n, s) : !0 : !1;
  };
}
function ry(t, e, n, r) {
...
function F(t, e, n) {
  return t.config[e] === void 0 && t.parent ? F(t.parent, e, n) : typeof t.config[e] == "function" ? t.config[e].bind({
    ...n,
...
function Q(t, e = void 0, ...n) {
  return Hh(t) ? e ? t.bind(e)(...n) : t(...n) : t;
}
function ly(t = {}) {
  ...
  return t.style ? t : {
    ...
    getAttrs: (n) => {
      ...
      const i = e.reduce((s, o) => {
        const l = o.attribute.parseHTML ? o.attribute.parseHTML(n) : ay(n.getAttribute(o.name));
        return l == null ? s : {
          ...s,
          [o.name]: l
        };
...
function bd(t) {
  return Object.fromEntries(
    // @ts-ignore
    Object.entries(t).filter(([e, n]) => e === "attrs" && ly(n) ? !1 : n != null)
  );
}
function cy(t, e) {
  var n;
  const r = Bh(t), { nodeExtensions: i, markExtensions: s } = Co(t), o = (n = i.find((c) => F(c, "topNode"))) === null || n === void 0 ? void 0 : n.name, l = Object.fromEntries(i.map((c) => {
    const d = r.filter((v) => v.type === c.name), u = {
      ...
      const b = F(E, "extendNodeSchema", u);
      return {
        ...v,
        ...b ? b(c) : {}
      };
      ...
      ...f,
      content: Q(F(c, "content", u)),
      marks: Q(F(c, "marks", u)),
      group: Q(F(c, "group", u)),
      inline: Q(F(c, "inline", u)),
      atom: Q(F(c, "atom", u)),
      selectable: Q(F(c, "selectable", u)),
      draggable: Q(F(c, "draggable", u)),
      code: Q(F(c, "code", u)),
      defining: Q(F(c, "defining", u)),
      isolating: Q(F(c, "isolating", u)),
    ...
    const m = F(c, "renderHTML", u);
    m && (h.toDOM = (v) => m({
      node: v,
      HTMLAttributes: ql(v, d)
    }));
    const g = F(c, "renderText", u);
    ...
    const d = r.filter((g) => g.type === c.name), u = {
      ...
      const E = F(v, "extendMarkSchema", u);
      return {
        ...g,
        ...E ? E(c) : {}
      };
      ...
      ...f,
      inclusive: Q(F(c, "inclusive", u)),
      excludes: Q(F(c, "excludes", u)),
      group: Q(F(c, "group", u)),
      spanning: Q(F(c, "spanning", u)),
      code: Q(F(c, "code", u)),
...
class wr {
  constructor(e, n) {
    this.splittableMarks = [], this.editor = n, this.extensions = wr.resolve(e), this.schema = cy(this.extensions, n), this.extensions.forEach((r) => {
      var i;
      ...
      r.type === "mark" && (!((i = Q(F(r, "keepOnSplit", s))) !== null && i !== void 0) || i) && this.splittableMarks.push(r.name);
      const o = F(r, "onBeforeCreate", s);
      o && this.editor.on("beforeCreate", o);
      const l = F(r, "onCreate", s);
      l && this.editor.on("create", l);
      const a = F(r, "onUpdate", s);
      a && this.editor.on("update", a);
      const c = F(r, "onSelectionUpdate", s);
      c && this.editor.on("selectionUpdate", c);
      const d = F(r, "onTransaction", s);
      d && this.editor.on("transaction", d);
      const u = F(r, "onFocus", s);
      u && this.editor.on("focus", u);
      const f = F(r, "onBlur", s);
      f && this.editor.on("blur", f);
      const h = F(r, "onDestroy", s);
      h && this.editor.on("destroy", h);
    });
  }
  static resolve(e) {
    const n = wr.sort(wr.flatten(e)), r = yy(n.map((i) => i.name));
  ...
  static flatten(e) {
    return e.map((n) => {
      const r = {
        ...
        options: n.options,
        storage: n.storage
      }, i = F(n, "addExtensions", r);
      return i ? [n, ...this.flatten(i())] : n;
    }).flat(10);
  }
  static sort(e) {
    return e.sort((r, i) => {
      const s = F(r, "priority") || 100, o = F(i, "priority") || 100;
  ...
  get plugins() {
    const { editor: e } = this, n = wr.sort([...this.extensions].reverse()), r = [], i = [], s = n.map((o) => {
      const l = {
        name: o.name,
        options: o.options,
        storage: o.storage,
      ...
      }, a = [], c = F(o, "addKeyboardShortcuts", l);
      let d = {};
      if (o.type === "mark" && o.config.exitable && (d.ArrowRight = () => tt.handleExit({ editor: e, mark: o })), c) {
        const m = Object.fromEntries(Object.entries(c()).map(([g, v]) => [g, () => v({ editor: e })]));
        d = { ...d, ...m };
      }
      const u = N1(d);
      a.push(u);
      const f = F(o, "addInputRules", l);
      wd(o, e.options.enableInputRules) && f && r.push(...f());
      const h = F(o, "addPasteRules", l);
      wd(o, e.options.enablePasteRules) && h && i.push(...h());
      const p = F(o, "addProseMirrorPlugins", l);
      if (p) {
        const m = p();
        a.push(...m);
      }
  ...
  get attributes() {
    return Bh(this.extensions);
  }
  get nodeViews() {
    const { editor: e } = this, { nodeExtensions: n } = Co(this.extensions);
    return Object.fromEntries(n.filter((r) => !!F(r, "addNodeView")).map((r) => {
...
class be {
  constructor(e = {}) {
    this.type = "extension", this.name = "extension", this.parent = null, this.child = null, this.config = {
      ...
      ...this.config,
      ...e
    }, this.name = this.config.name, e.defaultOptions && console.warn(`[tiptap warn]: BREAKING CHANGE: "defaultOptions" is deprecated. Please use "addOptions" instead. Found in extension: "${this.name}".`), this.options = this.config.defaultOptions, this.config.addOptions && (this.options = Q(F(this, "addOptions", {
      name: this.name
    }))), this.storage = Q(F(this, "addStorage", {
      name: this.name,
  ...
  configure(e = {}) {
    const n = this.extend();
    return n.options = Oo(this.options, e), n.storage = Q(F(n, "addStorage", {
      name: n.name,
      options: n.options
    })), n;
  }
  extend(e = {}) {
    const n = new be(e);
    return n.parent = this, this.child = n, n.name = e.name ? e.name : n.parent.name, e.defaultOptions && console.warn(`[tiptap warn]: BREAKING CHANGE: "defaultOptions" is deprecated. Please use "addOptions" instead. Found in extension: "${n.name}".`), n.options = Q(F(n, "addOptions", {
      name: n.name
    })), n.storage = Q(F(n, "addStorage", {
      name: n.name,
      options: n.options
    })), n;
  }
      ...
      new me({
        ...
        props: {
          clipboardTextSerializer: () => {
            const { editor: t } = this, { state: e, schema: n } = t, { doc: r, selection: i } = e, { ranges: s } = i, o = Math.min(...s.map((d) => d.$from.pos)), l = Math.max(...s.map((d) => d.$to.pos)), a = zh(n);
            return Vh(r, { from: o, to: l }, {
              textSerializers: a
            });
          }
        }
...
}), by = () => ({ editor: t, view: e }) => (requestAnimationFrame(() => {
  var n;
  t.isDestroyed || (e.dom.blur(), (n = window == null ? void 0 : window.getSelection()) === null || n === void 0 || n.removeAllRanges());
}), !0), wy = (t = !1) => ({ commands: e }) => e.setContent("", t), Ty = () => ({ state: t, tr: e, dispatch: n }) => {
...
}, Sy = (t) => (e) => t(e), Iy = () => ({ state: t, dispatch: e }) => j1(t, e), Cy = () => ({ tr: t, dispatch: e }) => {
...
}, Ay = () => ({ state: t, dispatch: e }) => L1(t, e), Ry = () => ({ commands: t }) => t.keyboardShortcut("Enter"), xy = () => ({ state: t, dispatch: e }) => q1(t, e);
function Us(t, e, n = { strict: !0 }) {
  const r = Object.keys(e);
  return r.length ? r.every((i) => n.strict ? e[i] === t[i] : Va(e[i]) ? e[i].test(t[i]) : e[i] === t[i]) : !0;
}
function jl(t, e, n = {}) {
...
function za(t, e, n = {}) {
  ...
  for (; l < t.parent.childCount && _y([...t.parent.child(l).marks], e, n); )
...
const ky = (t, e = {}) => ({ tr: n, state: r, dispatch: i }) => {
...
function Gh(t, e = null) {
  ...
  return e === "all" ? Y.create(t, en(0, i, s), en(t.content.size, i, s)) : Y.create(t, en(e, i, s), en(e, i, s));
}
function Ao() {
  return [
    "iPad Simulator",
...
const Ny = (t = null, e = {}) => ({ editor: n, view: r, tr: i, dispatch: s }) => {
  e = {
    scrollIntoView: !0,
    ...e
  };
  ...
  if (s && t === null && !Ga(n.state.selection))
    return o(), !0;
  const l = Gh(i.doc, t) || n.state.selection, a = n.state.selection.eq(l);
  return s && (a || i.setSelection(l), a && i.storedMarks && i.setStoredMarks(i.storedMarks), o()), !0;
}, Ly = (t, e) => (n) => t.every((r, i) => e(r, { ...n, index: i })), Py = (t, e) => ({ tr: n, commands: r }) => r.insertContentAt({ from: n.selection.from, to: n.selection.to }, t, e);
function Td(t) {
  const e = `<body>${t}</body>`;
...
const Hy = (t) => t.toString().startsWith("<"), Fy = (t, e, n) => ({ tr: r, dispatch: i, editor: s }) => {
  if (i) {
    n = {
      parseOptions: {},
      updateSelection: !0,
    ...
    c ? Array.isArray(e) ? r.insertText(e.map((f) => f.text || "").join(""), l, a) : typeof e == "object" && e && e.text ? r.insertText(e.text, l, a) : r.insertText(e, l, a) : r.replaceWith(l, a, o), n.updateSelection && By(r, r.steps.length - 1, -1);
  }
  return !0;
}, Vy = () => ({ state: t, dispatch: e }) => G1(t, e), zy = () => ({ state: t, dispatch: e }) => U1(t, e), Gy = () => ({ state: t, dispatch: e }) => B1(t, e), Uy = () => ({ state: t, dispatch: e }) => V1(t, e);
function Uh() {
...
const Wy = (t) => ({ editor: e, view: n, tr: r, dispatch: i }) => {
  const s = $y(t).split(/-(?!$)/), o = s.find((c) => !["Alt", "Ctrl", "Meta", "Shift"].includes(c)), l = new KeyboardEvent("keydown", {
    key: o === "Space" ? " " : o,
...
const qy = (t, e = {}) => ({ state: n, dispatch: r }) => {
  ...
  return Ai(n, i, e) ? $1(n, r) : !1;
}, jy = () => ({ state: t, dispatch: e }) => Y1(t, e), Yy = (t) => ({ state: e, dispatch: n }) => {
  const r = _e(t, e.schema);
  return ny(r)(e, n);
}, Ky = () => ({ state: t, dispatch: e }) => W1(t, e);
function Ro(t, e) {
...
const Xy = (t, e) => ({ tr: n, state: r, dispatch: i }) => {
  let s = null, o = null;
...
}, Jy = () => ({ tr: t, dispatch: e }) => (e && t.scrollIntoView(), !0), Qy = () => ({ tr: t, commands: e }) => e.setTextSelection({
  from: 0,
  to: t.doc.content.size
}), Zy = () => ({ state: t, dispatch: e }) => H1(t, e), eE = () => ({ state: t, dispatch: e }) => z1(t, e), tE = () => ({ state: t, dispatch: e }) => K1(t, e), nE = () => ({ state: t, dispatch: e }) => Q1(t, e), rE = () => ({ state: t, dispatch: e }) => J1(t, e);
function $h(t, e, n = {}) {
  return $s(t, e, { slice: !1, parseOptions: n });
}
const iE = (t, e = !1, n = {}) => ({ tr: r, editor: i, dispatch: s }) => {
  const { doc: o } = r, l = $h(t, i.schema, n);
...
function Ua(t) {
  return (e) => Wh(e.$from, t);
}
function lE(t, e) {
  const n = Vt.fromSchema(e).serializeFragment(t), i = document.implementation.createHTMLDocument().createElement("div");
...
function qh(t, e) {
  ...
  return n === "node" ? cE(t, e) : n === "mark" ? xo(t, e) : {};
}
function dE(t, e = JSON.stringify) {
  const n = {};
  return t.filter((r) => {
    const i = e(r);
...
function jh(t, e, n) {
  const i = t.state.doc.content.size, s = en(e, 0, i), o = en(n, 0, i), l = t.coordsAtPos(s), a = t.coordsAtPos(o, -1), c = Math.min(l.top, a.top), d = Math.max(l.bottom, a.bottom), u = Math.min(l.left, a.left), f = Math.max(l.right, a.right), h = f - u, p = d - c, v = {
    top: c,
    bottom: d,
    left: u,
    right: f,
...
const yE = (t, e = {}) => ({ tr: n, state: r, dispatch: i }) => {
  ...
  return gE(r, n, a);
}, EE = (t, e) => ({ tr: n }) => (n.setMeta(t, e), !0), vE = (t, e = {}) => ({ state: n, dispatch: r, chain: i }) => {
...
}, bE = (t) => ({ tr: e, dispatch: n }) => {
  if (n) {
    const { doc: r } = e, i = en(t, 0, r.content.size), s = W.create(r, i);
    e.setSelection(s);
  }
  return !0;
}, wE = (t) => ({ tr: e, dispatch: n }) => {
  if (n) {
    const { doc: r } = e, { from: i, to: s } = typeof t == "number" ? { from: t, to: t } : t, o = Y.atStart(r).from, l = Y.atEnd(r).to, a = en(i, o, l), c = en(s, o, l), d = Y.create(r, a, c);
    e.setSelection(d);
  }
  return !0;
}, TE = (t) => ({ state: e, dispatch: n }) => {
  const r = _e(t, e.schema);
  return sy(r)(e, n);
};
function Cd(t, e) {
...
const SE = ({ keepMarks: t = !0 } = {}) => ({ tr: e, state: n, dispatch: r, editor: i }) => {
  ...
  if (s instanceof W && s.node.isBlock)
    return !l.parentOffset || !Rr(o, l.pos) ? !1 : (r && (t && Cd(n, i.extensionManager.splittableMarks), e.split(l.pos).scrollIntoView()), !0);
  if (!l.parent.isBlock)
    return !1;
  if (r) {
    const u = a.parentOffset === a.parent.content.size;
    s instanceof Y && e.deleteSelection();
    const f = l.depth === 0 ? void 0 : oE(l.node(-1).contentMatchAt(l.indexAfter(-1)));
    let h = u && f ? [
      {
        type: f,
        attrs: d
      }
    ] : void 0, p = Rr(e.doc, e.mapping.map(l.pos), 1, h);
    if (!h && !p && Rr(e.doc, e.mapping.map(l.pos), 1, f ? [{ type: f }] : void 0) && (p = !0, h = f ? [
      {
        type: f,
        attrs: d
      }
  ...
  return !0;
}, IE = (t) => ({ tr: e, state: n, dispatch: r, editor: i }) => {
  var s;
...
}, CE = (t, e, n, r = {}) => ({ editor: i, tr: s, state: o, dispatch: l, chain: a, commands: c, can: d }) => {
...
}, _E = (t, e = {}) => ({ tr: n, state: r, dispatch: i }) => {
  var s;
...
}, kE = (t, e = {}) => ({ tr: n, state: r, dispatch: i }) => {
  let s = null, o = null;
  const l = Ro(typeof t == "string" ? t : t.name, r.schema);
  return l ? (l === "node" && (s = _e(t, r.schema)), l === "mark" && (o = _n(t, r.schema)), i && n.selection.ranges.forEach((a) => {
...
}, DE = (t, e = {}) => ({ state: n, dispatch: r }) => {
  const i = _e(t, n.schema);
  return Z1(i, e)(n, r);
}, NE = (t, e = {}) => ({ state: n, dispatch: r }) => {
  const i = _e(t, n.schema);
  return ey(i, e)(n, r);
};
var LE = /* @__PURE__ */ Object.freeze({
  ...
  scrollIntoView: Jy,
  selectAll: Qy,
  selectNodeBackward: Zy,
  selectNodeForward: eE,
  selectParentNode: tE,
  selectTextblockEnd: nE,
  selectTextblockStart: rE,
  setContent: iE,
  setMark: yE,
  setMeta: EE,
  setNode: vE,
...
let $E = class extends oy {
   ...
   */
  injectCSS() {
    this.options.injectCSS && document && (this.css = UE(GE, this.options.injectNonce));
  }
  /**
   ...
   */
  registerPlugin(e, n) {
    const r = Hh(n) ? n(e, [...this.state.plugins]) : [...this.state.plugins, e], i = this.state.reconfigure({ plugins: r });
  ...
  createExtensionManager() {
    const n = [...this.options.enableCoreExtensions ? Object.values(zE) : [], ...this.options.extensions].filter((r) => ["extension", "node", "mark"].includes(r == null ? void 0 : r.type));
    this.extensionManager = new wr(n, this);
  }
  /**
   ...
   */
  createView() {
    const e = $h(this.options.content, this.schema, this.options.parseOptions), n = Gh(e, this.options.autofocus);
    this.view = new C1(this.options.element, {
   ...
   */
  getHTML() {
    return lE(this.state.doc.content, this.schema);
  }
  /**
...
var Ze = "top", wt = "bottom", Tt = "right", et = "left", $a = "auto", Fi = [Ze, wt, Tt, et], Fr = "start", xi = "end", YE = "clippingParents", Kh = "viewport", ii = "popper", KE = "reference", Od = /* @__PURE__ */ Fi.reduce(function(t, e) {
  return t.concat([e + "-" + Fr, e + "-" + xi]);
}, []), Xh = /* @__PURE__ */ [].concat(Fi, [$a]).reduce(function(t, e) {
  return t.concat([e, e + "-" + Fr, e + "-" + xi]);
}, []), XE = "beforeRead", JE = "read", QE = "afterRead", ZE = "beforeMain", ev = "main", tv = "afterMain", nv = "beforeWrite", rv = "write", iv = "afterWrite", sv = [XE, JE, QE, ZE, ev, tv, nv, rv, iv];
function qt(t) {
...
function ov(t) {
  ...
  Object.keys(e.elements).forEach(function(n) {
    ...
    !bt(s) || !qt(s) || (Object.assign(s.style, r), Object.keys(i).forEach(function(o) {
      var l = i[o];
...
function lv(t) {
  ...
  return Object.assign(e.elements.popper.style, n.popper), e.styles = n, e.elements.arrow && Object.assign(e.elements.arrow.style, n.arrow), function() {
    Object.keys(e.elements).forEach(function(r) {
      ...
      !bt(i) || !qt(i) || (Object.assign(i.style, l), Object.keys(s).forEach(function(a) {
        i.removeAttribute(a);
      }));
    });
  };
...
var Qn = Math.max, qs = Math.min, Vr = Math.round;
function Jl() {
...
function zr(t, e, n) {
  ...
  e && bt(t) && (i = t.offsetWidth > 0 && Vr(r.width) / t.offsetWidth || 1, s = t.offsetHeight > 0 && Vr(r.height) / t.offsetHeight || 1);
  var o = or(t) ? at(t) : window, l = o.visualViewport, a = !Qh() && n, c = (r.left + (a && l ? l.offsetLeft : 0)) / i, d = (r.top + (a && l ? l.offsetTop : 0)) / s, u = r.width / i, f = r.height / s;
  return {
    width: u,
    height: f,
    top: d,
...
function qa(t) {
  var e = zr(t), n = t.offsetWidth, r = t.offsetHeight;
...
function cv(t) {
  ...
  var i = _o(t);
  for (Wa(i) && (i = i.host); bt(i) && ["html", "body"].indexOf(qt(i)) < 0; ) {
    var s = rn(i);
...
function Vi(t) {
  for (var e = at(t), n = Ad(t); n && av(n) && rn(n).position === "static"; )
    n = Ad(n);
  return n && (qt(n) === "html" || qt(n) === "body" && rn(n).position === "static") ? e : n || cv(t) || e;
}
function ja(t) {
...
var uv = function(e, n) {
  ...
  })) : e, tp(typeof e != "number" ? e : np(e, Fi));
};
function fv(t) {
  var e, n = t.state, r = t.name, i = t.options, s = n.elements.arrow, o = n.modifiersData.popperOffsets, l = Ut(n.placement), a = ja(l), c = [et, Tt].indexOf(l) >= 0, d = c ? "height" : "width";
  if (!(!s || !o)) {
    var u = uv(i.padding, n), f = qa(s), h = a === "y" ? Ze : et, p = a === "y" ? wt : Tt, m = n.rects.reference[d] + n.rects.reference[a] - o[a] - n.rects.popper[d], g = o[a] - n.rects.reference[a], v = Vi(s), E = v ? a === "y" ? v.clientHeight || 0 : v.clientWidth || 0 : 0, b = m / 2 - g / 2, y = u[h], T = E - f[d] - u[p], w = E / 2 - f[d] / 2 + b, C = mi(y, w, T), S = a;
    n.modifiersData[r] = (e = {}, e[S] = C, e.centerOffset = C - w, e);
  }
}
function hv(t) {
  var e = t.state, n = t.options, r = n.element, i = r === void 0 ? "[data-popper-arrow]" : r;
  i != null && (typeof i == "string" && (i = e.elements.popper.querySelector(i), !i) || Zh(e.elements.popper, i) && (e.elements.arrow = i));
}
const pv = {
  name: "arrow",
  enabled: !0,
...
function Rd(t) {
  ...
  h = g.x, m = g.y;
  var v = o.hasOwnProperty("x"), E = o.hasOwnProperty("y"), b = et, y = Ze, T = window;
  if (c) {
    var w = Vi(n), C = "clientHeight", S = "clientWidth";
    if (w === at(n) && (w = kn(n), rn(w).position !== "static" && l === "absolute" && (C = "scrollHeight", S = "scrollWidth")), w = w, i === Ze || (i === et || i === Tt) && s === xi) {
      y = wt;
  ...
  if (h = D.x, m = D.y, a) {
    var V;
    return Object.assign({}, k, (V = {}, V[y] = E ? "0" : "", V[b] = v ? "0" : "", V.transform = (T.devicePixelRatio || 1) <= 1 ? "translate(" + h + "px, " + m + "px)" : "translate3d(" + h + "px, " + m + "px, 0)", V));
  }
...
function vv(t) {
  var e = t.state, n = t.instance, r = t.options, i = r.scroll, s = i === void 0 ? !0 : i, o = r.resize, l = o === void 0 ? !0 : o, a = at(e.elements.popper), c = [].concat(e.scrollParents.reference, e.scrollParents.popper);
...
function Ka(t) {
  return zr(kn(t)).left + Ya(t).scrollLeft;
}
function Sv(t, e) {
  var n = at(t), r = kn(t), i = n.visualViewport, s = r.clientWidth, o = r.clientHeight, l = 0, a = 0;
  if (i) {
...
function Iv(t) {
  ...
  return rn(i || n).direction === "rtl" && (l += Qn(n.clientWidth, i ? i.clientWidth : 0) - s), {
    width: s,
    height: o,
    x: l,
    y: a
...
function Xa(t) {
  var e = rn(t), n = e.overflow, r = e.overflowX, i = e.overflowY;
  return /auto|scroll|overlay|hidden/.test(n + i + r);
}
function rp(t) {
  return ["html", "body", "#document"].indexOf(qt(t)) >= 0 ? t.ownerDocument.body : bt(t) && Xa(t) ? t : rp(_o(t));
}
function gi(t, e) {
  var n;
  e === void 0 && (e = []);
  var r = rp(t), i = r === ((n = t.ownerDocument) == null ? void 0 : n.body), s = at(r), o = i ? [s].concat(s.visualViewport || [], Xa(r) ? r : []) : r, l = e.concat(o);
  return i ? l : (
...
function Cv(t, e) {
  var n = zr(t, !1, e === "fixed");
  return n.top = n.top + t.clientTop, n.left = n.left + t.clientLeft, n.bottom = n.top + t.clientHeight, n.right = n.left + t.clientWidth, n.width = t.clientWidth, n.height = t.clientHeight, n.x = n.left, n.y = n.top, n;
}
function _d(t, e, n) {
  return e === Kh ? Ql(Sv(t, n)) : or(e) ? Cv(e, n) : Ql(Iv(kn(t)));
}
function Mv(t) {
  var e = gi(_o(t)), n = ["absolute", "fixed"].indexOf(rn(t).position) >= 0, r = n && bt(t) ? Vi(t) : t;
  return or(r) ? e.filter(function(i) {
    return or(i) && Zh(i, r) && qt(i) !== "body";
  }) : [];
}
function Ov(t, e, n, r) {
  var i = e === "clippingParents" ? Mv(t) : [].concat(e), s = [].concat(i, [n]), o = s[0], l = s.reduce(function(a, c) {
    var d = _d(t, c, r);
...
function ip(t) {
  var e = t.reference, n = t.element, r = t.placement, i = r ? Ut(r) : null, s = r ? Gr(r) : null, o = e.x + e.width / 2 - n.width / 2, l = e.y + e.height / 2 - n.height / 2, a;
  switch (i) {
    case Ze:
      a = {
        x: o,
...
function _i(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, i = r === void 0 ? t.placement : r, s = n.strategy, o = s === void 0 ? t.strategy : s, l = n.boundary, a = l === void 0 ? YE : l, c = n.rootBoundary, d = c === void 0 ? Kh : c, u = n.elementContext, f = u === void 0 ? ii : u, h = n.altBoundary, p = h === void 0 ? !1 : h, m = n.padding, g = m === void 0 ? 0 : m, v = tp(typeof g != "number" ? g : np(g, Fi)), E = f === ii ? KE : ii, b = t.rects.popper, y = t.elements[p ? E : f], T = Ov(or(y) ? y : y.contextElement || kn(t.elements.popper), a, d, o), w = zr(t.elements.reference), C = ip({
    reference: w,
    element: b,
    strategy: "absolute",
    placement: i
  ...
  if (f === ii && k) {
    ...
    Object.keys(P).forEach(function(V) {
      var R = [Tt, wt].indexOf(V) >= 0 ? 1 : -1, G = [Ze, wt].indexOf(V) >= 0 ? "y" : "x";
      P[V] += D[G] * R;
    });
  }
  return P;
...
function Av(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, i = n.boundary, s = n.rootBoundary, o = n.padding, l = n.flipVariations, a = n.allowedAutoPlacements, c = a === void 0 ? Xh : a, d = Gr(r), u = d ? l ? Od : Od.filter(function(p) {
    return Gr(p) === d;
  }) : Fi, f = u.filter(function(p) {
...
function xv(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var i = n.mainAxis, s = i === void 0 ? !0 : i, o = n.altAxis, l = o === void 0 ? !0 : o, a = n.fallbackPlacements, c = n.padding, d = n.boundary, u = n.rootBoundary, f = n.altBoundary, h = n.flipVariations, p = h === void 0 ? !0 : h, m = n.allowedAutoPlacements, g = e.options.placement, v = Ut(g), E = v === g, b = a || (E || !p ? [Is(g)] : Rv(g)), y = [g].concat(b).reduce(function(ge, Ve) {
      return ge.concat(Ut(Ve) === $a ? Av(e, {
        placement: Ve,
        boundary: d,
        rootBoundary: u,
        padding: c,
      ...
      var k = y[P], D = Ut(k), V = Gr(k) === Fr, R = [Ze, wt].indexOf(D) >= 0, G = R ? "width" : "height", I = _i(e, {
        placement: k,
        boundary: d,
        rootBoundary: u,
        altBoundary: f,
    ...
    if (S)
      for (var $ = p ? 3 : 1, K = function(Ve) {
        var X = y.find(function(oe) {
          var Te = C.get(oe);
          if (Te)
...
function Dd(t) {
  return [Ze, Tt, wt, et].some(function(e) {
    return t[e] >= 0;
  });
}
function kv(t) {
...
function Nv(t, e, n) {
  var r = Ut(t), i = [et, Ze].indexOf(r) >= 0 ? -1 : 1, s = typeof n == "function" ? n(Object.assign({}, e, {
    placement: t
  })) : n, o = s[0], l = s[1];
  return o = o || 0, l = (l || 0) * i, [et, Tt].indexOf(r) >= 0 ? {
    x: l,
    y: o
  } : {
    x: o,
...
function Lv(t) {
  var e = t.state, n = t.options, r = t.name, i = n.offset, s = i === void 0 ? [0, 0] : i, o = Xh.reduce(function(d, u) {
    return d[u] = Nv(u, e.rects, s), d;
...
function Vv(t) {
  var e = t.state, n = t.options, r = t.name, i = n.mainAxis, s = i === void 0 ? !0 : i, o = n.altAxis, l = o === void 0 ? !1 : o, a = n.boundary, c = n.rootBoundary, d = n.altBoundary, u = n.padding, f = n.tether, h = f === void 0 ? !0 : f, p = n.tetherOffset, m = p === void 0 ? 0 : p, g = _i(e, {
    ...
    padding: u,
    altBoundary: d
  }), v = Ut(e.placement), E = Gr(e.placement), b = !E, y = ja(v), T = Fv(y), w = e.modifiersData.popperOffsets, C = e.rects.reference, S = e.rects.popper, O = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, P = typeof O == "number" ? {
    mainAxis: O,
    altAxis: O
  ...
  if (w) {
    if (s) {
      var V, R = y === "y" ? Ze : et, G = y === "y" ? wt : Tt, I = y === "y" ? "height" : "width", A = w[y], L = A + g[R], B = A - g[G], $ = h ? -S[I] / 2 : 0, K = E === Fr ? C[I] : S[I], ue = E === Fr ? -S[I] : -C[I], ke = e.elements.arrow, ge = h && ke ? qa(ke) : {
        width: 0,
        height: 0
      }, Ve = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : ep(), X = Ve[R], oe = Ve[G], Te = mi(0, C[I], ge[I]), rt = b ? C[I] / 2 - $ - Te - X - P.mainAxis : K - Te - X - P.mainAxis, le = b ? -C[I] / 2 + $ + Te + oe + P.mainAxis : ue + Te + oe + P.mainAxis, St = e.elements.arrow && Vi(e.elements.arrow), Gi = St ? y === "y" ? St.clientTop || 0 : St.clientLeft || 0 : 0, Jr = (V = k == null ? void 0 : k[y]) != null ? V : 0, Ui = A + rt - Jr - Gi, $i = A + le - Jr, Qr = mi(h ? qs(L, Ui) : L, A, h ? Qn(B, $i) : B);
      w[y] = Qr, D[y] = Qr - A;
    }
    if (l) {
      var Zr, Wi = y === "x" ? Ze : et, qi = y === "x" ? wt : Tt, Yt = w[T], ln = T === "y" ? "height" : "width", ei = Yt + g[Wi], Dn = Yt - g[qi], ti = [Ze, et].indexOf(v) !== -1, ji = (Zr = k == null ? void 0 : k[T]) != null ? Zr : 0, Yi = ti ? ei : Yt - C[ln] - S[ln] - ji + P.altAxis, Ki = ti ? Yt + C[ln] + S[ln] - ji - P.altAxis : Dn, Xi = h && ti ? dv(Yi, Yt, Ki) : mi(h ? Yi : ei, Yt, h ? Ki : Dn);
      w[T] = Xi, D[T] = Xi - Yt;
    }
    e.modifiersData[r] = D;
  }
...
function Uv(t) {
  return t === at(t) || !bt(t) ? Ya(t) : Gv(t);
}
function $v(t) {
  var e = t.getBoundingClientRect(), n = Vr(e.width) / t.offsetWidth || 1, r = Vr(e.height) / t.offsetHeight || 1;
  return n !== 1 || r !== 1;
}
function Wv(t, e, n) {
  n === void 0 && (n = !1);
  var r = bt(e), i = bt(e) && $v(e), s = kn(e), o = zr(t, i, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, a = {
    x: 0,
  ...
  Xa(s)) && (l = Uv(e)), bt(e) ? (a = zr(e, !0), a.x += e.clientLeft, a.y += e.clientTop) : s && (a.x = Ka(s))), {
  ...
  return function(l, a, c) {
    ...
    var d = {
      ...
      setOptions: function(v) {
        ...
        var b = jv(Kv([].concat(r, d.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!f) {
          ...
          if (Ld(E, b)) {
            d.rects = {
              reference: Wv(E, Vi(b), d.options.strategy === "fixed"),
              popper: qa(b)
...
var Jv = [bv, Hv, Ev, Jh, Pv, _v, zv, pv, Dv], Qv = /* @__PURE__ */ Xv({
  defaultModifiers: Jv
}), Zv = "tippy-box", sp = "tippy-content", eb = "tippy-backdrop", op = "tippy-arrow", lp = "tippy-svg-arrow", Pn = {
  passive: !0,
  capture: !0
}, ap = function() {
...
function cb(t) {
  return ki(t) ? [t] : ob(t) ? js(t) : Array.isArray(t) ? t : js(document.querySelectorAll(t));
}
function ul(t, e) {
...
function ub(t, e) {
  ...
  return t.every(function(i) {
    var s = i.popperRect, o = i.popperState, l = i.props, a = l.interactiveBorder, c = sb(o.placement), d = o.modifiersData.offset;
    if (!d)
      return !0;
...
function fb() {
  Ht.isTouch || (Ht.isTouch = !0, window.performance && document.addEventListener("mousemove", dp));
}
function dp() {
  var t = performance.now();
  t - zd < 20 && (Ht.isTouch = !1, document.removeEventListener("mousemove", dp)), zd = t;
}
function hb() {
...
function pb() {
  document.addEventListener("touchstart", fb, Pn), window.addEventListener("blur", hb);
}
var mb = typeof window < "u" && typeof document < "u", gb = mb ? (
  // @ts-ignore
  !!window.msCrypto
) : !1;
function pr(t) {
...
var Di;
process.env.NODE_ENV !== "production" && Eb();
function Eb() {
  Di = /* @__PURE__ */ new Set();
}
function Zt(t, e) {
  if (t && !Di.has(e)) {
    var n;
    Di.add(e), (n = console).warn.apply(n, up(e));
  }
}
function Zl(t, e) {
  if (t && !Di.has(e)) {
    var n;
    Di.add(e), (n = console).error.apply(n, up(e));
  }
}
function vb(t) {
...
var fp = {
  ...
  triggerTarget: null
}, fp, bb), wb = Object.keys(ot), Tb = function(e) {
  process.env.NODE_ENV !== "production" && pp(e, []);
  var n = Object.keys(e);
...
function hp(t) {
  var e = t.plugins || [], n = e.reduce(function(r, i) {
    ...
    if (s) {
      var l;
      r[s] = t[s] !== void 0 ? t[s] : (l = ot[s]) != null ? l : o;
    }
    return r;
  }, {});
...
function Sb(t, e) {
  var n = e ? Object.keys(hp(Object.assign({}, ot, {
    plugins: e
  }))) : wb, r = n.reduce(function(i, s) {
...
function Ud(t, e) {
  var n = Object.assign({}, e, {
    content: cp(e.content, [t])
  }, e.ignoreAttributes ? {} : Sb(t, e.plugins));
  return n.aria = Object.assign({}, ot.aria, n.aria), n.aria = {
...
function pp(t, e) {
  ...
  var n = Object.keys(t);
  n.forEach(function(r) {
    var i = nb(ot, Object.keys(fp)), s = !tb(i, r);
...
function $d(t) {
  var e = yi();
  return t === !0 ? e.className = op : (e.className = lp, ki(t) ? e.appendChild(t) : ea(e, t)), e;
}
function Wd(t, e) {
...
function ta(t) {
  ...
  return {
    ...
    content: n.find(function(r) {
      return r.classList.contains(sp);
    }),
    arrow: n.find(function(r) {
      return r.classList.contains(op) || r.classList.contains(lp);
    }),
...
function mp(t) {
  var e = yi(), n = yi();
  n.className = Zv, n.setAttribute("data-state", "hidden"), n.setAttribute("tabindex", "-1");
  var r = yi();
  r.className = sp, r.setAttribute("data-state", "hidden"), Wd(r, t.props), e.appendChild(n), n.appendChild(r), i(t.props, t.props);
  function i(s, o) {
...
var Cb = 1, rs = [], hl = [];
function Mb(t, e) {
  var n = Ud(t, Object.assign({}, ot, hp(Hd(e)))), r, i, s, o = !1, l = !1, a = !1, c = !1, d, u, f, h = [], p = Pd(Ui, n.interactiveDebounce), m, g = Cb++, v = null, E = ib(n.plugins), b = {
  ...
  function R() {
    var M = V().parentNode;
    return M ? db(M) : document;
  }
  function G() {
    return ta(w);
  }
  function I(M) {
    return y.state.isMounted && !y.state.isVisible || Ht.isTouch || d && d.type === "focus" ? 0 : dl(y.props.delay, M ? 0 : 1, ot.delay);
  }
  function A(M) {
  ...
  function B() {
    var M = y.props.aria;
    if (M.content) {
      var z = "aria-" + M.content, j = w.id, re = Er(y.props.triggerTarget || t);
      re.forEach(function(te) {
        var ze = te.getAttribute(z);
        if (y.state.isVisible)
          te.setAttribute(z, ze ? ze + " " + j : j);
        else {
          var ct = ze && ze.replace(j, "").trim();
          ct ? te.setAttribute(z, ct) : te.removeAttribute(z);
        }
      });
    }
  }
  function $() {
    if (!(O || !y.props.aria.expanded)) {
      var M = Er(y.props.triggerTarget || t);
      M.forEach(function(z) {
        y.props.interactive ? z.setAttribute("aria-expanded", y.state.isVisible && z === V() ? "true" : "false") : z.removeAttribute("aria-expanded");
      });
    }
  }
  function K() {
  ...
  function ue(M) {
    if (!(Ht.isTouch && (a || M.type === "mousedown"))) {
      ...
      if (!(y.props.interactive && Vd(w, z))) {
        if (Er(y.props.triggerTarget || t).some(function(j) {
          return Vd(j, z);
        })) {
  ...
  function le(M, z, j) {
    j === void 0 && (j = !1);
    var re = Er(y.props.triggerTarget || t);
    re.forEach(function(te) {
  ...
  function St() {
    k() && (le("touchstart", Jr, {
      ...
      passive: !0
    })), rb(y.props.trigger).forEach(function(M) {
      if (M !== "manual")
        switch (le(M, Jr), M) {
          case "mouseenter":
            le("mouseleave", $i);
  ...
  function Jr(M) {
    ...
    if (!(!y.state.isEnabled || Zr(M) || l)) {
      ...
      d = M, m = M.currentTarget, $(), !y.state.isVisible && lb(M) && rs.forEach(function(te) {
        return te(M);
  ...
  function Ui(M) {
    var z = M.target, j = V().contains(z) || w.contains(z);
    if (!(M.type === "mousemove" && j)) {
      var re = ln().concat(w).map(function(te) {
        var ze, ct = te._tippy, ur = (ze = ct.popperInstance) == null ? void 0 : ze.state;
        return ur ? {
  ...
  function Qr(M) {
    y.props.trigger.indexOf("focusin") < 0 && M.target !== V() || y.props.interactive && M.relatedTarget && w.contains(M.relatedTarget) || Dn(M);
  }
  function Zr(M) {
  ...
  function Wi() {
    qi();
    var M = y.props, z = M.popperOptions, j = M.placement, re = M.offset, te = M.getReferenceClientRect, ze = M.moveTransition, ct = D() ? ta(w).arrow : null, ur = te ? {
      getBoundingClientRect: te,
      contextElement: te.contextElement || V()
    } : t, wc = {
      name: "$$tippy",
      enabled: !0,
      phase: "beforeWrite",
      ...
      fn: function(Ji) {
        ...
        if (D()) {
          ...
          ["placement", "reference-hidden", "escaped"].forEach(function(Qi) {
            Qi === "placement" ? Go.setAttribute("data-placement", fr.placement) : fr.attributes.popper["data-popper-" + Qi] ? Go.setAttribute("data-" + Qi, "") : Go.removeAttribute("data-" + Qi);
          }), fr.attributes.popper = {};
        }
      }
    }, Nn = [{
      name: "offset",
    ...
    }), Nn.push.apply(Nn, (z == null ? void 0 : z.modifiers) || []), y.popperInstance = Qv(ur, w, Object.assign({}, z, {
      placement: j,
      onFirstUpdate: f,
      modifiers: Nn
    }));
  ...
  function Yt() {
    var M = y.props.appendTo, z, j = V();
    y.props.interactive && M === ap || M === "parent" ? z = j.parentNode : z = cp(M, [j]), z.contains(w) || z.appendChild(w), y.state.isMounted = !0, Wi(), process.env.NODE_ENV !== "production" && Zt(y.props.interactive && M === ot.appendTo && j.nextElementSibling !== w, ["Interactive tippy element may not be accessible via keyboard", "navigation because it is not directly after the reference element", "in the DOM source order.", `
...
`, "See: https://atomiks.github.io/tippyjs/v6/accessibility/#interactivity"].join(" "));
  ...
  function ei(M) {
    y.clearDelayTimeouts(), M && L("onTrigger", [y, M]), Ve();
  ...
  function Ki(M) {
    if (process.env.NODE_ENV !== "production" && Zt(y.state.isDestroyed, pr("setProps")), !y.state.isDestroyed) {
      L("onBeforeUpdate", [y, M]), Gi();
      var z = y.props, j = Ud(t, Object.assign({}, z, Hd(M), {
        ignoreAttributes: !0
      }));
      y.props = j, St(), z.interactiveDebounce !== j.interactiveDebounce && (K(), p = Pd(Ui, j.interactiveDebounce)), z.triggerTarget && !j.triggerTarget ? Er(z.triggerTarget).forEach(function(re) {
        re.removeAttribute("aria-expanded");
      }) : j.triggerTarget && t.removeAttribute("aria-expanded"), $(), A(), C && C(z, j), y.popperInstance && (Wi(), ln().forEach(function(re) {
  ...
  function Dm() {
    process.env.NODE_ENV !== "production" && Zt(y.state.isDestroyed, pr("show"));
    var M = y.state.isVisible, z = y.state.isDestroyed, j = !y.state.isEnabled, re = Ht.isTouch && !y.props.touch, te = dl(y.props.duration, 0, ot.duration);
    if (!(M || z || j || re) && !V().hasAttribute("disabled") && (L("onShow", [y], !1), y.props.onShow(y) !== !1)) {
      if (y.state.isVisible = !0, D() && (w.style.visibility = "visible"), A(), Ve(), y.state.isMounted || (w.style.transition = "none"), D()) {
        var ze = G(), ct = ze.box, ur = ze.content;
        ul([ct, ur], 0);
      }
      f = function() {
        var Nn;
        if (!(!y.state.isVisible || c)) {
          if (c = !0, w.offsetHeight, w.style.transition = y.props.moveTransition, D() && y.props.animation) {
            var zo = G(), Ji = zo.box, fr = zo.content;
            ul([Ji, fr], te), Fd([Ji, fr], "visible");
          }
  ...
  function Nm() {
    process.env.NODE_ENV !== "production" && Zt(y.state.isDestroyed, pr("hide"));
    var M = !y.state.isVisible, z = y.state.isDestroyed, j = !y.state.isEnabled, re = dl(y.props.duration, 1, ot.duration);
    if (!(M || z || j) && (L("onHide", [y], !1), y.props.onHide(y) !== !1)) {
      if (y.state.isVisible = !1, y.state.isShown = !1, c = !1, o = !1, D() && (w.style.visibility = "hidden"), K(), X(), A(!0), D()) {
        var te = G(), ze = te.box, ct = te.content;
        y.props.animation && (ul([ze, ct], re), Fd([ze, ct], "hidden"));
      }
      B(), $(), y.props.animation ? D() && oe(re, y.unmount) : y.unmount();
    }
  }
  function Lm(M) {
    process.env.NODE_ENV !== "production" && Zt(y.state.isDestroyed, pr("hideWithInteractivity")), R().addEventListener("mousemove", p), Bd(rs, p), p(M);
  }
  function Pm() {
    process.env.NODE_ENV !== "production" && Zt(y.state.isDestroyed, pr("unmount")), y.state.isVisible && y.hide(), y.state.isMounted && (qi(), ln().forEach(function(M) {
      M._tippy.unmount();
  ...
  function Bm() {
    process.env.NODE_ENV !== "production" && Zt(y.state.isDestroyed, pr("destroy")), !y.state.isDestroyed && (y.clearDelayTimeouts(), y.unmount(), Gi(), delete t._tippy, y.state.isDestroyed = !0, L("onDestroy", [y]));
  }
}
function ar(t, e) {
  e === void 0 && (e = {});
  var n = ot.plugins.concat(e.plugins || []);
  process.env.NODE_ENV !== "production" && (vb(t), pp(e, n)), pb();
  var r = Object.assign({}, e, {
    plugins: n
  }), i = cb(t);
  if (process.env.NODE_ENV !== "production") {
    var s = ki(r.content), o = i.length > 1;
    Zt(s && o, ["tippy() was passed an Element as the `content` prop, but more than", "one tippy instance was created by this invocation. This means the", "content element will only be appended to the last tippy instance.", `
...
class Ab {
  ...
  update(e, n) {
    ...
    (i = this.tippy) === null || i === void 0 || i.setProps({
      getReferenceClientRect: ((s = this.tippyOptions) === null || s === void 0 ? void 0 : s.getReferenceClientRect) || (() => jh(e, c, d))
    }), this.show();
  }
  show() {
    var e;
...
const Rb = qr({
  ...
  setup(t, { slots: e }) {
    ...
    return bf(() => {
      ...
      var r;
      return tn("div", { ref: n }, (r = e.default) === null || r === void 0 ? void 0 : r.call(e));
    };
  }
});
function qd(t) {
...
const _b = qr({
  ...
  setup(t) {
    ...
    return Vm(() => {
      const r = t.editor;
      r && r.options.element && e.value && zm(() => {
...
function Pb(t, e) {
  return (n) => n.editor.contentComponent ? new Lb(t, n, e) : {};
}
const Bb = /^\s*>\s$/, vp = de.create({
  name: "blockquote",
  addOptions() {
    return {
      HTMLAttributes: {}
...
}), Hb = /(?:^|\s)((?:\*\*)((?:[^*]+))(?:\*\*))$/, Fb = /(?:^|\s)((?:\*\*)((?:[^*]+))(?:\*\*))/g, Vb = /(?:^|\s)((?:__)((?:[^__]+))(?:__))$/, zb = /(?:^|\s)((?:__)((?:[^__]+))(?:__))/g, Gb = tt.create({
  name: "bold",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  dragover(e) {
    ...
    if (n && !s) {
      ...
      if (this.editorView.dragging && this.editorView.dragging.slice) {
        let l = qf(this.editorView.state.doc, o, this.editorView.dragging.slice);
        l != null && (o = l);
      }
...
function lw(t) {
  ...
  return e.className = "ProseMirror-gapcursor", se.create(t.doc, [He.widget(t.selection.head, e, { key: "gapcursor" })]);
}
const aw = be.create({
  name: "gapCursor",
  addProseMirrorPlugins() {
  ...
  extendNodeSchema(t) {
    ...
    return {
      allowGapCursor: (e = Q(F(t, "allowGapCursor", n))) !== null && e !== void 0 ? e : null
    };
  }
}), cw = de.create({
  name: "hardBreak",
...
xe.from = function(e) {
  return e instanceof xe ? e : e && e.length ? new bp(e) : xe.empty;
};
...
function mw(t, e, n, r) {
  ...
  n.getMeta(yw) && (t = new fn(t.done, t.undone, null, 0, -1));
  let o = n.getMeta("appendedTransaction");
  if (n.steps.length == 0)
    return t;
  if (o && o.getMeta(Cn))
    return o.getMeta(Cn).redo ? new fn(t.done.addTransform(n, void 0, r, Cs(e)), t.undone, Kd(n.mapping.maps[n.steps.length - 1]), t.prevTime, t.prevComposition) : new fn(t.done, t.undone.addTransform(n, void 0, r, Cs(e)), null, t.prevTime, t.prevComposition);
  if (n.getMeta("addToHistory") !== !1 && !(o && o.getMeta("addToHistory") === !1)) {
    ...
    return new fn(t.done.addTransform(n, a ? e.selection.getBookmark() : void 0, r, Cs(e)), Mt.empty, c, n.time, l ?? t.prevComposition);
  } else
    return (s = n.getMeta("rebased")) ? new fn(t.done.rebased(n, s), t.undone.rebased(n, s), pl(t.prevRanges, n.mapping), t.prevTime, t.prevComposition) : new fn(t.done.addMaps(n.mapping.maps), t.undone.addMaps(n.mapping.maps), pl(t.prevRanges, n.mapping), t.prevTime, t.prevComposition);
}
function gw(t, e) {
  if (!e)
    return !1;
...
function wp(t, e, n, r) {
  ...
  if (!o)
    return;
  let l = o.selection.resolve(o.transform.doc), a = (r ? t.done : t.undone).addTransform(o.transform, e.selection.getBookmark(), s, i), c = new fn(r ? a : o.remaining, r ? o.remaining : a, null, 0, -1);
...
function Ew(t = {}) {
  return t = {
    ...
    props: {
      handleDOMEvents: {
        beforeinput(e, n) {
          let r = n.inputType, i = r == "historyUndo" ? Tp : r == "historyRedo" ? Sp : null;
...
const Tp = (t, e) => {
  let n = Cn.getState(t);
  return !n || n.done.eventCount == 0 ? !1 : (e && wp(n, t, e, !1), !0);
}, Sp = (t, e) => {
  let n = Cn.getState(t);
  return !n || n.undone.eventCount == 0 ? !1 : (e && wp(n, t, e, !0), !0);
}, vw = be.create({
  name: "history",
  addOptions() {
    return {
  ...
  addCommands() {
    return {
      undo: () => ({ state: t, dispatch: e }) => Tp(t, e),
      redo: () => ({ state: t, dispatch: e }) => Sp(t, e)
    };
  },
  addProseMirrorPlugins() {
    return [
...
}), ww = /(?:^|\s)((?:\*)((?:[^*]+))(?:\*))$/, Tw = /(?:^|\s)((?:\*)((?:[^*]+))(?:\*))/g, Sw = /(?:^|\s)((?:_)((?:[^_]+))(?:_))$/, Iw = /(?:^|\s)((?:_)((?:[^_]+))(?:_))/g, Cw = tt.create({
  name: "italic",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  for (const n in e)
    t[n] = e[n];
  return t;
}, na = "numeric", ra = "ascii", ia = "alpha", Ms = "asciinumeric", ss = "alphanumeric", sa = "domain", Ip = "emoji", Bw = "scheme", Hw = "slashscheme", Zd = "whitespace";
function Fw(t, e) {
  return t in e || (e[t] = []), e[t];
}
function Un(t, e, n) {
  e[na] && (e[Ms] = !0, e[ss] = !0), e[ra] && (e[Ms] = !0, e[ia] = !0), e[Ms] && (e[ss] = !0), e[ia] && (e[ss] = !0), e[ss] && (e[sa] = !0), e[Ip] && (e[sa] = !0);
  for (const r in e) {
    const i = Fw(r, n);
...
Je.prototype = {
  ...
  tr(t, e, n, r) {
    r = r || Je.groups;
    let i;
    return e && e.j ? i = e : (i = new Je(e), n && r && Un(e, n, r)), this.jr.push([t, i]), i;
  },
  /**
  ...
  tt(t, e, n, r) {
    ...
    const s = e;
    let o, l = i.go(t);
    if (l ? (o = new Je(), Ur(o.j, l.j), o.jr.push.apply(o.jr, l.jr), o.jd = l.jd, o.t = l.t) : o = new Je(), s) {
      if (r)
        if (o.t && typeof o.t == "string") {
          const a = Ur(Vw(o.t, r), n);
          Un(s, a, r);
        } else
          n && Un(s, n, r);
      o.t = s;
...
const U = (t, e, n, r, i) => t.ta(e, n, r, i), dt = (t, e, n, r, i) => t.tr(e, n, r, i), eu = (t, e, n, r, i) => t.ts(e, n, r, i), N = (t, e, n, r, i) => t.tt(e, n, r, i), Jt = "WORD", oa = "UWORD", Ni = "LOCALHOST", la = "TLD", aa = "UTLD", Os = "SCHEME", vr = "SLASH_SCHEME", Za = "NUM", Cp = "WS", ec = "NL", Tr = "OPENBRACE", Ei = "OPENBRACKET", vi = "OPENANGLEBRACKET", bi = "OPENPAREN", Fn = "CLOSEBRACE", Sr = "CLOSEBRACKET", Ir = "CLOSEANGLEBRACKET", Vn = "CLOSEPAREN", Ks = "AMPERSAND", Xs = "APOSTROPHE", Js = "ASTERISK", hn = "AT", Qs = "BACKSLASH", Zs = "BACKTICK", eo = "CARET", gn = "COLON", tc = "COMMA", to = "DOLLAR", Nt = "DOT", no = "EQUALS", nc = "EXCLAMATION", Lt = "HYPHEN", ro = "PERCENT", io = "PIPE", so = "PLUS", oo = "POUND", lo = "QUERY", rc = "QUOTE", ic = "SEMI", Pt = "SLASH", wi = "TILDE", ao = "UNDERSCORE", Mp = "EMOJI", co = "SYM";
...
const mr = /[a-z]/, gl = /\p{L}/u, yl = /\p{Emoji}/u, El = /\d/, tu = /\s/, nu = `
`, zw = "️", Gw = "‍";
let ls = null, as = null;
function Uw(t) {
  t === void 0 && (t = []);
  ...
  Je.groups = e;
  const n = new Je();
  ls == null && (ls = ru(Lw)), as == null && (as = ru(Pw)), N(n, "'", Xs), N(n, "{", Tr), N(n, "[", Ei), N(n, "<", vi), N(n, "(", bi), N(n, "}", Fn), N(n, "]", Sr), N(n, ">", Ir), N(n, ")", Vn), N(n, "&", Ks), N(n, "*", Js), N(n, "@", hn), N(n, "`", Zs), N(n, "^", eo), N(n, ":", gn), N(n, ",", tc), N(n, "$", to), N(n, ".", Nt), N(n, "=", no), N(n, "!", nc), N(n, "-", Lt), N(n, "%", ro), N(n, "|", io), N(n, "+", so), N(n, "#", oo), N(n, "?", lo), N(n, '"', rc), N(n, "/", Pt), N(n, ";", ic), N(n, "~", wi), N(n, "_", ao), N(n, "\\", Qs);
  const r = dt(n, El, Za, {
    [na]: !0
  });
  dt(r, El, r);
  ...
  Un(la, {
    ...
    utld: !0,
    alpha: !0
  }, e), cn(n, "file", Os, Jt, c), cn(n, "mailto", Os, Jt, c), cn(n, "http", vr, Jt, c), cn(n, "https", vr, Jt, c), cn(n, "ftp", vr, Jt, c), cn(n, "ftps", vr, Jt, c), Un(Os, {
    scheme: !0,
    ascii: !0
  }, e), Un(vr, {
    slashscheme: !0,
  ...
  for (let u = 0; u < t.length; u++) {
    ...
    f.indexOf("-") >= 0 ? p[sa] = !0 : mr.test(f) ? El.test(f) ? p[Ms] = !0 : p[ra] = !0 : p[na] = !0, eu(n, f, f, p);
  }
...
function cn(t, e, n, r, i) {
  ...
  for (let l = 0; l < o - 1; l++) {
    const a = e[l];
    t.j[a] ? s = t.j[a] : (s = new Je(r), s.jr = i.slice(), t.j[a] = s), t = s;
  }
  return s = new Je(n), s.jr = i.slice(), t.j[e[o - 1]] = s, s;
}
function ru(t) {
  const e = [], n = [];
...
function sc(t, e) {
  e === void 0 && (e = null);
  let n = Ur({}, Li);
  t && (n = Ur(n, t instanceof sc ? t.o : t));
...
Ap.prototype = {
  ...
  */
  ...
  render(t) {
    ...
    return o.href = r, l && (o.class = l), a && (o.target = a), c && (o.rel = c), d && Ur(o, d), {
      tagName: i,
      attributes: o,
      content: s,
      eventListeners: u
...
function jw(t) {
  ...
  const n = e.domain.concat([Ks, Js, hn, Qs, Zs, eo, to, no, Lt, Za, ro, io, so, oo, Pt, co, wi, ao]), r = [Xs, Ir, Fn, Sr, Vn, gn, tc, Nt, nc, vi, Tr, Ei, bi, lo, rc, ic], i = [Ks, Xs, Js, Qs, Zs, eo, Fn, to, no, Lt, Tr, ro, io, so, oo, lo, Pt, co, wi, ao], s = Ce(), o = N(s, wi);
  U(o, i, o), U(o, e.domain, o);
  const l = Ce(), a = Ce(), c = Ce();
  U(s, e.domain, l), U(s, e.scheme, a), U(s, e.slashscheme, c), U(l, i, o), U(l, e.domain, l);
  const d = N(l, hn);
  N(o, hn, d), N(a, hn, d), N(c, hn, d);
  const u = N(o, Nt);
  ...
  const b = Ce(Ln);
  U(E, e.tld, b), U(E, e.utld, b), U(b, e.domain, l), U(b, i, o), N(b, Nt, E), N(b, Lt, v), N(b, hn, d);
  ...
  const D = N(w, Tr), V = N(w, Ei), R = N(w, vi), G = N(w, bi);
  N(C, Tr, D), N(C, Ei, V), N(C, vi, R), N(C, bi, G), N(D, Fn, w), N(V, Sr, w), N(R, Ir, w), N(G, Vn, w), N(D, Fn, w);
  const I = Ce(Ln), A = Ce(Ln), L = Ce(Ln), B = Ce(Ln);
  U(D, n, I), U(V, n, A), U(R, n, L), U(G, n, B);
  const $ = Ce(), K = Ce(), ue = Ce(), ke = Ce();
  return U(D, r), U(V, r), U(R, r), U(G, r), U(I, n, I), U(A, n, A), U(L, n, L), U(B, n, B), U(I, r, I), U(A, r, A), U(L, r, L), U(B, r, B), U($, n, $), U(K, n, A), U(ue, n, L), U(ke, n, B), U($, r, $), U(K, r, K), U(ue, r, ue), U(ke, r, ke), N(A, Sr, w), N(L, Ir, w), N(B, Vn, w), N(I, Fn, w), N(K, Sr, w), N(ue, Ir, w), N(ke, Vn, w), N($, Vn, w), N(s, Ni, b), N(s, ec, qw), {
    start: s,
    tokens: Op
  };
}
...
}), Xw = "until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.", ce = {
  scanner: null,
  parser: null,
  tokenQueue: [],
  pluginQueue: [],
...
function Jw() {
  Je.groups = {}, ce.scanner = null, ce.parser = null, ce.tokenQueue = [], ce.pluginQueue = [], ce.customSchemes = [], ce.initialized = !1;
}
function lu(t, e) {
  if (e === void 0 && (e = !1), ce.initialized && Kw(`linkifyjs: already initialized - will not register custom scheme "${t}" ${Xw}`), !/^[0-9a-z]+(-[0-9a-z]+)*$/.test(t))
    throw new Error(`linkifyjs: incorrect scheme format.
 1. Must only contain digits, lowercase ASCII letters or "-"
 2. Cannot start or end with "-"
 3. "-" cannot repeat`);
  ce.customSchemes.push([t, e]);
}
function Qw() {
  ce.scanner = Uw(ce.customSchemes);
  for (let t = 0; t < ce.tokenQueue.length; t++)
    ce.tokenQueue[t][1]({
      scanner: ce.scanner
    });
  ce.parser = jw(ce.scanner.tokens);
  for (let t = 0; t < ce.pluginQueue.length; t++)
    ce.pluginQueue[t][1]({
      scanner: ce.scanner,
      parser: ce.parser
    });
...
function Rp(t) {
  return ce.initialized || Qw(), Yw(ce.parser.start, t, $w(ce.scanner.start, t));
}
function oc(t, e, n) {
...
function Zw(t) {
  return new me({
    ...
    appendTransaction: (e, n, r) => {
      ...
      if (!i || s)
        return;
      const { tr: o } = r, l = sE(n.doc, [...e]), { mapping: a } = l;
      if (fE(l).forEach(({ oldRange: d, newRange: u }) => {
  ...
  return new me({
    ...
    props: {
      handleClick: (e, n, r) => {
        ...
        if (r.button !== 0)
          return !1;
        const l = qh(e.state, t.type.name), a = (i = r.target) === null || i === void 0 ? void 0 : i.closest("a"), c = (s = a == null ? void 0 : a.href) !== null && s !== void 0 ? s : l.href, d = (o = a == null ? void 0 : a.target) !== null && o !== void 0 ? o : l.target;
          ...
          decorations: ({ doc: t, selection: e }) => {
            ...
            return t.descendants((l, a) => {
              ...
              if ((c || !this.options.showOnlyCurrent) && d) {
                ...
                const f = He.node(a, a + l.nodeSize, {
                  class: u.join(" "),
...
var kp = class {
  ...
  map(t) {
    return new kp(t.map(this.anchor), t.map(this.head));
  }
  resolve(t) {
...
function Dp(t, e, n, r) {
  ...
  e:
    for (let o = 0, l = 0; o < s; o++) {
      ...
      r(a, n), l < i && t.child(l).sameMarkup(a) ? Dp(t.child(l), a, n + 1, r) : a.nodesBetween(0, a.content.size, r, n + 1), n += a.nodeSize;
    }
}
function Np(t, e) {
  let n;
  ...
  return e ? e.doc != t.doc && Dp(e.doc, t.doc, 0, r) : t.doc.descendants(r), n;
}
function yT(t, e, n, r) {
  const i = he.get(e);
  if (!i.problems)
...
function cs(t, e) {
  return (n, r, i) => {
    ...
    {
      const l = n.doc.resolve(o), a = xp(l, t, e);
      let c;
...
function RT(t) {
  ...
  e && e.activeHandle > -1 && !e.dragging && Pp(t, -1);
}
function xT(t, e, n) {
...
function PT(t, e) {
  ...
  for (let a = 0; a < s.height; a++) {
    ...
    if ((l == s.width || s.map[c] != s.map[c + 1]) && (a == 0 || s.map[c] != s.map[c - s.width])) {
      ...
      f.className = "column-resize-handle", n.push(He.widget(u, f));
    }
  }
...
function Bp(t, { map: e, tableStart: n, table: r }, i) {
  let s = i > 0 ? -1 : 0;
...
function FT(t, { map: e, table: n, tableStart: r }, i) {
...
function VT(t, e) {
  ...
  if (e) {
    ...
    if (n.left == 0 && n.right == n.map.width)
      return !1;
    for (let i = n.right - 1; FT(r, n, i), i != n.left; i--) {
...
function Hp(t, { map: e, tableStart: n, table: r }, i) {
  var s;
  let o = n;
  for (let c = 0; c < i; c++)
...
function KT(t) {
  return function(e, n) {
    if (!_t(e))
      return !1;
    if (n) {
      const r = Fe(e.schema), i = jt(e), s = e.tr, o = i.map.cellsInRect(
        t == "column" ? {
          left: i.left,
          top: 0,
          right: i.right,
...
function Pi(t, e) {
  return e = e || { useDeprecatedLogic: !1 }, e.useDeprecatedLogic ? KT(t) : function(n, r) {
    if (!_t(n))
      return !1;
    if (r) {
      const i = Fe(n.schema), s = jt(n), o = n.tr, l = Eu("row", s, i), a = Eu(
        "column",
        s,
        i
...
const fs = ({ editor: t }) => {
  ...
  if (!rS(e))
    return !1;
  let n = 0;
  const r = Wh(e.ranges[0].$from, (s) => s.type.name === "table");
  ...
  addCommands() {
    return {
      ...
      fixTables: () => ({ state: t, dispatch: e }) => (e && Np(t), !0),
...
const yS = function({
  ...
  const a = i.node(0), c = i.start(0), d = Vp(a, (v) => v);
  ...
  if (!n)
    return !1;
  let r = t.state.tr;
  const i = e === "DOWN", s = n.node(1) || n.nodeAfter, o = 0, l = n.node(o), a = n.start(o), c = Vp(l, (g) => g);
  let d = c.indexOf(s);
  if (d == -1)
    return !1;
  let u = i ? d + 1 : d - 1;
  ...
  addCommands() {
    return {
      setBlockWidth: (t) => ({ commands: e, view: n }) => this.options.alignments.includes(t) ? (this.options.types.forEach((r) => {
        r == Fp(n).type.name && e.updateAttributes(r, {
          blockWidth: t
        });
      }), !0) : !1,
 ...
 */
const bS = (t) => t instanceof HTMLElement, wS = (t, e = [], n = []) => {
  const r = {
    ...t
  }, i = [], s = [], o = () => ({ ...r }), l = () => {
    const p = [...i];
  ...
  t.setAttribute(e, n);
}, SS = "http://www.w3.org/2000/svg", IS = ["svg", "path"], Tu = (t) => IS.includes(t), uo = (t, e, n = {}) => {
  typeof e == "object" && (n = e, e = null);
  const r = Tu(t) ? document.createElementNS(SS, t) : document.createElement(t);
  return e && (Tu(t) ? ve(r, "class", e) : r.className = e), pe(n, (i, s) => {
    ve(r, i, s);
  }), r;
}, CS = (t) => (e, n) => {
  typeof n < "u" && t.children[n] ? t.insertBefore(e, t.children[n]) : t.appendChild(e);
}, MS = (t, e) => (n, r) => (typeof r < "u" ? e.splice(r, 0, n) : e.push(n), n), OS = (t, e) => (n) => (e.splice(e.indexOf(n), 1), n.element.parentNode && t.removeChild(n.element), n), AS = (() => typeof window < "u" && typeof window.document < "u")(), zp = () => AS, RS = zp() ? uo("svg") : {}, xS = "children" in RS ? (t) => t.children.length : (t) => t.childNodes.length, Gp = (t, e, n, r) => {
...
}, $n = (t) => typeof t == "number", _S = (t, e, n, r = 1e-3) => Math.abs(t - e) < r && Math.abs(n) < r, kS = (
  // default options
  ({ stiffness: t = 0.5, damping: e = 0.75, mass: n = 10 } = {}) => {
    ...
    const c = Mn({
      interpolate: (d, u) => {
        ...
        const f = -(i - r) * t;
        s += f / n, i += s, s *= e, _S(i, r, s) || u ? (i = r, s = 0, o = !0, c.onupdate(i), c.oncomplete(i)) : c.onupdate(i);
      },
      target: {
        set: (d) => {
...
), DS = (t) => t < 0.5 ? 2 * t * t : -1 + (4 - 2 * t) * t, NS = (
  // default values
  ({ duration: t = 500, easing: e = DS, delay: n = 0 } = {}) => {
...
}, PS = ({ mixinConfig: t, viewProps: e, viewInternalAPI: n, viewExternalAPI: r }) => {
  const i = { ...e }, s = [];
  return pe(t, (o, l) => {
    const a = LS(l);
    if (!a)
  ...
  const o = [], l = BS(s.element), a = HS(s.element);
  return r.on = (c, d) => {
    o.push({
      type: c,
      fn: d
...
}, VS = ({ mixinConfig: t, viewProps: e, viewExternalAPI: n }) => {
  ac(t, n, e);
}, Ge = (t) => t != null, zS = {
  opacity: 1,
  scaleX: 1,
  ...
  originX: 0,
  originY: 0
}, GS = ({ mixinConfig: t, viewProps: e, viewInternalAPI: n, viewExternalAPI: r, view: i }) => {
  const s = { ...e }, o = {};
  ac(t, [n, r], e);
  const l = () => [e.translateX || 0, e.translateY || 0], a = () => [e.scaleX || 0, e.scaleY || 0], c = () => i.rect ? Gp(i.rect, i.childViews, l(), a()) : null;
  return n.rect = { get: c }, r.rect = { get: c }, t.forEach((d) => {
    e[d] = typeof s[d] > "u" ? zS[d] : s[d];
  }), {
    write: () => {
      if (US(o, e))
        return $S(i.element, e), Object.assign(o, { ...e }), !0;
    },
    destroy: () => {
    }
  };
  ...
  let p = "", m = "";
  (Ge(d) || Ge(u)) && (m += `transform-origin: ${d || 0}px ${u || 0}px;`), Ge(n) && (p += `perspective(${n}px) `), (Ge(r) || Ge(i)) && (p += `translate3d(${r || 0}px, ${i || 0}px, 0) `), (Ge(s) || Ge(o)) && (p += `scale3d(${Ge(s) ? s : 1}, ${Ge(o) ? o : 1}, 1) `), Ge(c) && (p += `rotateZ(${c}rad) `), Ge(l) && (p += `rotateX(${l}rad) `), Ge(a) && (p += `rotateY(${a}rad) `), p.length && (m += `transform:${p};`), Ge(e) && (m += `opacity:${e};`, e === 0 && (m += "visibility:hidden;"), e < 1 && (m += "pointer-events:none;")), Ge(h) && (m += `height:${h}px;`), Ge(f) && (m += `width:${f}px;`);
  ...
  ({
    ...
    const y = [], T = [], w = {}, C = {}, S = [
      ...
      o
      // default destroy
    ], k = () => m, D = () => y.concat(), V = () => w, R = (X) => (oe, Te) => oe(X, Te), G = () => E || (E = Gp(v, y, [0, 0], [1, 1]), E), I = () => g, A = () => {
      E = null, y.forEach((Te) => Te._read()), !(u && v.width && v.height) && Mu(v, m, g);
      const oe = { root: ge, props: p, rect: v };
      O.forEach((Te) => Te(oe));
    }, L = (X, oe, Te) => {
      let rt = oe.length === 0;
      return S.forEach((le) => {
        ...
        le.write(X) === !1 && (rt = !1);
      }), y.filter((le) => !!le.element.parentNode).forEach((le) => {
        le._write(
          X,
          l(le, oe),
          Te
        ...
        le.element.parentNode || (ge.appendChild(le.element, St), le._read(), le._write(
          X,
          l(le, oe),
          Te
        ), rt = !1);
      ...
      appendChildView: MS(m, y),
      removeChildView: OS(m, y),
    ...
    Object.keys(f).sort((X, oe) => X === "styles" ? 1 : oe === "styles" ? -1 : 0).forEach((X) => {
      const oe = WS[X]({
        mixinConfig: f[X],
        viewProps: p,
        viewState: C,
    ...
    const Ve = xS(m);
    return y.forEach((X, oe) => {
      ge.appendChild(X.element, Ve + oe);
    }), a(ge), Mn(ue);
  }
), qS = (t, e, n = 60) => {
...
}, je = (t, e) => ({ root: n, props: r, actions: i = [], timestamp: s, shouldOptimize: o }) => {
...
}, Ou = (t, e) => e.parentNode.insertBefore(t, e), Au = (t, e) => e.parentNode.insertBefore(t, e.nextSibling), No = (t) => Array.isArray(t), sn = (t) => t == null, jS = (t) => t.trim(), Lo = (t) => "" + t, YS = (t, e = ",") => sn(t) ? [] : No(t) ? t : Lo(t).split(e).map(jS).filter((n) => n.length), Up = (t) => typeof t == "boolean", $p = (t) => Up(t) ? t : t === "true", qe = (t) => typeof t == "string", Wp = (t) => $n(t) ? t : qe(t) ? Lo(t).replace(/[a-z]+/gi, "") : 0, xs = (t) => parseInt(Wp(t), 10), Ru = (t) => parseFloat(Wp(t)), Xr = (t) => $n(t) && isFinite(t) && Math.floor(t) === t, xu = (t, e = 1e3) => {
  if (Xr(t))
    return t;
  let n = Lo(t).trim();
  return /MB$/i.test(n) ? (n = n.replace(/MB$i/, "").trim(), xs(n) * e * e) : /KB/i.test(n) ? (n = n.replace(/KB$i/, "").trim(), xs(n) * e) : xs(n);
}, Wn = (t) => typeof t == "function", KS = (t) => {
  ...
  const e = {};
  return e.url = qe(t) ? t : t.url || "", e.timeout = t.timeout ? parseInt(t.timeout, 10) : 0, e.headers = t.headers ? t.headers : {}, pe(_u, (n) => {
    e[n] = JS(n, t[n], _u[n], e.timeout, e.headers);
  }), e.process = t.process || qe(t) || t.url ? e.process : null, e.remove = t.remove || null, delete e.headers, e;
}, JS = (t, e, n, r, i) => {
  if (e === null)
    return null;
  ...
  if (qe(e))
    return s.url = e, s;
  if (Object.assign(s, e), qe(s.headers)) {
  ...
  return s.withCredentials = $p(s.withCredentials), s;
}, QS = (t) => XS(t), ZS = (t) => t === null, Ae = (t) => typeof t == "object" && t !== null, eI = (t) => Ae(t) && qe(t.url) && Ae(t.process) && Ae(t.revert) && Ae(t.restore) && Ae(t.fetch), pa = (t) => No(t) ? "array" : ZS(t) ? "null" : Xr(t) ? "int" : /^[0-9]+ ?(?:GB|MB|KB)$/gi.test(t) ? "bytes" : eI(t) ? "api" : typeof t, tI = (t) => t.replace(/{\s*'/g, '{"').replace(/'\s*}/g, '"}').replace(/'\s*:/g, '":').replace(/:\s*'/g, ':"').replace(/,\s*'/g, ',"').replace(/'\s*,/g, '",'), nI = {
  array: YS,
  boolean: $p,
  ...
  object: (t) => {
    try {
      return JSON.parse(tI(t));
    } catch {
      return null;
    }
  }
}, rI = (t, e) => nI[e](t), qp = (t, e, n) => {
  if (t === e)
    return t;
  let r = pa(t);
  if (r !== n) {
  ...
  // options
  options: sI(t)
}), Po = (t, e = "-") => t.split(/(?=[A-Z])/).map((n) => n.toLowerCase()).join(e), lI = (t, e) => {
  const n = {};
  return pe(e, (r) => {
    n[r] = {
  ...
  PASTE: 4,
  NONE: 5
}, cc = () => Math.random().toString(36).substring(2, 11), dc = (t, e) => t.splice(e, 1), dI = (t, e) => {
  ...
  const t = [], e = (r, i) => {
    ...
    t.filter((o) => o.event === r).map((o) => o.cb).forEach((o) => dI(() => o(...i), s));
  };
  return {
    fireSync: (r, ...i) => {
      n(r, i, !0);
  ...
  LIMBO: 2,
  LOCAL: 3
}, Yp = (t) => /[^0-9]+/.exec(t), Kp = () => Yp(1.1.toLocaleString())[0], hI = () => {
  const t = Kp(), e = 1e3.toLocaleString(), n = 1e3.toString();
  return e !== n ? Yp(e)[0] : t === "." ? "," : ".";
}, _ = {
  BOOLEAN: "boolean",
  INT: "int",
...
}), cr = (t, e, n) => uc.filter((r) => r.key === t).map((r) => r.cb(e, n)), pI = (t, e) => uc.push({ key: t, cb: e }), mI = (t) => Object.assign(Cr, t), fo = () => ({ ...Cr }), gI = (t) => {
  pe(t, (e, n) => {
    Cr[e] && (Cr[e][0] = qp(
      n,
      Cr[e][0],
  ...
  labelDecimalSeparator: [Kp(), _.STRING],
  // Default is locale separator
  labelThousandsSeparator: [hI(), _.STRING],
  // Default is locale separator
  labelIdle: [
...
}, qn = (t, e) => sn(e) ? t[0] || null : Xr(e) ? t[e] || null : (typeof e == "object" && (e = e.id), t.find((n) => n.id === e) || null), Xp = (t) => {
  if (sn(t))
    return t;
  if (/:/.test(t)) {
    const e = t.split(":");
...
const EI = () => {
  ...
  J.PROCESSING_QUEUED,
  J.INIT
], wI = [J.PROCESSING_COMPLETE], TI = (t) => vI.includes(t.status), SI = (t) => bI.includes(t.status), II = (t) => wI.includes(t.status), ku = (t) => Ae(t.options.server) && (Ae(t.options.server.process) || Wn(t.options.server.process)), CI = (t) => ({
  GET_STATUS: () => {
    const e = Ot(t.items), { EMPTY: n, ERROR: r, BUSY: i, IDLE: s, READY: o } = yI;
    return e.length === 0 ? n : e.some(TI) ? r : e.some(SI) ? i : e.some(II) ? o : s;
  },
  ...
  GET_PANEL_ASPECT_RATIO: () => /circle/.test(t.options.stylePanelLayout) ? 1 : Xp(t.options.stylePanelAspectRatio),
  ...
  SHOULD_UPDATE_FILE_INPUT: () => t.options.storeAsFile && EI() && !ku(t),
  IS_ASYNC: () => ku(t),
  ...
  return n === null || e < n;
}, Jp = (t, e, n) => Math.max(Math.min(n, t), e), OI = (t, e, n) => t.splice(e, 0, n), AI = (t, e, n) => sn(e) ? null : typeof n > "u" ? (t.push(e), e) : (n = Jp(n, 0, t.length), OI(t, n, e), e), ma = (t) => /^\s*data:([a-z]+\/[a-z0-9-+.]+(;[a-z-]+=[a-z0-9-]+)?)?(;base64)?,([a-z0-9!$&',()*+;=\-._~:@\/?%\s]*)\s*$/i.test(
  t
), zi = (t) => t.split("/").pop().split("?").shift(), Ho = (t) => t.split(".").pop(), RI = (t) => {
  if (typeof t != "string")
    return "";
  const e = t.split("/").pop();
  return /svg/.test(e) ? "svg" : /zip|compressed/.test(e) ? "zip" : /plain/.test(e) ? "txt" : /msword/.test(e) ? "doc" : /[a-z]+/.test(e) ? e === "jpeg" ? "jpg" : e : "";
}, si = (t, e = "") => (e + t).slice(-e.length), Qp = (t = /* @__PURE__ */ new Date()) => `${t.getFullYear()}-${si(t.getMonth() + 1, "00")}-${si(
  t.getDate(),
  "00"
  ...
  return i.lastModifiedDate = /* @__PURE__ */ new Date(), t._relativePath && (i._relativePath = t._relativePath), qe(e) || (e = Qp()), e && r === null && Ho(e) ? i.name = e : (r = r || RI(i.type), i.name = e + (r ? "." + r : "")), i;
}, xI = () => window.BlobBuilder = window.BlobBuilder || window.WebKitBlobBuilder || window.MozBlobBuilder || window.MSBlobBuilder, Zp = (t, e) => {
  const n = xI();
  if (n) {
    const r = new n();
  ...
  for (let i = 0; i < t.length; i++)
    r[i] = t.charCodeAt(i);
  return Zp(n, e);
}, em = (t) => (/^data:(.+);/.exec(t) || [])[1] || null, kI = (t) => t.split(",")[1].replace(/\s/g, ""), DI = (t) => atob(kI(t)), NI = (t) => {
  const e = em(t), n = DI(t);
  return _I(n, e);
}, LI = (t, e, n) => $r(NI(t), e, null, n), PI = (t) => {
  ...
  return null;
}, HI = (t) => /x-content-transfer-id:/i.test(t) && (t.split(":")[1] || "").trim() || null, fc = (t) => {
  const e = {
    source: null,
    name: null,
    size: null
...
`);
  ...
  const e = {
    ...
    const l = e.source;
    o.fire("init", l), l instanceof File ? o.fire("load", l) : l instanceof Blob ? o.fire("load", $r(l, l.name)) : ma(l) ? o.fire("load", LI(l)) : s(l);
  }, s = (l) => {
    if (!t) {
      o.fire("error", {
        type: "error",
    ...
    e.timestamp = Date.now(), e.request = t(
      l,
      (a) => {
        e.duration = Date.now() - e.timestamp, e.complete = !0, a instanceof Blob && (a = $r(a, a.name || zi(l))), o.fire(
          "load",
    ...
    return d.onload = (u) => {
      ...
      s(
        ye(
          "load",
          u.status,
          e.method === "HEAD" ? null : $r(n(u.response), h),
          f
        )
      );
    }, d.onerror = (u) => {
  ...
  const C = () => s(g.serverId), S = (R) => R.status === ut.QUEUED || R.status === ut.ERROR, O = (R) => {
    if (g.aborted)
      return;
    if (R = R || u.find(S), !R) {
      u.every(($) => $.status === ut.COMPLETE) && C();
      return;
    }
    R.status = ut.PROCESSING, R.progress = null;
    ...
    B.onload = () => {
      R.status = ut.COMPLETE, R.request = null, D();
    }, B.onprogress = ($, K, ue) => {
      R.progress = $ ? K : null, k();
    }, B.onerror = ($) => {
      R.status = ut.ERROR, R.request = null, R.error = I($.response) || $.statusText, P(R) || o(
        ye(
          "error",
          $.status,
      ...
      R.status = ut.ERROR, R.request = null, P(R) || er(o)($);
    }, B.onabort = () => {
      R.status = ut.QUEUED, R.request = null, a();
    };
  }, P = (R) => R.retries.length === 0 ? !1 : (R.status = ut.WAITING, clearTimeout(R.timeout), R.timeout = setTimeout(() => {
    O(R);
  }, R.retries.shift()), !0), k = () => {
    ...
    u.filter((G) => G.status === ut.PROCESSING).length >= 1 || O();
  }, V = () => {
    u.forEach((R) => {
  ...
  return g.serverId ? T((R) => {
    g.aborted || (u.filter((G) => G.offset < R).forEach((G) => {
      G.status = ut.COMPLETE, G.progress = G.size;
    }), D());
  }) : y((R) => {
...
}, GI = (t = "", e, n, r) => typeof e == "function" ? (...i) => e(n, ...i, r) : !e || !qe(e.url) ? null : zI(t, e, n, r), oi = (t = "", e) => {
  if (typeof e == "function")
    return e;
  if (!e || !qe(e.url))
    return (i, s) => s();
...
}, tm = (t = 0, e = 1) => t + Math.random() * (e - t), UI = (t, e = 1e3, n = 0, r = 25, i = 250) => {
  let s = null;
  const o = Date.now(), l = () => {
    let a = Date.now() - o, c = tm(r, i);
    a + c > e && (c = a + c - e);
    let d = a / e;
  ...
  const n = {
    ...
    c.fire("start"), n.timestamp = Date.now(), n.perceivedPerformanceUpdater = UI(
      (p) => {
  ...
  return c;
}, nm = (t) => t.substring(0, t.lastIndexOf(".")) || t, WI = (t) => {
  let e = [t.name, t.size, t.type];
  return t instanceof Blob || ma(t) ? e[0] = t.name || Qp() : ma(t) ? (e[1] = t.length, e[2] = em(t)) : qe(t) && (e[0] = zi(t), e[1] = 0, e[2] = "application/octet-stream"), {
    name: e[0],
    size: e[1],
    type: e[2]
  };
}, Wr = (t) => !!(t instanceof File || t instanceof Blob && t.name), rm = (t) => {
  if (!Ae(t))
    return t;
  const e = No(t) ? [] : {};
  for (const n in t) {
  ...
  const o = {}, l = (S) => i.status = S, a = (S, ...O) => {
    ...
    i.file = WI(S), O.on("init", () => {
      ...
      i.activeLoader = null;
      const D = (R) => {
        i.file = Wr(R) ? R : i.file, t === Me.LIMBO && i.serverFileReference ? l(J.PROCESSING_COMPLETE) : l(J.IDLE), a("load");
      }, V = (R) => {
    ...
    S(
      ...
      (V) => {
        ...
        l(J.PROCESSING_REVERT_ERROR), a("process-revert-error"), k(V);
      }
    ), l(J.IDLE), a("process-revert");
  }), y = (S, O, P) => {
    const k = S.split("."), D = k[0], V = k.pop();
    let R = o;
    k.forEach((G) => R = R[G]), JSON.stringify(R[V]) !== JSON.stringify(O) && (R[V] = O, a("metadata-update", {
      key: D,
      value: o[D],
      silent: P
    }));
    ...
    filenameWithoutExtension: { get: () => nm(i.file.name) },
    fileExtension: { get: c },
    fileType: { get: d },
    fileSize: { get: u },
    file: { get: f },
  ...
  return C;
}, jI = (t, e) => sn(e) ? 0 : qe(e) ? t.findIndex((n) => n.id === e) : -1, Lu = (t, e) => {
  const n = jI(t, e);
  if (!(n < 0))
    return t[n] || null;
}, Pu = (t, e, n, r, i, s) => {
  ...
  return o.onload = (l) => {
    ...
    e(ye("load", l.status, $r(l.response, c), a));
  }, o.onerror = (l) => {
...
}, Bu = (t) => (t.indexOf("//") === 0 && (t = location.protocol + t), t.toLowerCase().replace("blob:", "").replace(/([a-z])?:\/\//, "$1").split("/")[0]), YI = (t) => (t.indexOf(":") > -1 || t.indexOf("//") > -1) && Bu(location.href) !== Bu(t), ps = (t) => (...e) => Wn(t) ? t(...e) : t, KI = (t) => !Wr(t.file), Tl = (t, e) => {
  ...
  MOVE_ITEM: ({ query: r, index: i }) => {
    ...
    i = Jp(i, 0, n.items.length - 1), o !== i && n.items.splice(i, 0, n.items.splice(o, 1)[0]);
  },
  SORT: ({ compare: r }) => {
  ...
  ADD_ITEMS: ({ items: r, index: i, interactionMethod: s, success: o = () => {
    ...
    const c = e("GET_IGNORED_FILES"), d = (h) => Wr(h) ? !c.includes(h.name.toLowerCase()) : !sn(h), f = r.filter(d).map(
      (h) => new Promise((p, m) => {
        t("ADD_ITEM", {
          interactionMethod: s,
          source: h.source || h,
  ...
  ADD_ITEM: ({
    ...
    if (Wr(r) && n.options.ignoredFiles.includes(r.name.toLowerCase()))
      return;
    if (!MI(n)) {
    ...
    }), cr("DID_CREATE_ITEM", d, { query: e, dispatch: t });
    const u = e("GET_ITEM_INSERT_LOCATION");
    n.options.itemInsertLocationFreedom || (i = u === "before" ? -1 : n.items.length), AI(n.items, d, i), Wn(u) && r && Sl(n, u);
    const f = d.id;
    d.on("init", () => {
      ...
      It("DID_LOAD_ITEM", d, { query: e, dispatch: t }).then(() => {
        Hu(e("GET_BEFORE_ADD_FILE"), Ke(d)).then(
          v
        );
      }).catch((E) => {
  ...
  RETRY_ITEM_LOAD: ft(n, (r) => {
    r.retryLoad();
  }),
  REQUEST_ITEM_PREPARE: ft(n, (r, i, s) => {
    t(
      "REQUEST_PREPARE_OUTPUT",
      {
        query: r.id,
  ...
  REQUEST_ITEM_PROCESSING: ft(n, (r, i, s) => {
  ...
  PROCESS_ITEM: ft(n, (r, i, s) => {
    ...
    r.onOnce("process-complete", () => {
      ...
      s({ error: d, file: Ke(r) }), a();
    });
    const c = n.options;
    r.process(
      $I(
        GI(c.server.url, c.server.process, c.name, {
  ...
  RETRY_ITEM_PROCESSING: ft(n, (r) => {
    t("REQUEST_ITEM_PROCESSING", { query: r });
  }),
  REQUEST_REMOVE_ITEM: ft(n, (r) => {
    Hu(e("GET_BEFORE_REMOVE_FILE"), Ke(r)).then((i) => {
  ...
  REMOVE_ITEM: ft(n, (r, i, s, o) => {
    const l = () => {
      const c = r.id;
      Lu(n.items, c).archive(), t("DID_REMOVE_ITEM", { error: null, id: c, item: r }), Tl(t, n), i(Ke(r));
    }, a = n.options.server;
  ...
  ABORT_ITEM_LOAD: ft(n, (r) => {
    r.abortLoad();
  }),
  ABORT_ITEM_PROCESSING: ft(n, (r) => {
    if (r.serverId) {
  ...
  REQUEST_REVERT_ITEM_PROCESSING: ft(n, (r) => {
  ...
  REVERT_ITEM_PROCESSING: ft(n, (r) => {
    r.revert(
      oi(n.options.server.url, n.options.server.revert),
      e("GET_FORCE_REVERT")
    ).then(() => {
      (n.options.instantUpload || KI(r)) && t("REMOVE_ITEM", { query: r.id });
    }).catch(() => {
    });
  }),
  SET_OPTIONS: ({ options: r }) => {
    const i = Object.keys(r), s = JI.filter((l) => i.includes(l));
    [
...
], hc = (t) => t, on = (t) => document.createElement(t), Ee = (t, e) => {
  ...
  const o = Fu(t, e, n, i), l = Fu(t, e, n, r);
  return ["M", o.x, o.y, "A", n, n, 0, s, 0, l.x, l.y].join(" ");
}, ZI = (t, e, n, r, i) => {
  let s = 1;
  return i > r && i - r <= 0.5 && (s = 0), r > i && r - i >= 0.5 && (s = 0), QI(
    t,
    e,
    n,
...
}, zu = (t, e, n) => t.toFixed(e).split(".").filter((r) => r !== "0").join(n), iC = ({ root: t, props: e }) => {
  const n = on("span");
...
}), om = (t) => Math.round(t * 100), oC = ({ root: t }) => {
  const e = on("span");
  e.className = "filepond--file-status-main", t.appendChild(e), t.ref.main = e;
  const n = on("span");
  n.className = "filepond--file-status-sub", t.appendChild(n), t.ref.sub = n, lm({ root: t, action: { progress: null } });
}, lm = ({ root: t, action: e }) => {
  const n = e.progress === null ? t.query("GET_LABEL_FILE_LOADING") : `${t.query("GET_LABEL_FILE_LOADING")} ${om(e.progress)}%`;
  Ee(t.ref.main, n), Ee(t.ref.sub, t.query("GET_LABEL_TAP_TO_CANCEL"));
}, lC = ({ root: t, action: e }) => {
  const n = e.progress === null ? t.query("GET_LABEL_FILE_PROCESSING") : `${t.query("GET_LABEL_FILE_PROCESSING")} ${om(e.progress)}%`;
  Ee(t.ref.main, n), Ee(t.ref.sub, t.query("GET_LABEL_TAP_TO_CANCEL"));
}, aC = ({ root: t }) => {
  ...
  write: je({
    ...
    DID_ABORT_ITEM_PROCESSING: cC,
    DID_COMPLETE_ITEM_PROCESSING: dC,
    DID_UPDATE_ITEM_PROCESS_PROGRESS: lC,
    DID_UPDATE_ITEM_LOAD_PROGRESS: lm,
...
const it = (t) => {
...
}, fC = (t) => t.ref.buttonAbortItemLoad.rect.element.width, ms = (t) => Math.floor(t.ref.buttonRemoveItem.rect.element.height / 4), hC = (t) => Math.floor(t.ref.buttonRemoveItem.rect.element.left / 2), pC = (t) => t.query("GET_STYLE_LOAD_INDICATOR_POSITION"), mC = (t) => t.query("GET_STYLE_PROGRESS_INDICATOR_POSITION"), va = (t) => t.query("GET_STYLE_BUTTON_REMOVE_ITEM_POSITION"), gC = {
  ...
  DID_THROW_ITEM_REMOVE_ERROR: {
    ...
    buttonRemoveItem: { opacity: 1 },
    info: { translateX: it },
    status: { opacity: 1, translateX: it }
  },
  DID_LOAD_ITEM: $u,
  DID_LOAD_LOCAL_ITEM: {
    buttonRemoveItem: { opacity: 1 },
  ...
  if (l && i && (n.RevertItemProcessing.label = "GET_LABEL_BUTTON_REMOVE_ITEM", n.RevertItemProcessing.icon = "GET_ICON_REMOVE"), a && !i) {
    const p = Mr.DID_COMPLETE_ITEM_PROCESSING;
    p.info.translateX = hC, p.info.translateY = ms, p.status.translateY = ms, p.processingCompleteIndicator = { opacity: 1, scaleX: 1, scaleY: 1 };
  }
  if (a && !o && ([
    ...
    Mr[p].status.translateY = ms;
  }), Mr.DID_THROW_ITEM_PROCESSING_ERROR.status.translateX = fC), c && i) {
    n.RevertItemProcessing.align = "BUTTON_REMOVE_ITEM_POSITION";
    const p = Mr.DID_COMPLETE_ITEM_PROCESSING;
    p.info.translateX = it, p.status.translateY = ms, p.processingCompleteIndicator = { opacity: 1, scaleX: 1, scaleY: 1 };
  }
  s || (n.RemoveItem.disabled = !0), pe(n, (p, m) => {
    const g = t.createChildView(im, {
    ...
    t.createChildView(yC)
  ), t.ref.processingCompleteIndicator.element.dataset.align = t.query(
    "GET_STYLE_BUTTON_PROCESS_ITEM_POSITION"
  ), t.ref.info = t.appendChildView(t.createChildView(sC, { id: r })), t.ref.status = t.appendChildView(t.createChildView(uC, { id: r }));
  const f = t.appendChildView(
    t.createChildView(Vu, {
      opacity: 0,
...
}, vC = ({ root: t, actions: e, props: n }) => {
  bC({ root: t, actions: e, props: n });
  let r = e.concat().filter((i) => /^DID_/.test(i.type)).reverse().find((i) => Mr[i.type]);
  if (r) {
    t.ref.activeStyles = [];
    const i = Mr[r.type];
    pe(gC, (s, o) => {
  ...
  t.ref.fileName = on("legend"), t.appendChild(t.ref.fileName), t.ref.file = t.appendChildView(t.createChildView(wC, { id: e.id })), t.ref.data = !1;
}, SC = ({ root: t, props: e }) => {
  Ee(t.ref.fileName, hc(t.query("GET_ITEM_NAME", e.id)));
}, IC = we({
  create: TC,
  ...
  tag: "fieldset",
  name: "file-wrapper"
}), Wu = { type: "spring", damping: 0.6, mass: 7 }, CC = ({ root: t, props: e }) => {
  [
    {
      name: "top"
    },
  ...
  if ((t.ref.scalable === null || e.scalable !== t.ref.scalable) && (t.ref.scalable = Up(e.scalable) ? e.scalable : !0, t.element.dataset.scalable = t.ref.scalable), !e.height)
    return;
  ...
  if (t.ref.handleClick = (r) => t.dispatch("DID_ACTIVATE_ITEM", { id: e.id }), t.element.id = `filepond--item-${e.id}`, t.element.addEventListener("click", t.ref.handleClick), t.ref.container = t.appendChildView(t.createChildView(IC, { id: e.id })), t.ref.panel = t.appendChildView(t.createChildView(am, { name: "item-panel" })), t.ref.panel.height = null, e.markedForRemoval = !1, !t.query("GET_ALLOW_REORDER"))
    return;
  ...
  const n = (r) => {
    ...
    const o = AC(t.query("GET_ACTIVE_ITEMS"));
  ...
  ({ root: t, actions: e, props: n, shouldOptimize: r }) => {
    ...
    s ? r || (t.height = t.rect.element.width * s) : (xC({ root: t, actions: e, props: n }), !t.height && t.ref.container.rect.element.height > 0 && (t.height = t.ref.container.rect.element.height)), r && (t.ref.panel.height = null), t.ref.panel.height = t.height;
  }
), kC = we({
  create: RC,
  write: _C,
...
const mc = (t, e, n) => {
  ...
  t.dragOffset ? (t.translateX = null, t.translateY = null, t.translateX = t.dragOrigin.x + t.dragOffset.x, t.translateY = t.dragOrigin.y + t.dragOffset.y, t.scaleX = 1.025, t.scaleY = 1.025) : (t.translateX = e, t.translateY = n, Date.now() > t.spawnDate && (t.opacity === 0 && LC(t, e, n, r, i), t.scaleX = 1, t.scaleY = 1, t.opacity = 1));
}, LC = (t, e, n, r, i) => {
...
}, Cl = (t) => t.rect.element.height + t.rect.element.marginBottom * 0.5 + t.rect.element.marginTop * 0.5, BC = (t) => t.rect.element.width + t.rect.element.marginLeft * 0.5 + t.rect.element.marginRight * 0.5, HC = ({ root: t, action: e }) => {
  ...
  DID_REMOVE_ITEM: PC,
  DID_DRAG_ITEM: HC
}), VC = ({ root: t, props: e, actions: n, shouldOptimize: r }) => {
  FC({ root: t, props: e, actions: n });
  ...
  if (E === 1) {
    ...
    l.forEach((T, w) => {
      ...
      const C = w + f + d + u, S = C % E, O = Math.floor(C / E), P = S * g, k = O * v, D = Math.sign(P - b), V = Math.sign(k - y);
      b = P, y = k, !T.markedForRemoval && (r && (T.translateX = null, T.translateY = null), Ku(T, P, k, D, V));
    });
  }
}, zC = (t, e) => e.filter((n) => n.data && n.data.id ? t.id === n.data.id : !0), GC = we({
  create: DC,
  write: VC,
  tag: "ul",
  name: "list",
  ...
  filterFrameActionsForChild: zC,
  mixins: {
    apis: ["dragCoordinates"]
  }
}), UC = ({ root: t, props: e }) => {
  t.ref.list = t.appendChildView(t.createChildView(GC)), e.dragCoordinates = null, e.overflowing = !1;
}, $C = ({ root: t, props: e, action: n }) => {
  ...
  if (!(!t || t.value === "")) {
    ...
    if (t.value) {
      const e = on("form"), n = t.parentNode, r = t.nextSibling;
      e.appendChild(t), e.reset(), r ? n.insertBefore(t, r) : n.appendChild(t);
    }
  }
}, XC = ({ root: t, props: e }) => {
  t.element.id = `filepond--browser-${e.id}`, ve(t.element, "name", t.query("GET_NAME")), ve(t.element, "aria-controls", `filepond--assistant-${e.id}`), ve(t.element, "aria-labelledby", `filepond--drop-label-${e.id}`), cm({ root: t, action: { value: t.query("GET_ACCEPTED_FILE_TYPES") } }), dm({ root: t, action: { value: t.query("GET_ALLOW_MULTIPLE") } }), um({ root: t, action: { value: t.query("GET_ALLOW_DIRECTORIES_ONLY") } }), ba({ root: t }), fm({ root: t, action: { value: t.query("GET_REQUIRED") } }), hm({ root: t, action: { value: t.query("GET_CAPTURE_METHOD") } }), t.ref.handleChange = (n) => {
    if (!t.element.value)
      return;
    const r = Array.from(t.element.files).map((i) => (i._relativePath = i.webkitRelativePath, i));
    setTimeout(() => {
      e.onload(r), KC(t.element);
    }, 250);
  ...
  write: je({
    ...
    DID_SET_ALLOW_DIRECTORIES_ONLY: um,
    DID_SET_ALLOW_MULTIPLE: dm,
    DID_SET_ACCEPTED_FILE_TYPES: cm,
    DID_SET_CAPTURE_METHOD: hm,
    DID_SET_REQUIRED: fm
  })
}), Ju = {
  ENTER: 13,
  ...
  }, n.addEventListener("keydown", t.ref.handleKeyDown), t.element.addEventListener("click", t.ref.handleClick), pm(n, e.caption), t.appendChild(n), t.ref.label = n;
}, pm = (t, e) => {
  t.innerHTML = e;
...
}, oM = ({ root: t, props: e, actions: n }) => {
  lM({ root: t, props: e, actions: n });
  const { blob: r } = t.ref;
  ...
  return !0;
}, cM = ({ root: t }) => t.ref.fields = {}, Fo = (t, e) => t.ref.fields[e], gc = (t) => {
  t.query("GET_ACTIVE_ITEMS").forEach((e) => {
    t.ref.fields[e.id] && t.element.appendChild(t.ref.fields[e.id]);
  });
}, Qu = ({ root: t }) => gc(t), dM = ({ root: t, action: e }) => {
  const i = !(t.query("GET_ITEM", e.id).origin === Me.LOCAL) && t.query("SHOULD_UPDATE_FILE_INPUT"), s = on("input");
  ...
  write: gM,
  ignoreRect: !0
}), EM = (t) => "getRootNode" in t ? t.getRootNode() : document, vM = ["jpg", "jpeg", "png", "gif", "bmp", "webp", "svg", "tiff"], bM = ["css", "csv", "html", "txt"], wM = {
  zip: "zip|compressed",
  epub: "application/epub+zip"
}, gm = (t = "") => (t = t.toLowerCase(), vM.includes(t) ? "image/" + (t === "jpg" ? "jpeg" : t === "svg" ? "svg+xml" : t) : bM.includes(t) ? "text/" + t : wM[t] || ""), yc = (t) => new Promise((e, n) => {
  const r = RM(t);
  if (r.length && !TM(t))
    return e(r);
  SM(t).then(e);
}), TM = (t) => t.files ? t.files.length > 0 : !1, SM = (t) => new Promise((e, n) => {
  const r = (t.items ? Array.from(t.items) : []).filter((i) => IM(i)).map((i) => CM(i));
  if (!r.length) {
  ...
  return t.kind === "file";
}, CM = (t) => new Promise((e, n) => {
  if (AM(t)) {
    MM(Ec(t)).then(e).catch(n);
    return;
  }
  e([t.getAsFile()]);
}), MM = (t) => new Promise((e, n) => {
  const r = [];
  let i = 0, s = 0;
  const o = () => {
    s === 0 && i === 0 && e(r);
  ...
  if (t.type.length)
    return t;
  const e = t.lastModifiedDate, n = t.name, r = gm(Ho(t.name));
  return r.length && (t = t.slice(0, t.size, r), t.name = n, t.lastModifiedDate = e), t;
}, AM = (t) => ym(t) && (Ec(t) || {}).isDirectory, ym = (t) => "webkitGetAsEntry" in t, Ec = (t) => t.webkitGetAsEntry(), RM = (t) => {
  let e = [];
  try {
    if (e = _M(t), e.length)
      return e;
  ...
  return i;
}, LM = (t, e) => ("elementFromPoint" in t || (t = document), t.elementFromPoint(e.x, e.y)), vc = (t, e) => {
  const n = EM(e), r = LM(n, {
...
const ys = (t, e) => {
  ...
  n.preventDefault(), Em = n.target, e.forEach((r) => {
  ...
  Em === n.target && e.forEach((r) => {
    const { onexit: i } = r;
    r.state = null, i(tr(n));
  });
}, VM = (t, e, n) => {
  t.classList.add("filepond--hopper");
  const { catchesDropsOnPage: r, requiresDropOnElement: i, filterItems: s = (d) => d } = n, o = kM(
    t,
...
const kr = [], vm = (t) => {
  ...
  yc(t.clipboardData).then((n) => {
    n.length && kr.forEach((r) => r(n));
  });
}, zM = (t) => {
  kr.includes(t) || (kr.push(t), !wa && (wa = !0, document.addEventListener("paste", vm)));
}, GM = (t) => {
  dc(kr, kr.indexOf(t)), kr.length === 0 && (document.removeEventListener("paste", vm), wa = !1);
}, UM = () => {
  const t = (n) => {
    e.onload(n);
  }, e = {
...
const Ml = [], Vo = (t, e) => {
...
}, wm = (t) => t.element.parentNode.contains(document.activeElement), qM = ({ root: t, action: e }) => {
  if (!wm(t))
    return;
  t.element.textContent = "";
  const n = t.query("GET_ITEM", e.id);
  Ml.push(n.filename), clearTimeout(Zu), Zu = setTimeout(() => {
    bm(t, Ml.join(", "), t.query("GET_LABEL_FILE_ADDED")), Ml.length = 0;
  }, 750);
}, jM = ({ root: t, action: e }) => {
  if (!wm(t))
    return;
  const n = e.item;
  bm(t, n.filename, t.query("GET_LABEL_FILE_REMOVED"));
}, YM = ({ root: t, action: e }) => {
  ...
  Vo(t, `${e.status.main} ${r} ${e.status.sub}`);
}, KM = we({
  create: $M,
  ignoreRect: !0,
  ignoreRectUpdate: !0,
  write: je({
    DID_LOAD_ITEM: qM,
    DID_REMOVE_ITEM: jM,
    DID_COMPLETE_ITEM_PROCESSING: YM,
  ...
  tag: "span",
  name: "assistant"
}), Tm = (t, e = "-") => t.replace(new RegExp(`${e}.`, "g"), (n) => n.charAt(1).toUpperCase()), Sm = (t, e = 16, n = !0) => {
...
}, XM = 1e6, po = (t) => t.preventDefault(), JM = ({ root: t, props: e }) => {
  ...
  r && r.split(" ").filter((a) => a.length).forEach((a) => {
    ...
    t.createChildView(eM, {
      ...e,
      translateY: null,
      caption: t.query("GET_LABEL_IDLE")
    })
  ), t.ref.list = t.appendChildView(t.createChildView(YC, { translateY: null })), t.ref.panel = t.appendChildView(t.createChildView(am, { name: "panel-root" })), t.ref.assistant = t.appendChildView(t.createChildView(KM, { ...e })), t.ref.data = t.appendChildView(t.createChildView(yM, { ...e })), t.ref.measure = on("div"), t.ref.measure.style.height = "100%", t.element.appendChild(t.ref.measure), t.ref.bounds = null, t.query("GET_STYLES").filter((a) => !sn(a.value)).map(({ name: a, value: c }) => {
    t.element.dataset[a] = c;
  }), t.ref.widthPrevious = null, t.ref.widthUpdated = Sm(() => {
...
}, QM = ({ root: t, props: e, actions: n }) => {
  if (rO({ root: t, props: e, actions: n }), n.filter((w) => /^DID_SET_STYLE_/.test(w.type)).filter((w) => !sn(w.data.value)).map(({ type: w, data: C }) => {
    const S = Tm(w.substring(8).toLowerCase(), "_");
  ...
  let r = t.ref.bounds;
  r || (r = t.ref.bounds = tO(t), t.element.removeChild(t.ref.measure), t.ref.measure = null);
  const { hopper: i, label: s, list: o, panel: l } = t.ref;
  i && i.updateHopperState();
  const a = t.query("GET_PANEL_ASPECT_RATIO"), c = t.query("GET_ALLOW_MULTIPLE"), d = t.query("GET_TOTAL_ITEMS"), u = c ? t.query("GET_MAX_FILES") || XM : 1, f = d === u, h = n.find((w) => w.type === "DID_ADD_ITEM");
  if (f && h) {
  ...
  const p = ZM(t), m = eO(t), g = s.rect.element.height, v = !c || f ? 0 : g, E = f ? o.rect.element.marginTop : 0, b = d === 0 ? 0 : o.rect.element.marginBottom, y = v + E + m.visual + b, T = v + E + m.bounds + b;
  ...
  if (r && !t.ref.hopper) {
    const i = VM(
      ...
      },
      {
        filterItems: (s) => {
          ...
          return s.filter((l) => Wr(l) ? !o.includes(l.name.toLowerCase()) : !0);
        },
    ...
    }, t.ref.hopper = i, t.ref.drip = t.appendChildView(t.createChildView(aM));
  } else
  ...
  r && !t.ref.paster ? (t.ref.paster = UM(), t.ref.paster.onload = (i) => {
  ...
  const p = {
    ...
    _write: (I) => {
      ...
      f && !A.length || (E(A), f = u._write(I, A, l), fI(r.query("GET_ITEMS")), f && r.processDispatchQueue());
    }
  }, m = (I) => (A) => {
    const L = {
      type: I
    ...
    return A.items && (L.items = A.items.map(Ke)), /progress/.test(I) && (L.progress = A.progress), A.hasOwnProperty("origin") && A.hasOwnProperty("target") && (L.origin = A.origin, L.target = A.target), L;
  }, g = {
...
}, oO = (t) => t.charAt(0).toLowerCase() + t.slice(1), lO = (t) => Tm(t.replace(/^data-/, "")), Cm = (t, e) => {
  pe(e, (n, r) => {
    pe(t, (i, s) => {
      ...
      const a = r.group;
      Ae(r) && !t[a] && (t[a] = {}), t[a][oO(i.replace(o, ""))] = s;
    }), r.mapping && Cm(t[r.group], r.mapping);
  });
}, aO = (t, e = {}) => {
  const n = [];
  pe(t.attributes, (i) => {
  ...
  const r = n.filter((i) => i.name).reduce((i, s) => {
    const o = ve(t, s.name);
    return i[lO(s.name)] = o === s.name ? !0 : o, i;
  }, {});
  return Cm(r, e), r;
}, cO = (t, e = {}) => {
  const n = {
  ...
  cr("SET_ATTRIBUTE_TO_OPTION_MAP", n);
  const r = {
    ...e
  }, i = aO(
...
}, dO = (...t) => bS(t[0]) ? cO(...t) : Im(...t), uO = ["fire", "_read", "_write"], of = (t) => {
  const e = {};
  return jp(t, e, uO), e;
}, fO = (t, e) => t.replace(/(?:{([a-zA-Z]+)})/g, (n, r) => e[r]), hO = (t) => {
  ...
  const e = t({
    ...
    utils: {
      ...
      isString: qe,
      isFile: Wr,
      toNaturalFileSize: sm,
      replaceInString: fO,
      getExtensionFromFilename: Ho,
      getFilenameWithoutExtension: nm,
      guesstimateMimeType: gm,
      getFileFromBlob: $r,
      ...
      applyFilterChain: It,
      text: Ee,
      getNumericAspectRatioFromString: Xp
    },
    views: {
      fileActionButton: im
    }
  ...
  mI(e.options);
}, yO = () => Object.prototype.toString.call(window.operamini) === "[object OperaMini]", EO = () => "Promise" in window, vO = () => "slice" in Blob.prototype, bO = () => "URL" in window && "createObjectURL" in window.URL, wO = () => "visibilityState" in document, TO = () => "performance" in window, SO = () => "supports" in (window.CSS || {}), IO = () => /MSIE|Trident/.test(window.navigator.userAgent), Ta = (() => {
  const t = (
    // Has to be a browser
    zp() && // Can't run on Opera Mini due to lack of everything
    !yO() && // Require these APIs to feature detect a modern browser
    wO() && EO() && vO() && bO() && TO() && // doesn't need CSSSupports but is a good way to detect Safari 9+ (we do want to support IE11 though)
    (SO() || IO())
  );
  return () => t;
})(), dn = {
...
let mo = {}, _s = dr, Ol = dr, af = dr, cf = dr, Sa = dr, df = dr, uf = dr;
if (Ta()) {
  qS(
    () => {
      dn.apps.forEach((n) => n._read());
    },
    (n) => {
      dn.apps.forEach((r) => r._write(n));
    }
  );
  const t = () => {
  ...
  mo = {}, e(), _s = (...n) => {
    const r = dO(...n);
    return r.on("destroy", Ol), dn.apps.push(r), of(r);
  }, Ol = (n) => {
    const r = dn.apps.findIndex((i) => i.isAttachedTo(n));
    return r >= 0 ? (dn.apps.splice(r, 1)[0].restoreElement(), !0) : !1;
  }, af = (n) => Array.from(n.querySelectorAll(`.${CO}`)).filter(
    (s) => !dn.apps.find((o) => o.isAttachedTo(s))
  ).map((s) => _s(s)), cf = (n) => {
    const r = dn.apps.find((i) => i.isAttachedTo(n));
    return r ? of(r) : null;
  }, Sa = (...n) => {
    n.forEach(gO), e();
  }, df = () => {
  ...
  return {
    ...
    mounted() {
      ...
      Object.keys(vs).forEach((r) => {
        ...
        this._element,
        Object.assign({}, RO, e, n)
      ), Object.keys(this._pond).filter((r) => !MO.includes(r)).forEach((r) => {
        this[r] = this._pond[r];
      }), Rl.push(this._pond);
    },
...
}, _O = typeof window < "u" && typeof window.document < "u";
_O && document.dispatchEvent(
  new CustomEvent("FilePond:pluginloaded", { detail: Om })
);
/*!
 ...
 * Please visit https://pqina.nl/filepond/ for details.
 */
const kO = (t) => /^image/.test(t.type), ff = (t, e) => Bi(t.x * e, t.y * e), hf = (t, e) => Bi(t.x + e.x, t.y + e.y), DO = (t) => {
...
}, Bi = (t = 0, e = 0) => ({ x: t, y: e }), Xe = (t, e, n = 1, r) => {
  if (typeof t == "string")
    return parseFloat(t) * n;
  if (typeof t == "number")
    return t * (r ? e[r] : Math.min(e.width, e.height));
}, NO = (t, e, n) => {
  const r = t.borderStyle || t.lineStyle || "solid", i = t.backgroundColor || t.fontColor || "transparent", s = t.borderColor || t.lineColor || "transparent", o = Xe(
    t.borderWidth || t.lineWidth,
    e,
    n
  ), l = t.lineCap || "round", a = t.lineJoin || "round", c = typeof r == "string" ? "" : r.map((u) => Xe(u, e, n)).join(","), d = t.opacity || 1;
  return {
    "stroke-linecap": l,
    "stroke-linejoin": a,
    "stroke-width": o || 0,
...
}, ht = (t) => t != null, LO = (t, e, n = 1) => {
  let r = Xe(t.x, e, n, "width") || Xe(t.left, e, n, "width"), i = Xe(t.y, e, n, "height") || Xe(t.top, e, n, "height"), s = Xe(t.width, e, n, "width"), o = Xe(t.height, e, n, "height"), l = Xe(t.right, e, n, "width"), a = Xe(t.bottom, e, n, "height");
  return ht(i) || (ht(o) && ht(a) ? i = e.height - o - a : i = a), ht(r) || (ht(s) && ht(l) ? r = e.width - s - l : r = l), ht(s) || (ht(r) && ht(l) ? s = e.width - r - l : s = 0), ht(o) || (ht(i) && ht(a) ? o = e.height - i - a : o = 0), {
    x: r || 0,
    y: i || 0,
    width: s || 0,
    height: o || 0
  };
}, PO = (t) => t.map((e, n) => `${n === 0 ? "M" : "L"} ${e.x} ${e.y}`).join(" "), Gt = (t, e) => Object.keys(e).forEach((n) => t.setAttribute(n, e[n])), BO = "http://www.w3.org/2000/svg", Or = (t, e) => {
  const n = document.createElementNS(BO, t);
  return e && Gt(n, e), n;
}, HO = (t) => Gt(t, {
  ...t.rect,
  ...t.styles
  ...
  Gt(t, {
    ...t.rect,
    ...t.styles,
    preserveAspectRatio: VO[e.fit] || "none"
  });
}, GO = {
  left: "start",
  center: "middle",
  ...
  const i = Xe(e.fontSize, n, r), s = e.fontFamily || "sans-serif", o = e.fontWeight || "normal", l = GO[e.textAlign] || "start";
  Gt(t, {
    ...t.rect,
    ...t.styles,
    "stroke-width": 0,
  ...
  path: WO,
  line: $O
}, XO = (t, e) => YO[t](e), JO = (t, e, n, r, i) => {
  e !== "path" && (t.rect = LO(n, r, i)), t.styles = NO(n, r, i), KO[e](t, n, r, i);
}, QO = [
  "x",
  "y",
  "left",
  ...
  "width",
  "height"
], ZO = (t) => typeof t == "string" && /%/.test(t) ? parseFloat(t) / 100 : t, eA = (t) => {
  const [e, n] = t, r = n.points ? {} : QO.reduce((i, s) => (i[s] = ZO(n[s]), i), {});
  return [
    e,
    {
      zIndex: 0,
...
}, tA = (t, e) => t[1].zIndex > e[1].zIndex ? 1 : t[1].zIndex < e[1].zIndex ? -1 : 0, nA = (t) => t.utils.createView({
  ...
  write: ({ root: e, props: n }) => {
    ...
    s.filter(f).map(eA).sort(tA).forEach((h) => {
      const [p, m] = h, g = XO(p, m);
      JO(g, p, m, d, u), e.element.appendChild(g);
    });
  }
}), Si = (t, e) => ({ x: t, y: e }), rA = (t, e) => t.x * e.x + t.y * e.y, pf = (t, e) => Si(t.x - e.x, t.y - e.y), iA = (t, e) => rA(pf(t, e), pf(t, e)), mf = (t, e) => Math.sqrt(iA(t, e)), gf = (t, e) => {
  ...
  const i = r.x > 0.5 ? 1 - r.x : r.x, s = r.y > 0.5 ? 1 - r.y : r.y, o = i * 2 * t.width, l = s * 2 * t.height, a = sA(e, n);
  return Math.max(
    a.width / o,
    a.height / l
  );
  ...
  const o = oA(t, s, n), l = {
    ...
    height: o.height,
    center: l
  }, c = typeof e.scaleToFit > "u" || e.scaleToFit, d = Am(
    t,
    Rm(a, s),
    r,
    c ? i : { x: 0.5, y: 0.5 }
  ...
  create: ({ root: e, props: n }) => {
    n.width = n.image.width, n.height = n.image.height, e.ref.bitmap = e.appendChildView(
      e.createChildView(aA(t), { image: n.image })
    );
  },
  write: ({ root: e, props: n }) => {
  ...
  create: ({ root: e, props: n }) => {
    e.ref.image = e.appendChildView(
      ...
      e.ref.markup || (e.ref.markup = e.appendChildView(
        e.createChildView(nA(t), Object.assign({}, n))
      ));
    }, e.ref.destroyMarkup = () => {
  ...
  write: ({ root: e, props: n, shouldOptimize: r }) => {
    ...
    }, p = Math.PI * 2 + i.rotation % (Math.PI * 2), m = i.aspectRatio || u.height / u.width, g = typeof i.scaleToFit > "u" || i.scaleToFit, v = Am(
      u,
      Rm(d, m),
      p,
      g ? i.center : { x: 0.5, y: 0.5 }
    ), E = i.zoom * v;
    s && s.length ? (e.ref.createMarkup(), e.ref.markup.width = a, e.ref.markup.height = c, e.ref.markup.resize = o, e.ref.markup.dirty = l, e.ref.markup.markup = s, e.ref.markup.crop = lA(u, i)) : e.ref.markup && e.ref.destroyMarkup();
    const b = e.ref.image;
    if (r) {
...
let fA = `<svg width="500" height="200" viewBox="0 0 500 200" preserveAspectRatio="none">
    <defs>
...
const hA = (t) => t.utils.createView({
  ...
  self.onmessage = (t) => {
    ...
    let O = 0, P = 0, k = 0, D = 0, V = 0;
    for (; O < i; O += 4)
      P = r[O] / 255, k = r[O + 1] / 255, D = r[O + 2] / 255, V = r[O + 3] / 255, r[O] = Math.max(
        0,
        Math.min((P * s + k * o + D * l + V * a + c) * 255, 255)
      ), r[O + 1] = Math.max(
        0,
        Math.min((P * d + k * u + D * f + V * h + p) * 255, 255)
      ), r[O + 2] = Math.max(
        0,
        Math.min((P * m + k * g + D * v + V * E + b) * 255, 255)
      ), r[O + 3] = Math.max(
        0,
        Math.min((P * y + k * T + D * w + V * C + S) * 255, 255)
      );
  ...
  r !== -1 && t.transform.apply(t, yA[r](e, n));
}, vA = (t, e, n, r) => {
  e = Math.round(e), n = Math.round(n);
  const i = document.createElement("canvas");
  i.width = e, i.height = n;
  const s = i.getContext("2d");
  return r >= 5 && r <= 8 && ([e, n] = [n, e]), EA(s, e, n, r), s.drawImage(t, 0, 0, e, n), i;
}, xm = (t) => /^image/.test(t.type) && !/svg/.test(t.type), bA = 10, wA = 10, TA = (t) => {
  const e = Math.min(bA / t.width, wA / t.height), n = document.createElement("canvas"), r = n.getContext("2d"), i = n.width = Math.ceil(t.width * e), s = n.height = Math.ceil(t.height * e);
...
}, xl = (t, e) => Math.floor(Math.sqrt(t / (e / 4))), SA = (t, e) => (e = e || document.createElement("canvas"), e.width = t.width, e.height = t.height, e.getContext("2d").drawImage(t, 0, 0), e), IA = (t) => {
  let e;
  try {
  ...
  const e = hA(t), n = uA(t), { createWorker: r } = t.utils, i = (E, b, y) => new Promise((T) => {
    E.ref.imageData || (E.ref.imageData = y.getContext("2d").getImageData(0, 0, y.width, y.height));
    const w = IA(E.ref.imageData);
    if (!b || b.length !== 20)
    ...
    if (T) {
      ...
      if (/crop|markup|resize/.test(y.change.key)) {
        ...
        if (w && w.aspectRatio && C.crop && C.crop.aspectRatio && Math.abs(w.aspectRatio - C.crop.aspectRatio) > 1e-5) {
          const S = o({ root: E });
          l({ root: E, props: b, image: SA(S.image) });
        } else
          a({ root: E, props: b });
      }
    }
    ...
    return (y ? parseInt(y[1]) : null) <= 58 ? !1 : "createImageBitmap" in window && xm(E);
  }, u = ({ root: E, props: b }) => {
    ...
    const w = URL.createObjectURL(T.file), C = () => {
      ...
      let { width: D, height: V } = O;
      if (!D || !V)
        return;
      k >= 5 && k <= 8 && ([D, V] = [V, D]);
      const R = Math.max(1, window.devicePixelRatio * 0.75), I = E.query("GET_IMAGE_PREVIEW_ZOOM_FACTOR") * R, A = V / D, L = E.rect.element.width, B = E.rect.element.height;
      let $ = L, K = $ * A;
      A > 1 ? ($ = Math.min(D, L * I), K = $ * A) : (K = Math.min(V, B * I), $ = K / A);
      const ue = vA(
        O,
        $,
        K,
        ...
        T.setMetadata("color", Ve, !0), "close" in O && O.close(), E.ref.overlayShadow.opacity = 1, l({ root: E, props: b, image: ue });
  ...
  const { addFilter: e, utils: n } = t, { Type: r, createRoute: i, isFile: s } = n, o = MA(t);
  return e("CREATE_VIEW", (l) => {
    ...
    const u = ({ root: g, props: v }) => {
      ...
      if (!b || !s(b.file) || b.archived)
        return;
      const y = b.file;
      if (!kO(y) || !d("GET_IMAGE_PREVIEW_FILTER_ITEM")(b))
        return;
      ...
      if (D >= 5 && D <= 8 && ([C, S] = [S, C]), !xm(b.file) || g.query("GET_IMAGE_PREVIEW_UPSCALE")) {
        const L = 2048 / C;
        C *= L, S *= L;
      }
      const V = S / C, R = (b.getMetadata("crop") || {}).aspectRatio || V;
      let G = Math.max(
        O,
        Math.min(S, P)
      );
...
OA && document.dispatchEvent(
  new CustomEvent("FilePond:pluginloaded", { detail: _m })
);
const AA = xO(
  Om,
  _m
...
function _A(t, e, n, r, i, s) {
  const o = pn("file-pond"), l = pn("node-view-content"), a = pn("node-view-wrapper");
  return Z(), pt(a, { class: "relative border-2 border-slate-400 rounded p-6" }, {
    default: Le(() => [
      lt("div", xA, [
        Ye(o, {
          name: "test",
        ...
        Ye(l, { class: "bg-white p-2 border-2 rounded h-14" })
      ])
    ]),
    _: 1
  });
}
const kA = /* @__PURE__ */ jr(RA, [["render", _A]]), DA = de.create({
...
}), PA = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/, BA = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/g, HA = (t) => t.match(PA), Ef = (t) => t ? "https://www.youtube-nocookie.com/embed/" : "https://www.youtube.com/embed/", FA = (t) => {
  const {
    url: e,
    allowFullscreen: n,
    autoplay: r,
  ...
  addCommands() {
    return {
      setYoutubeVideo: (t) => ({ commands: e }) => HA(t.src) ? e.insertContent({
        type: this.name,
        attrs: t
      }) : !1
    };
...
function GA(t) {
  var e;
  const { char: n, allowSpaces: r, allowedPrefixes: i, startOfLine: s, $position: o } = t, l = qE(n), a = new RegExp(`\\s${l}$`), c = s ? "^" : "", d = r ? new RegExp(`${c}${l}.*?(?=\\s${l}|$)`, "gm") : new RegExp(`${c}(?:^)?${l}[^\\s${l}]*`, "gm"), u = ((e = o.nodeBefore) === null || e === void 0 ? void 0 : e.isText) && o.nodeBefore.text;
  if (!u)
    return null;
...
const UA = new Ie("suggestion");
function $A({ pluginKey: t = UA, editor: e, char: n = "@", allowSpaces: r = !1, allowedPrefixes: i = [" "], startOfLine: s = !1, decorationTag: o = "span", decorationClass: l = "suggestion", command: a = () => null, items: c = () => [], render: d = () => ({}), allow: u = () => !0 }) {
  let f;
  const h = d == null ? void 0 : d(), p = new me({
    ...
    view() {
      return {
        update: async (m, g) => {
          var v, E, b, y, T, w, C;
          const S = (v = this.key) === null || v === void 0 ? void 0 : v.getState(g), O = (E = this.key) === null || E === void 0 ? void 0 : E.getState(m.state), P = S.active && O.active && S.range.from !== O.range.from, k = !S.active && O.active, D = S.active && !O.active, V = !k && !D && S.query !== O.query, R = k || P, G = V && !P, I = D || P;
          if (!R && !G && !I)
            return;
...
}, jA = { class: "bg-white border border-slate-400 rounded overflow-hidden shadow" }, YA = ["onClick"], KA = ["innerHTML"], XA = {
  key: 1,
  class: "p-2 text-slate-600 text-sm w-full"
};
function JA(t, e, n, r, i, s) {
  return Z(), ae("div", jA, [
    n.items.length ? (Z(!0), ae(Kt, { key: 0 }, Xt(s.itemsWithInsertCommand, (o, l) => (Z(), ae("button", {
      ...
      Wm(" " + qm(o.title), 1)
    ], 10, YA))), 128)) : (Z(), ae("div", XA, "No result"))
  ]);
}
const QA = /* @__PURE__ */ jr(qA, [["render", JA]]);
function km() {
  return [
    {
      name: "paragraph",
...
const i2 = {
  ...
  methods: {
    ...
    getTopLevelNodeType() {
      var t;
      return (t = Fp(this.editor.view)) == null ? void 0 : t.type.name;
    },
    canMoveNodeDown() {
...
}, s2 = { class: "flex flex-row" }, o2 = /* @__PURE__ */ lt("svg", {
  width: "24",
  height: "24",
  ...
  /* @__PURE__ */ lt("path", { d: "M8 7h2V5H8v2zm0 6h2v-2H8v2zm0 6h2v-2H8v2zm6-14v2h2V5h-2zm0 8h2v-2h-2v2zm0 6h2v-2h-2v2z" })
], -1), l2 = [
  o2
], a2 = {
  key: 0,
  class: "py-1 md:py-2 group relative"
}, c2 = /* @__PURE__ */ lt("div", { class: "p-3 uppercase text-gray-600 text-xs pb-1 tracking-wide" }, " Transform to ", -1), d2 = {
  key: 1,
  class: "pr-2 flex flex-col"
}, u2 = ["disabled"], f2 = /* @__PURE__ */ lt("svg", {
  width: "24",
  height: "24",
  class: "w-5 h-5 md:w-6 md:h-6",
  viewBox: "0 0 24 24",
  ...
  /* @__PURE__ */ lt("path", { d: "M6.5 12.4L12 8l5.5 4.4-.9 1.2L12 10l-4.5 3.6-1-1.2z" })
], -1), h2 = [
  f2
], p2 = ["disabled"], m2 = /* @__PURE__ */ lt("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  width: "24",
  height: "24",
  fill: "currentColor",
  ...
  /* @__PURE__ */ lt("path", { d: "M17.5 11.6 12 16l-5.5-4.4.9-1.2L12 14l4.5-3.6 1 1.2z" })
], -1), g2 = [
  m2
], y2 = {
  key: 0,
...
function w2(t, e, n, r, i, s) {
  const o = pn("menu-button"), l = pn("menu-dropdown-button"), a = pn("menu-item"), c = pn("bubble-menu"), d = pn("editor-content");
  return Z(), ae("div", null, [
    i.editor && i.tableRowTools ? (Z(), pt(c, {
      key: 0,
      editor: i.editor,
      ...
      default: Le(() => [
        Ye(a, null, {
          dropdown: Le(() => [
            (Z(!0), ae(Kt, null, Xt(i.tableRowTools, (u) => (Z(), pt(l, {
    ...
    i.editor && i.tableColumnTools ? (Z(), pt(c, {
      key: 1,
      editor: i.editor,
      ...
      default: Le(() => [
        Ye(a, null, {
          dropdown: Le(() => [
            (Z(!0), ae(Kt, null, Xt(i.tableColumnTools, (u) => (Z(), pt(l, {
    ...
    i.editor ? (Z(), pt(c, {
      ...
      class: En(["text-sm bg-white max-w-screen flex divide-x max-w-full divide-slate-400 flex-row border-slate-400 md:rounded border-t md:border", {
        ...
        return [
          lt("div", s2, [
            lt("button", {
              ...
              class: En(["hidden md:block ml-1 my-2 hover:bg-slate-100 rounded", {
            ...
            !i.dragging && i.currentBlockTool ? (Z(), ae("div", a2, [
              Ye(a, null, jm({
                default: Le(() => {
                  var g, v, E;
                  return [
                ...
                (u = i.currentBlockTool) != null && u.canBeConverted ? {
                  ...
                  fn: Le(() => [
                    c2,
                    (Z(!0), ae(Kt, null, Xt(i.blockTools.filter((g) => g.convertCommand), (g) => (Z(), pt(l, {
          ...
          i.dragging ? kt("", !0) : (Z(), ae("div", y2, [
            (Z(!0), ae(Kt, null, Xt(s.activeAlignmentTools, (g, v) => (Z(), pt(a, { key: v }, {
              dropdown: Le(() => [
                (Z(!0), ae(Kt, null, Xt(g, (E) => (Z(), pt(l, {
                  key: E.title,
          ...
          !i.dragging && ((h = (f = i.currentBlockTool) == null ? void 0 : f.tools) != null && h.length) ? (Z(), ae("div", E2, [
            (Z(!0), ae(Kt, null, Xt((p = i.currentBlockTool) == null ? void 0 : p.tools, (g) => {
              var v, E;
              return Z(), pt(o, {
                key: g.name,
                content: g.icon,
          ...
          (m = i.currentBlockTool) != null && m.hasInlineTools && !i.dragging ? (Z(), ae("div", v2, [
            (Z(!0), ae(Kt, null, Xt(i.inlineTools, (g) => (Z(), pt(a, {
              align: "right",
              key: g.title
            }, {
              dropdown: Le(() => [
                (Z(!0), ae(Kt, null, Xt(g.tools, (v) => (Z(), pt(l, {
                  key: v.name,
          ...
          i.editor && i.editor.can().deleteNode(i.topLevelNodeType) && !i.dragging ? (Z(), ae("div", b2, [
            Ye(a, { align: "right" }, {
              dropdown: Le(() => [
                Ye(l, {
                  ref: "deleteButton",
    ...
    Ye(d, {
      ...
      onKeyup: e[7] || (e[7] = Ym((u) => i.isTyping = !1, ["esc"])),
      ref: "editor",
      editor: i.editor
    }, null, 8, ["class", "editor"])
  ]);
}
const T2 = /* @__PURE__ */ jr(i2, [["render", w2]]), M2 = T2;
export {
  M2 as GutenTap
};
