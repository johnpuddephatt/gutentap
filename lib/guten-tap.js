...
const i2 = {
...
}, s2 = { id: "gutentap" }, o2 = { class: "flex flex-row" }, l2 = /* @__PURE__ */ lt("svg", {
  width: "24",
  height: "24",
...
}, d2 = /* @__PURE__ */ lt("div", { class: "p-3 uppercase text-gray-600 text-xs pb-1 tracking-wide" }, " Transform to ", -1), u2 = {
  key: 1,
  class: "pr-2 flex flex-col"
}, f2 = ["disabled"], h2 = /* @__PURE__ */ lt("svg", {
  width: "24",
  height: "24",
  class: "w-5 h-5 md:w-6 md:h-6",
  viewBox: "0 0 24 24",
  ...
  h2
], m2 = ["disabled"], g2 = /* @__PURE__ */ lt("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  width: "24",
  height: "24",
  fill: "currentColor",
      ...
      default: Le(() => {
        ...
        return [
          lt("div", o2, [
            ...
            !i.dragging && i.currentBlockTool ? (Z(), ae("div", c2, [
              Ye(a, null, jm({
                default: Le(() => {
                  var g, v, E;
                  return [
          ...
          !i.dragging && ((h = (f = i.currentBlockTool) == null ? void 0 : f.tools) != null && h.length) ? (Z(), ae("div", v2, [
          ...
          (m = i.currentBlockTool) != null && m.hasInlineTools && !i.dragging ? (Z(), ae("div", b2, [
          ...
          i.editor && i.editor.can().deleteNode(i.topLevelNodeType) && !i.dragging ? (Z(), ae("div", w2, [
            Ye(a, { align: "right" }, {
              dropdown: Le(() => [
                Ye(l, {
                  ref: "deleteButton",
...
const S2 = /* @__PURE__ */ jr(i2, [["render", T2]]), O2 = S2;
export {
  O2 as GutenTap
};
